...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,113 | 🐛 19 | 🌐 Python | 📅 2026-09-15 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,103 | 🐛 59 | 🌐 Shell | 📅 2026-09-16：简单的 Python 版本管理工具。
...
* [conda](https://github.com/conda/conda/) ⭐ 7,507 | 🐛 663 | 🌐 Python | 📅 2026-09-17：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,153 | 🐛 582 | 🌐 Python | 📅 2026-09-16：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,096 | 🐛 290 | 🌐 Python | 📅 2026-09-16：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,189 | 🐛 14 | 🌐 Python | 📅 2026-09-16：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,461 | 🐛 276 | 🌐 Python | 📅 2026-09-15：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,784 | 🐛 1,288 | 🌐 Python | 📅 2026-09-14：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,574 | 🐛 719 | 🌐 Python | 📅 2026-07-26 之上。
...
* [Jupyter Notebook (IPython)](https://jupyter.org)：一个能够让你最大限度地以交互式方式使用 Python 的丰富工具包。
  * [awesome-jupyter](https://github.com/markusschanta/awesome-jupyter) ⭐ 4,669 | 🐛 10 | 📅 2026-09-16

### 文件

文件管理和 MIME（多用途的网际邮件扩充协议）类型检测。

* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,414 | 🐛 260 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,049 | 🐛 201 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,674 | 🐛 275 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,721 | 🐛 522 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,533 | 🐛 537 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,206 | 🐛 133 | 🌐 Python | 📅 2026-09-16：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,247 | 🐛 22 | 🌐 Python | 📅 2026-09-16：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,076 | 🐛 27 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,410 | 🐛 44 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,152 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,153 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,486 | 🐛 440 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,878 | 🐛 95 | 🌐 Python | 📅 2026-09-10：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,386 | 🐛 393 | 🌐 Python | 📅 2026-09-16：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,658 | 🐛 71 | 🌐 Python | 📅 2026-09-16：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,224 | 🐛 196 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,903 | 🐛 180 | 🌐 Python | 📅 2026-09-12：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,574 | 🐛 719 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,372 | 🐛 377 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,336 | 🐛 623 | 🌐 Python | 📅 2026-09-11：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,861 | 🐛 458 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,089 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,259 | 🐛 742 | 🌐 Python | 📅 2026-09-16：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,845 | 🐛 18 | 🌐 Python | 📅 2026-09-12：通过命令行获取即时的编程问题解答。
  * [PathPicker](https://github.com/facebook/PathPicker) ⭐ 5,233 | 🐛 26 | 🌐 Python | 📅 2024-09-05：从 bash 输出中选出文件。
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,776 | 🐛 462 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,580 | 🐛 137 | 🌐 Python | 📅 2026-09-12： [tmux](https://github.com/tmux/tmux) ⭐ 49,298 | 🐛 41 | 🌐 C | 📅 2026-09-15 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,581 | 🐛 14 | 🌐 Python | 📅 2026-09-08：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,573 | 🐛 149 | 🌐 Python | 📅 2026-09-07：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,520 | 🐛 338 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,389 | 🐛 42 | 🌐 Python | 📅 2026-09-16：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,975 | 🐛 0 | 🌐 Python | 📅 2026-09-16：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,644 | 🐛 75 | 🌐 Python | 📅 2026-09-16：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,613 | 🐛 0 | 🌐 Python | 📅 2026-09-16：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,754 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,664 | 🐛 247 | 🌐 Python | 📅 2026-09-16: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,668 | 🐛 709 | 🌐 Python | 📅 2026-09-16：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,614 | 🐛 50 | 🌐 Python | 📅 2026-09-16：音频音乐分析 Python 库。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,548 | 🐛 222 | 🌐 Python | 📅 2026-09-16：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,484 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,570 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,058 | 🐛 240 | 🌐 Python | 📅 2026-09-15：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,566 | 🐛 13 | 🌐 Python | 📅 2026-09-16：一个微型的，面向文档型数据库。
...
* 异步客户端
  * [motor](https://github.com/mongodb/motor) ⭐ 2,525 | 🐛 3 | 🌐 Python | 📅 2026-09-14：支持 MongoDB 的异步 Python 驱动程序。
...
* 关系型数据库
  ...
  * [awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) ⭐ 3,057 | 🐛 10 | 🌐 Python | 📅 2026-06-08 系列
  ...
  * [SQLAlchemy](http://www.sqlalchemy.org/)：Python SQL 工具以及对象关系映射工具。
    * [awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) ⭐ 3,057 | 🐛 10 | 🌐 Python | 📅 2026-06-08
...
* [sanic](https://github.com/channelcat/sanic/) ⭐ 18,638 | 🐛 148 | 🌐 Python | 📅 2026-07-29：基于 Python3.5+ 的异步网络框架。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,247 | 🐛 4 | 🌐 Python | 📅 2026-09-16 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,767 | 🐛 5 | 📅 2026-08-17 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,717 | 🐛 9 | 🌐 Python | 📅 2026-09-13：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,913 | 🐛 32 | 🌐 Python | 📅 2026-09-17：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,108 | 🐛 890 | 🌐 Python | 📅 2026-09-16：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* [django-shop](https://github.com/awesto/django-shop) ⭐ 3,318 | 🐛 106 | 🌐 Python | 📅 2023-10-19：一个基于 Django 的店铺系统。
* [merchant](https://github.com/agiliq/merchant) ⭐ 1,019 | 🐛 32 | 🌐 Python | 📅 2022-07-08：一个可以接收来自多种支付平台支付的 Django 应用。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,370 | 🐛 81 | 🌐 Python | 📅 2026-09-14：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  ...
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,336 | 🐛 48 | 🌐 Python | 📅 2026-09-02：为 Django 用户准备的 OAuth2。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,034 | 🐛 0 | 🌐 Python | 📅 2026-09-15：小型多线程任务队列。
...
* [pysolr](https://github.com/django-haystack/pysolr) ⭐ 702 | 🐛 21 | 🌐 Python | 📅 2026-09-11：支持 [Apache Solr](https://lucene.apache.org/solr/) 的轻量级 Python 装饰器。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,536 | 🐛 50 | 🌐 Python | 📅 2026-09-16：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,391 | 🐛 117 | 🌐 Python | 📅 2026-09-16：HTML/CSS 转 PDF 工具。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,161 | 🐛 515 | 🌐 Python | 📅 2026-09-15：使用 Python 进行新闻提取，文章提取以及内容策展。
...
* [micawber](https://github.com/coleifer/micawber) ⭐ 678 | 🐛 0 | 🌐 Python | 📅 2026-09-03：一个小型网页内容提取库，用来从 URLs 提取富内容。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,981 | 🐛 53 | 🌐 Python | 📅 2026-09-15：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [voluptuous](https://github.com/alecthomas/voluptuous) ⭐ 1,851 | 🐛 46 | 🌐 Python | 📅 2026-07-25：一个 Python 数据验证库。主要是为了验证传入 Python 的 JSON，YAML 等数据。
...
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,257 | 🐛 139 | 🌐 C++ | 📅 2026-09-15 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 20 | 🌐 C++ | 📅 2026-09-06： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,120 | 🐛 795 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [flower](https://github.com/mher/flower) ⭐ 7,238 | 🐛 47 | 🌐 Python | 📅 2026-09-13：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,068 | 🐛 130 | 🌐 Python | 📅 2026-09-07：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [Wooey](https://github.com/wooey/wooey) ⭐ 2,242 | 🐛 57 | 🌐 Python | 📅 2026-08-04：一个 Django 应用，可以为 Python 脚本创建 web 用户界面。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,898 | 🐛 161 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,330 | 🐛 327 | 🌐 Python | 📅 2026-09-14：异步并发和 I/O 友好的库。
...
* [django-socketio](https://github.com/stephenmcd/django-socketio) ⭐ 1,312 | 🐛 32 | 🌐 Python | 📅 2021-05-17：给 Django 用的 WebSockets。
...
* [netius](https://github.com/hivesolutions/netius) ⭐ 117 | 🐛 8 | 🌐 Python | 📅 2026-09-13：异步，非常快速。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,966 | 🐛 97 | 🌐 Python | 📅 2026-09-16：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,622 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,020 | 🐛 17 | 🌐 Python | 📅 2026-09-16：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,415 | 🐛 313 | 🌐 Python | 📅 2026-09-14：一个 Python 原生的，操作系统原生的 GUI 工具包。
* [Flexx](https://github.com/zoofIO/flexx) ⭐ 3,328 | 🐛 97 | 🌐 Python | 📅 2025-01-20：Flexx 是一个纯 Python 语言编写的用来创建 GUI 程序的工具集，它使用 web 技术进行界面的展示。
* [enaml](https://github.com/nucleic/enaml) ⭐ 1,575 | 🐛 62 | 🌐 Python | 📅 2026-09-11：使用类似 QML 的 Declaratic 语法来创建美观的用户界面。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,111 | 🐛 256 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,204 | 🐛 346 | 🌐 Python | 📅 2026-09-16：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,888 | 🐛 300 | 🌐 Python | 📅 2026-09-15：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,978 | 🐛 43 | 🌐 Python | 📅 2026-09-14：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,163 | 🐛 5 | 🌐 Python | 📅 2026-09-15：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,698 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,604 | 🐛 9 | 🌐 Python | 📅 2026-09-16：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,525 | 🐛 170 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
...
* 伪数据
  * [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,843 | 🐛 15 | 🌐 Python | 📅 2026-09-07：一个帮助你生成伪数据的 Python 库。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,457 | 🐛 31 | 🌐 Python | 📅 2026-09-15：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,304 | 🐛 14 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,314 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,985 | 🐛 6 | 📅 2026-09-03
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,120 | 🐛 354 | 🌐 Python | 📅 2026-09-17：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,813 | 🐛 70 | 🌐 Python | 📅 2026-09-16：用于发现和分析无效 Python 代码的工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,842 | 🐛 307 | 🌐 Python | 📅 2026-09-16：一个坚定的 Python 代码格式化工具。
...
* 其他
  ...
  * [django-devserver](https://github.com/dcramer/django-devserver) ⭐ 1,264 | 🐛 59 | 🌐 Python | 📅 2020-02-26：一个 Django 运行服务器的替代品。
  * [flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) ⭐ 978 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07：django-debug-toolbar 的 flask 版。
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 0 | 🌐 Python | 📅 2026-09-14：[statsd](https://github.com/etsy/statsd/) ⭐ 18,076 | 🐛 92 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。
...
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,942 | 🐛 6,009 | 🌐 Python | 📅 2026-09-16：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,626 | 🐛 2,818 | 🌐 Python | 📅 2026-09-16：统计建模和计量经济学。
...
* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,621 | 🐛 390 | 🌐 Python | 📅 2026-09-10：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,454 | 🐛 851 | 🌐 Python | 📅 2026-09-16：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,023 | 🐛 234 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,473 | 🐛 150 | 🌐 Python | 📅 2026-09-16：用于 Python 的声明式统计可视化库。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 318 | 🌐 Python | 📅 2026-09-16：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,754 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,995 | 🐛 531 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,361 | 🐛 207 | 🌐 Python | 📅 2026-09-16：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,929 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,145 | 🐛 3,150 | 🌐 C++ | 📅 2026-09-17 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,357 | 🐛 29 | 🌐 Python | 📅 2026-09-12。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,740 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,768 | 🐛 439 | 🌐 C++ | 📅 2026-09-16：可扩展，便携式和分布式梯度提升库。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,835 | 🐛 3,599 | 🌐 Python | 📅 2026-09-17：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,774 | 🐛 178 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,920 | 🐛 1,336 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,365 | 🐛 81 | 🌐 Python | 📅 2026-09-16：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,357 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 18 | 🌐 Python | 📅 2026-09-14：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,508 | 🐛 15 | 🌐 Python | 📅 2026-09-16：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,901 | 🐛 201 | 🌐 Python | 📅 2026-09-16：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,931 | 🐛 45 | 🌐 Python | 📅 2026-09-15：Python 用的 Google APIs 客户端库。
* [gspread](https://github.com/burnash/gspread) ⭐ 7,504 | 🐛 73 | 🌐 Python | 📅 2026-07-30：Google 电子表格的 Python API。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,703 | 🐛 834 | 🌐 Python | 📅 2026-09-16：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,658 | 🐛 1,882 | 🌐 Python | 📅 2026-09-17：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,275 | 🐛 258 | 🌐 Python | 📅 2026-09-14：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,115 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,998 | 🐛 159 | 🌐 Python | 📅 2026-09-16：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,851 | 🐛 855 | 🌐 Python | 📅 2026-09-16：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,267 | 🐛 180 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,069 | 🐛 1,529 | 🌐 C | 📅 2026-09-16：精简高效的 Python 编程语言实现。
...
* [PythonNet](https://github.com/pythonnet/pythonnet) ⭐ 5,514 | 🐛 164 | 🌐 C# | 📅 2026-09-14：Python 与 .NET 公共语言运行库 (CLR)的集成。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,547 | 🐛 138 | 🌐 Python | 📅 2026-09-16：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,539 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,646 | 🐛 354 | 🌐 Python | 📅 2026-09-16：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,548 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,991 | 🐛 12 | 🌐 Python | 📅 2026-09-12：一个 Python 设计模式集合。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,528 | 🐛 56 | 🌐 Python | 📅 2026-09-14：各种具有可视化效果的机器人算法的汇总。
...
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,564 | 🐛 163 | 🌐 C# | 📅 2026-08-28：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,328 | 🐛 1,347 | 🌐 Python | 📅 2026-09-14： 开源 Python IDE。
...
* [graphene](https://github.com/graphql-python/graphene/) ⭐ 8,237 | 🐛 113 | 🌐 Python | 📅 2025-09-04：Python GraphQL 框架。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,407 | 🐛 25 | 🌐 Python | 📅 2026-09-13：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,623 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,203 | 🐛 240 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,508 | 🐛 5 | 🌐 C++ | 📅 2026-09-12：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,923 | 🐛 88 | 🌐 Python | 📅 2026-09-08：一组纯 Python 实用工具。
