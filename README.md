...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 319,151 | 🐛 19 | 🌐 Python | 📅 2026-09-01 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,084 | 🐛 55 | 🌐 Shell | 📅 2026-09-06：简单的 Python 版本管理工具。
* [p](https://github.com/qw3rtman/p) ⭐ 769 | 🐛 28 | 🌐 Shell | 📅 2019-11-01：非常简单的交互式 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,033 | 🐛 14 | 🌐 Python | 📅 2026-08-24：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,007 | 🐛 176 | 🌐 Python | 📅 2026-08-31：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,504 | 🐛 664 | 🌐 Python | 📅 2026-09-07：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,145 | 🐛 589 | 🌐 Python | 📅 2026-09-07：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,088 | 🐛 289 | 🌐 Python | 📅 2026-09-06：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,186 | 🐛 14 | 🌐 Python | 📅 2026-08-30：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,445 | 🐛 277 | 🌐 Python | 📅 2026-09-07：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,777 | 🐛 1,279 | 🌐 Python | 📅 2026-09-07：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,566 | 🐛 713 | 🌐 Python | 📅 2026-07-26 之上。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,407 | 🐛 252 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
...
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,673 | 🐛 269 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
* [maya](https://github.com/kennethreitz/maya) ⭐ 3,410 | 🐛 21 | 🌐 Python | 📅 2024-07-19：人性化的时间处理库。
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,632 | 🐛 484 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  ...
  * [ftfy](https://github.com/LuminosoInsight/python-ftfy) ⭐ 4,064 | 🐛 25 | 🌐 Python | 📅 2024-10-30：让 Unicode 文本更完整更连贯。
...
* 解析器
  ...
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 29 | 🌐 Python | 📅 2026-09-07：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,712 | 🐛 515 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,518 | 🐛 535 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  * [unoconv](https://github.com/dagwieers/unoconv) ⚠️ Archived：在 LibreOffice/OpenOffice 支持的任意文件格式之间进行转换。
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,700 | 🐛 177 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,195 | 🐛 132 | 🌐 Python | 📅 2026-09-07：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,246 | 🐛 31 | 🌐 Python | 📅 2026-09-06：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,072 | 🐛 23 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
  * [Python-Markdown2](https://github.com/trentm/python-markdown2) ⭐ 2,822 | 🐛 94 | 🌐 Python | 📅 2026-08-20：纯 Python 实现的 Markdown 解析器，比 Python-Markdown 更快，更准确，可扩展。
* YAML
  * [PyYAML](http://pyyaml.org/)：Python 版本的 YAML 解析器。
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,412 | 🐛 40 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,942 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,144 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,481 | 🐛 439 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-07：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,707 | 🐛 135 | 🌐 Python | 📅 2022-11-05：一个支持对不同领域进行中文分词的工具箱。
...
* [thulac](https://github.com/thunlp/THULAC-Python) ⭐ 2,082 | 🐛 87 | 🌐 Python | 📅 2022-01-31：清华大学自然语言处理与社会人文计算实验室研制推出的一套中文词法分析工具包。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,384 | 🐛 394 | 🌐 Python | 📅 2026-09-07：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,639 | 🐛 71 | 🌐 Python | 📅 2026-09-07：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,216 | 🐛 196 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,900 | 🐛 183 | 🌐 Python | 📅 2026-09-04：一条命令，将命令行程序变成一个 GUI 程序。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,339 | 🐛 375 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,318 | 🐛 613 | 🌐 Python | 📅 2026-09-07：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,772 | 🐛 456 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,080 | 🐛 311 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,240 | 🐛 728 | 🌐 Python | 📅 2026-09-04：Amazon Web Services 的通用命令行界面。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,572 | 🐛 139 | 🌐 Python | 📅 2026-09-05： [tmux](https://github.com/tmux/tmux) ⭐ 49,131 | 🐛 32 | 🌐 C | 📅 2026-09-07 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 15 | 🌐 Python | 📅 2026-09-07：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,560 | 🐛 144 | 🌐 Python | 📅 2026-09-07：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,486 | 🐛 338 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,374 | 🐛 38 | 🌐 Python | 📅 2026-09-04：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,974 | 🐛 1 | 🌐 Python | 📅 2026-09-07：支持自动补全和语法高亮的 MySQL 命令行客户端
  ...
  * [iredis](https://github.com/laixintao/iredis) ⭐ 2,742 | 🐛 52 | 🌐 Python | 📅 2026-09-02：支持自动补全和高亮显示的 redis 命令行工具。
  * [kube-shell](https://github.com/cloudnativelabs/kube-shell) ⭐ 2,391 | 🐛 67 | 🌐 Python | 📅 2022-11-02：K8S 命令行集成的 shell 工具。
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,634 | 🐛 79 | 🌐 Python | 📅 2026-09-07：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,477 | 🐛 7 | 🌐 Python | 📅 2026-09-02：为方便人使用而创建的金融数据接口库。
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,908 | 🐛 311 | 🌐 Python | 📅 2025-10-22：一个用来管理 Amazon S3 和 CloudFront 的命令行工具。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,715 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,517 | 🐛 36 | 🌐 Python | 📅 2026-09-08：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,044 | 🐛 243 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,388 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的一个封装。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,636 | 🐛 710 | 🌐 Python | 📅 2026-09-07：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,592 | 🐛 52 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,621 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 837 | 🐛 6 | 🌐 Python | 📅 2026-09-07：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,859 | 🐛 54 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [GeoIP2](https://github.com/maxmind/GeoIP2-python) ⭐ 1,218 | 🐛 5 | 🌐 Python | 📅 2026-09-07：GeoIP2 Webservice 客户端与数据库 Python API。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,543 | 🐛 216 | 🌐 Python | 📅 2026-09-08：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,468 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,571 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,053 | 🐛 233 | 🌐 Python | 📅 2026-09-07：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,562 | 🐛 12 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,842 | 🐛 16 | 🌐 Python | 📅 2026-09-07：纯 Python MySQL 驱动，兼容 mysql-python。
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,537 | 🐛 3 | 🌐 Python | 📅 2026-09-07 分支，支持 Python 3。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,631 | 🐛 83 | 🌐 Python | 📅 2026-09-04：Redis 的 Python 客户端。
...
* 异步客户端
  * [motor](https://github.com/mongodb/motor) ⭐ 2,526 | 🐛 2 | 🌐 Python | 📅 2026-09-07：支持 MongoDB 的异步 Python 驱动程序。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-09-07：一个小巧，富有表现力的 ORM。
  * [dataset](https://github.com/pudo/dataset) ⭐ 4,872 | 🐛 25 | 🌐 Python | 📅 2026-07-22：在数据库中存储字典，支持 SQLite，MySQL 和 PostgreSQL。
  * [pony](https://github.com/ponyorm/pony/) ⭐ 3,818 | 🐛 359 | 🌐 Python | 📅 2026-08-10：提供面向生成器的SQL接口的ORM。
  * [awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) ⭐ 3,056 | 🐛 10 | 🌐 Python | 📅 2026-06-08 系列
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,237 | 🐛 4 | 🌐 Python | 📅 2026-09-06 系列
  * [awesome-django(by shahraizali)](https://github.com/shahraizali/awesome-django) ⭐ 1,915 | 🐛 8 | 📅 2026-03-22 系列
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,761 | 🐛 4 | 📅 2026-08-17 系列
...
* [indico](https://github.com/indico/indico) ⭐ 2,106 | 🐛 885 | 🌐 Python | 📅 2026-09-07：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,182 | 🐛 80 | 🌐 Python | 📅 2026-09-01：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
  ...
  * [sandman2](https://github.com/jeffknupp/sandman2) ⭐ 2,041 | 🐛 45 | 🌐 Python | 📅 2026-09-07：为数据库驱动的系统自动生成 REST API。
...
* OAuth
  ...
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,414 | 🐛 144 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,697 | 🐛 64 | 🌐 Python | 📅 2026-09-07：JSON Web 令牌草案 01。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,767 | 🐛 103 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,029 | 🐛 1 | 🌐 Python | 📅 2026-09-04：小型多线程任务队列。
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,312 | 🐛 67 | 🌐 Python | 📅 2026-09-02：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-haystack](https://github.com/django-haystack/django-haystack) ⭐ 3,733 | 🐛 582 | 🌐 Python | 📅 2026-09-07：Django 模块化搜索。
* [pysolr](https://github.com/django-haystack/pysolr) ⭐ 702 | 🐛 25 | 🌐 Python | 📅 2026-09-07：支持 [Apache Solr](https://lucene.apache.org/solr/) 的轻量级 Python 装饰器。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,537 | 🐛 51 | 🌐 Python | 📅 2026-09-07：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
* [inbox](https://github.com/nylas/sync-engine) ⚠️ Archived：一个开源电子邮件工具箱。
* [flanker](https://github.com/mailgun/flanker) ⭐ 1,649 | 🐛 79 | 🌐 Python | 📅 2026-04-08：一个 email 地址和 Mime 解析库。
...
* [webargs](https://github.com/sloria/webargs) ⭐ 1,407 | 🐛 9 | 🌐 Python | 📅 2026-09-07：一个解析 HTTP 请求参数的库，内置对流行 web 框架的支持，包括 Flask, Django, Bottle, Tornado 和 Pyramid。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,390 | 🐛 138 | 🌐 Python | 📅 2026-09-07：HTML/CSS 转 PDF 工具。
...
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,710 | 🐛 57 | 🌐 HTML | 📅 2026-09-01：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
* [python-goose](https://github.com/grangier/python-goose) ⭐ 4,107 | 🐛 107 | 🌐 HTML | 📅 2026-03-10：HTML 内容/文章提取器(python2)。
* [sumy](https://github.com/miso-belica/sumy) ⭐ 3,700 | 🐛 7 | 🌐 Python | 📅 2026-09-02：一个为文本文件和 HTML 页面进行自动摘要的模块。
...
* [html2text](https://github.com/Alir3z4/html2text) ⭐ 2,168 | 🐛 96 | 🌐 Python | 📅 2025-10-28：将 HTML 转换为 Markdown 格式文本。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,977 | 🐛 53 | 🌐 Python | 📅 2026-09-07：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,238 | 🐛 150 | 🌐 Python | 📅 2026-09-07：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,496 | 🐛 31 | 🌐 C++ | 📅 2026-09-04：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,241 | 🐛 134 | 🌐 C++ | 📅 2026-09-07 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 531 | 🐛 20 | 🌐 C++ | 📅 2026-09-06： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,120 | 🐛 793 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [flower](https://github.com/mher/flower) ⭐ 7,242 | 🐛 57 | 🌐 Python | 📅 2026-09-06：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,071 | 🐛 129 | 🌐 Python | 📅 2026-09-07：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [gevent](http://www.gevent.org/)：一个基于协程的 Python 网络库，使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,845 | 🐛 23 | 🌐 C++ | 📅 2026-09-01。
* [gevent](http://www.gevent.org/)：使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,845 | 🐛 23 | 🌐 C++ | 📅 2026-09-01 且基于协程的 Python 网络库。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,316 | 🐛 326 | 🌐 Python | 📅 2026-09-07：异步并发和 I/O 友好的库。
* [Toapi](https://github.com/gaojiuli/toapi) ⭐ 3,556 | 🐛 3 | 🌐 Python | 📅 2026-08-27：一个轻巧，简单，快速的 Flask 库，致力于为所有网站提供 API 服务。
...
* [Crossbar](https://github.com/crossbario/crossbar/) ⭐ 2,063 | 🐛 305 | 🌐 Python | 📅 2026-09-07：开源统一应用路由(Websocket & WAMP for Python on Autobahn)。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,952 | 🐛 88 | 🌐 Python | 📅 2026-09-01：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,606 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,812 | 🐛 708 | 🌐 Python | 📅 2026-08-30：tkinter，Qt，WxPython 和 Remi 的封装。
* [Eel](https://github.com/ChrisKnott/Eel) ⚠️ Archived：用于制作简单离线 HTML/JS GUI 应用的库。
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,011 | 🐛 16 | 🌐 Python | 📅 2026-09-07：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,410 | 🐛 310 | 🌐 Python | 📅 2026-09-07：一个 Python 原生的，操作系统原生的 GUI 工具包。
* [Flexx](https://github.com/zoofIO/flexx) ⭐ 3,329 | 🐛 97 | 🌐 Python | 📅 2025-01-20：Flexx 是一个纯 Python 语言编写的用来创建 GUI 程序的工具集，它使用 web 技术进行界面的展示。
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 365 | 🌐 Python | 📅 2026-09-07：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,871 | 🐛 300 | 🌐 Python | 📅 2026-09-04：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,945 | 🐛 45 | 🌐 Python | 📅 2026-09-06：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
  * [nose2](https://github.com/nose-devs/nose2) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-09-07 `nose`的继任者，基于 `unittest2`。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,134 | 🐛 4 | 🌐 Python | 📅 2026-09-07：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,681 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,585 | 🐛 14 | 🌐 Python | 📅 2026-09-07：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,522 | 🐛 168 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
  * [responses](https://github.com/getsentry/responses) ⭐ 4,344 | 🐛 41 | 🌐 Python | 📅 2026-08-26：伪造 Python 中的 requests 库的一个通用库。
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,006 | 🐛 168 | 🌐 Python | 📅 2026-09-01：在你的测试中记录和重放 HTTP 交互。
...
* 伪数据
  * [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,838 | 🐛 15 | 🌐 Python | 📅 2026-09-07：一个帮助你生成伪数据的 Python 库。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,387 | 🐛 32 | 🌐 Python | 📅 2026-09-07：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,270 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,293 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,983 | 🐛 6 | 📅 2026-09-03
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,120 | 🐛 346 | 🌐 Python | 📅 2026-09-08：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,797 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,606 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
  * [prospector](https://github.com/PyCQA/prospector) ⭐ 2,087 | 🐛 33 | 🌐 Python | 📅 2026-09-07：分析 Python 代码的工具。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,899 | 🐛 14 | 🌐 Python | 📅 2026-09-07：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,834 | 🐛 309 | 🌐 Python | 📅 2026-09-04：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,951 | 🐛 91 | 🌐 Python | 📅 2026-08-27：用于纠正包导入顺序的 Python 库。
...
* 静态类型注释生成器
  ...
  * [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,999 | 🐛 78 | 🌐 Python | 📅 2026-02-11：通过收集运行时的类型来为 Python 生成静态类型注释的系统。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,481 | 🐛 239 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  * [icecream](https://github.com/gruns/icecream) ⭐ 10,109 | 🐛 64 | 🌐 Python | 📅 2026-08-21：通过一个简单的函数调用检查变量、表达式和程序执行情况。
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,376 | 🐛 81 | 🌐 Python | 📅 2026-09-07：为 Django 显示各种调试信息。
...
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,912 | 🐛 5,964 | 🌐 Python | 📅 2026-09-07：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,614 | 🐛 2,803 | 🌐 Python | 📅 2026-09-06：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,742 | 🐛 491 | 🌐 Python | 📅 2026-09-07：马尔科夫链蒙特卡洛采样工具。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,020 | 🐛 22 | 📅 2026-09-02。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,596 | 🐛 389 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,446 | 🐛 856 | 🌐 Python | 📅 2026-09-07：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,772 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,018 | 🐛 234 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,469 | 🐛 153 | 🌐 Python | 📅 2026-09-05：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,758 | 🐛 82 | 🌐 Python | 📅 2026-09-07：基于ggplot2的Python图形语法。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 329 | 🌐 Python | 📅 2026-09-04：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,715 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,980 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,347 | 🐛 170 | 🌐 Python | 📅 2026-09-08：PyTorch 的开源差异化计算机视觉库。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,388 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的另一包装库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,875 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,336 | 🐛 3,150 | 🌐 C++ | 📅 2026-09-08 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,277 | 🐛 32 | 🌐 Python | 📅 2026-09-02。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,708 | 🐛 5 | 🌐 Makefile | 📅 2026-09-04：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,740 | 🐛 432 | 🌐 C++ | 📅 2026-09-04：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,501 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-09-02：开源快速可扩展的机器学习平台。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,714 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 装饰器。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,295 | 🐛 86 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
* [Surprise](https://github.com/NicolasHug/Surprise) ⭐ 6,811 | 🐛 80 | 🌐 Python | 📅 2026-05-30：用于构建和分析推荐系统的科学工具。
* [lightfm](https://github.com/lyst/lightfm) ⭐ 5,110 | 🐛 166 | 🌐 Python | 📅 2024-07-24：很多流行的推荐算法的 Python 实现。
* [implicit](https://github.com/benfred/implicit) ⭐ 3,818 | 🐛 97 | 🌐 Python | 📅 2026-05-08：对隐式数据集进行协作过滤的快速 Python 实现。
...
* [tensorrec](https://github.com/jfkirk/tensorrec) ⭐ 1,298 | 🐛 40 | 🌐 Python | 📅 2023-05-22：TensorFlow 的推荐引擎框架。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,730 | 🐛 3,569 | 🌐 Python | 📅 2026-09-07：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,770 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,911 | 🐛 1,327 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [Toolz](https://github.com/pytoolz/toolz) ⭐ 5,155 | 🐛 138 | 🌐 Python | 📅 2026-01-01：一组用于迭代器，函数和字典的函数式编程工具。
* [returns](https://github.com/dry-python/returns) ⭐ 4,359 | 🐛 81 | 🌐 Python | 📅 2026-09-07：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,354 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 11 | 🌐 Python | 📅 2026-09-06：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,510 | 🐛 17 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,898 | 🐛 191 | 🌐 Python | 📅 2026-09-07：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,923 | 🐛 51 | 🌐 Python | 📅 2026-09-04：Python 用的 Google APIs 客户端库。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,619 | 🐛 845 | 🌐 Python | 📅 2026-09-04：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,650 | 🐛 1,886 | 🌐 Python | 📅 2026-09-05：基础设施自动化和管理系统。
...
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,980 | 🐛 184 | 🌐 Python | 📅 2026-09-07：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
* [pexpect](https://github.com/pexpect/pexpect) ⭐ 2,848 | 🐛 170 | 🌐 Python | 📅 2025-04-11：在一个伪终端中控制交互程序，就像 GNU expect 一样。
* [honcho](https://github.com/nickstenning/honcho) ⭐ 1,711 | 🐛 26 | 🌐 Python | 📅 2025-06-03：[Foreman](https://github.com/ddollar/foreman) ⭐ 6,160 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 的 Python 克隆版，用来管理基于 [Procfile](https://devcenter.heroku.com/articles/procfile) 的应用。
* [honcho](https://github.com/nickstenning/honcho) ⭐ 1,711 | 🐛 26 | 🌐 Python | 📅 2025-06-03：[Foreman](https://github.com/ddollar/foreman) ⭐ 6,160 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 的 Python 克隆版，用于管理基于 Procfile 的应用。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,798 | 🐛 867 | 🌐 Python | 📅 2026-09-07：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,234 | 🐛 148 | 🌐 Python | 📅 2026-09-07：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,048 | 🐛 1,526 | 🌐 C | 📅 2026-09-07：精简高效的 Python 编程语言实现。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,501 | 🐛 174 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,525 | 🐛 135 | 🌐 Python | 📅 2026-09-07：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,510 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,356 | 🐛 776 | 🌐 Python | 📅 2026-09-07：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,541 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,982 | 🐛 39 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
  * [python-ds](https://github.com/prabhupant/python-ds) ⭐ 3,090 | 🐛 34 | 🌐 Python | 📅 2024-04-06：用于面试的数据结构和算法的集合。
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,968 | 🐛 12 | 🌐 Python | 📅 2026-09-04：一个 Python 设计模式集合。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,834 | 🐛 154 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,831 | 🐛 47 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,463 | 🐛 55 | 🌐 Python | 📅 2026-09-07：各种具有可视化效果的机器人算法的汇总。
...
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,564 | 🐛 159 | 🌐 C# | 📅 2026-08-28：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,312 | 🐛 1,346 | 🌐 Python | 📅 2026-09-07： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,171 | 🐛 33 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,566 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,099 | 🐛 239 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,490 | 🐛 4 | 🌐 C++ | 📅 2026-09-07：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,919 | 🐛 70 | 🌐 Python | 📅 2026-09-07：一组纯 Python 实用工具。
