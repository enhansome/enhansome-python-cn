...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,544 | 🐛 17 | 🌐 Python | 📅 2026-09-01 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,080 | 🐛 55 | 🌐 Shell | 📅 2026-09-02：简单的 Python 版本管理工具。
...
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,007 | 🐛 176 | 🌐 Python | 📅 2026-08-31：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,503 | 🐛 660 | 🌐 Python | 📅 2026-09-04：跨平台的 Python 二进制包管理工具。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,086 | 🐛 292 | 🌐 Python | 📅 2026-09-05：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,184 | 🐛 14 | 🌐 Python | 📅 2026-08-30：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,438 | 🐛 279 | 🌐 Python | 📅 2026-09-05：多平台命令行构建工具。
* [PyBuilder](https://github.com/pybuilder/pybuilder) ⭐ 2,040 | 🐛 103 | 🌐 Python | 📅 2026-08-25：纯 Python 实现的持续化构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,776 | 🐛 1,278 | 🌐 Python | 📅 2026-09-01：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,450 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,567 | 🐛 712 | 🌐 Python | 📅 2026-07-26 之上。
...
* [Jupyter Notebook (IPython)](https://jupyter.org)：一个能够让你最大限度地以交互式方式使用 Python 的丰富工具包。
  * [awesome-jupyter](https://github.com/markusschanta/awesome-jupyter) ⭐ 4,666 | 🐛 19 | 📅 2026-09-05

### 文件

文件管理和 MIME（多用途的网际邮件扩充协议）类型检测。

* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,405 | 🐛 247 | 🌐 Python | 📅 2026-09-03：管理文件系统事件的 API 和 shell 工具。
...
* [path.py](https://github.com/jaraco/path.py) ⭐ 1,125 | 🐛 7 | 🌐 Python | 📅 2026-04-13：对 os.path 进行封装的模块。
...
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,672 | 🐛 269 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
...
* 通用
  ...
  * [pypinyin](https://github.com/mozillazg/python-pinyin) ⭐ 5,360 | 🐛 45 | 🌐 Python | 📅 2026-07-20：汉字拼音转换工具 Python 版。
  * [ftfy](https://github.com/LuminosoInsight/python-ftfy) ⭐ 4,062 | 🐛 25 | 🌐 Python | 📅 2024-10-30：让 Unicode 文本更完整更连贯。
  * [thefuzz](https://github.com/seatgeek/thefuzz) ⭐ 3,645 | 🐛 47 | 🌐 Python | 📅 2025-03-03：模糊字符串匹配。
  * [textdistance](https://github.com/orsinium/textdistance) ⭐ 3,539 | 🐛 11 | 🌐 Python | 📅 2025-04-18：支持 30 多种算法来计算序列之间的距离。
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,666 | 🐛 0 | 🌐 Python | 📅 2026-08-30：字符编码检测器，兼容 Python 2 和 Python 3。
  * [shortuuid](https://github.com/stochastic-technologies/shortuuid) ⭐ 2,198 | 🐛 0 | 🌐 Python | 📅 2026-06-20：一个生成器库，用以生成简洁的，明白的，URL 安全的 UUID。
...
* Slug 化
  * [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,623 | 🐛 17 | 🌐 Python | 📅 2026-04-27：Python slug 化库，可以把 unicode 转化为 ASCII。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,771 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,771 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,513 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 33 | 🌐 Python | 📅 2026-09-05：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,710 | 🐛 516 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,511 | 🐛 535 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  * [unoconv](https://github.com/dagwieers/unoconv) ⚠️ Archived：在 LibreOffice/OpenOffice 支持的任意文件格式之间进行转换。
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,699 | 🐛 177 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,190 | 🐛 134 | 🌐 Python | 📅 2026-09-04：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,246 | 🐛 30 | 🌐 Python | 📅 2026-09-04：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,071 | 🐛 22 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,901 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,139 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,479 | 🐛 439 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,872 | 🐛 94 | 🌐 Python | 📅 2026-09-05：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [thulac](https://github.com/thunlp/THULAC-Python) ⭐ 2,083 | 🐛 87 | 🌐 Python | 📅 2022-01-31：清华大学自然语言处理与社会人文计算实验室研制推出的一套中文词法分析工具包。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,383 | 🐛 389 | 🌐 Python | 📅 2026-09-06：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,637 | 🐛 74 | 🌐 Python | 📅 2026-09-05：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,214 | 🐛 195 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,899 | 🐛 183 | 🌐 Python | 📅 2026-09-04：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,567 | 🐛 712 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,325 | 🐛 375 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,306 | 🐛 614 | 🌐 Python | 📅 2026-09-06：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  ...
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,076 | 🐛 311 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,235 | 🐛 728 | 🌐 Python | 📅 2026-09-04：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,845 | 🐛 28 | 🌐 Python | 📅 2026-04-15：通过命令行获取即时的编程问题解答。
  * [PathPicker](https://github.com/facebook/PathPicker) ⭐ 5,225 | 🐛 26 | 🌐 Python | 📅 2024-09-05：从 bash 输出中选出文件。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,571 | 🐛 139 | 🌐 Python | 📅 2026-09-05： [tmux](https://github.com/tmux/tmux) ⭐ 49,078 | 🐛 31 | 🌐 C | 📅 2026-09-05 会话管理器。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,485 | 🐛 337 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,373 | 🐛 37 | 🌐 Python | 📅 2026-09-04：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,973 | 🐛 1 | 🌐 Python | 📅 2026-09-05：支持自动补全和语法高亮的 MySQL 命令行客户端
  ...
  * [iredis](https://github.com/laixintao/iredis) ⭐ 2,741 | 🐛 52 | 🌐 Python | 📅 2026-09-02：支持自动补全和高亮显示的 redis 命令行工具。
  * [kube-shell](https://github.com/cloudnativelabs/kube-shell) ⭐ 2,390 | 🐛 67 | 🌐 Python | 📅 2022-11-02：K8S 命令行集成的 shell 工具。
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,632 | 🐛 76 | 🌐 Python | 📅 2026-09-01：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,426 | 🐛 7 | 🌐 Python | 📅 2026-09-02：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,707 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [python-qrcode](https://github.com/lincolnloop/python-qrcode) ⭐ 4,937 | 🐛 55 | 🌐 Python | 📅 2026-03-25：一个纯 Python 实现的二维码生成器。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,935 | 🐛 242 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,623 | 🐛 714 | 🌐 Python | 📅 2026-09-05：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,588 | 🐛 52 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,620 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 836 | 🐛 6 | 🌐 Python | 📅 2026-09-05：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,857 | 🐛 54 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,533 | 🐛 214 | 🌐 Python | 📅 2026-09-05：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,460 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,573 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,053 | 🐛 223 | 🌐 Python | 📅 2026-09-05：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,561 | 🐛 12 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  ...
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,537 | 🐛 5 | 🌐 Python | 📅 2026-08-22 分支，支持 Python 3。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,626 | 🐛 80 | 🌐 Python | 📅 2026-09-04：Redis 的 Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,984 | 🐛 0 | 🌐 Python | 📅 2026-09-05：一个小巧，富有表现力的 ORM。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,233 | 🐛 10 | 🌐 Python | 📅 2026-08-18 系列
...
* [Pyramid](https://pylonsproject.org/)：一个小巧，快速，接地气的开源 Python web 框架。
  * [awesome-pyramid](https://github.com/uralbash/awesome-pyramid) ⭐ 575 | 🐛 0 | 📅 2021-07-08 系列
...
* [channels](https://github.com/django/channels) ⭐ 6,353 | 🐛 123 | 🌐 Python | 📅 2026-08-06：开发者友好的 Django 异步工具。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,912 | 🐛 33 | 🌐 Python | 📅 2026-09-03：Django 1.2+ ，实现了单个对象权限。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,099 | 🐛 87 | 🌐 Python | 📅 2026-09-01：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,375 | 🐛 2 | 🌐 Python | 📅 2026-09-01：Django 的验证应用。
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,412 | 🐛 144 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,764 | 🐛 104 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,026 | 🐛 0 | 🌐 Python | 📅 2026-09-04：小型多线程任务队列。
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,311 | 🐛 65 | 🌐 Python | 📅 2026-09-02：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-haystack](https://github.com/django-haystack/django-haystack) ⭐ 3,734 | 🐛 581 | 🌐 Python | 📅 2026-08-21：Django 模块化搜索。
* [pysolr](https://github.com/django-haystack/pysolr) ⭐ 702 | 🐛 24 | 🌐 Python | 📅 2026-08-27：支持 [Apache Solr](https://lucene.apache.org/solr/) 的轻量级 Python 装饰器。
...
* [Stream-Framework](https://github.com/tschellenbach/Stream-Framework) ⭐ 4,743 | 🐛 76 | 🌐 Python | 📅 2025-12-04：使用 Cassandra 和 Redis 创建动态消息和通知系统。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,342 | 🐛 55 | 🌐 Python | 📅 2026-09-05：Mailgun 库，用来抽取信息和签名。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,150 | 🐛 514 | 🌐 Python | 📅 2026-08-31：使用 Python 进行新闻提取，文章提取以及内容策展。
...
* [python-readability](https://github.com/buriy/python-readability) ⭐ 2,894 | 🐛 21 | 🌐 HTML | 📅 2026-08-27：arc90 公司 readability 工具的 Python 高速端口。
...
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,236 | 🐛 134 | 🌐 C++ | 📅 2026-09-05 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 531 | 🐛 21 | 🌐 C++ | 📅 2026-09-05： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,122 | 🐛 792 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [django-taggit](https://github.com/alex/django-taggit) ⭐ 3,447 | 🐛 114 | 🌐 Python | 📅 2026-08-24：简单的 Django 标记工具。
...
* [flower](https://github.com/mher/flower) ⭐ 7,243 | 🐛 154 | 🌐 Python | 📅 2026-08-16：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,819 | 🐛 687 | 🌐 Python | 📅 2023-03-23：在 AWS Lambda 和 API Gateway 部署 WSGI 应用的工具。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,315 | 🐛 327 | 🌐 Python | 📅 2026-09-01：异步并发和 I/O 友好的库。
...
* [Crossbar](https://github.com/crossbario/crossbar/) ⭐ 2,064 | 🐛 305 | 🌐 Python | 📅 2026-08-31：开源统一应用路由(Websocket & WAMP for Python on Autobahn)。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,944 | 🐛 88 | 🌐 Python | 📅 2026-09-01：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,684 | 🐛 40 | 🌐 Python | 📅 2026-08-28：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,599 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,813 | 🐛 708 | 🌐 Python | 📅 2026-08-30：tkinter，Qt，WxPython 和 Remi 的封装。
* [Eel](https://github.com/ChrisKnott/Eel) ⚠️ Archived：用于制作简单离线 HTML/JS GUI 应用的库。
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,009 | 🐛 15 | 🌐 Python | 📅 2026-09-03：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,410 | 🐛 310 | 🌐 Python | 📅 2026-09-04：一个 Python 原生的，操作系统原生的 GUI 工具包。
* [Flexx](https://github.com/zoofIO/flexx) ⭐ 3,329 | 🐛 96 | 🌐 Python | 📅 2025-01-20：Flexx 是一个纯 Python 语言编写的用来创建 GUI 程序的工具集，它使用 web 技术进行界面的展示。
* [enaml](https://github.com/nucleic/enaml) ⭐ 1,576 | 🐛 60 | 🌐 Python | 📅 2026-08-03：使用类似 QML 的 Declaratic 语法来创建美观的用户界面。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,094 | 🐛 253 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,201 | 🐛 390 | 🌐 Python | 📅 2026-09-04：Python 版 Sentry SDK。
...
* 测试框架
  ...
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,941 | 🐛 45 | 🌐 Python | 📅 2026-09-06：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,129 | 🐛 5 | 🌐 Python | 📅 2026-08-26：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,676 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,581 | 🐛 10 | 🌐 Python | 📅 2026-09-05：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  ...
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,003 | 🐛 165 | 🌐 Python | 📅 2026-09-01：在你的测试中记录和重放 HTTP 交互。
...
* 伪数据
  * [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,838 | 🐛 14 | 🌐 Python | 📅 2026-08-23：一个帮助你生成伪数据的 Python 库。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,366 | 🐛 32 | 🌐 Python | 📅 2026-09-04：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,261 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,291 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。

### 代码分析和 Lint 工具

进行代码分析、解析和操作代码库的库和工具。

* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,983 | 🐛 6 | 📅 2026-09-03

  * [pyre-check](https://github.com/facebook/pyre-check) ⚠️ Archived：性能类型检查。
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,118 | 🐛 375 | 🌐 Python | 📅 2026-09-06：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,794 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
...
* Lint 工具
  * [YAPF](https://github.com/google/yapf) ⭐ 13,984 | 🐛 418 | 🌐 Python | 📅 2026-08-28：Google 的 Python 代码格式化工具。

  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,900 | 🐛 14 | 🌐 Python | 📅 2026-09-04：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,828 | 🐛 306 | 🌐 Python | 📅 2026-09-04：一个坚定的 Python 代码格式化工具。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,476 | 🐛 239 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,376 | 🐛 77 | 🌐 Python | 📅 2026-09-05：为 Django 显示各种调试信息。
  ...
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 1 | 🌐 Python | 📅 2019-02-15：[statsd](https://github.com/etsy/statsd/) ⭐ 18,077 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,083 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,909 | 🐛 5,968 | 🌐 Python | 📅 2026-09-05：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,605 | 🐛 2,808 | 🌐 Python | 📅 2026-09-05：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,739 | 🐛 490 | 🌐 Python | 📅 2026-09-03：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,120 | 🐛 54 | 🌐 Python | 📅 2026-09-05：AWS 平台上使用的 Pandas。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,022 | 🐛 21 | 📅 2026-09-02。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,588 | 🐛 388 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,445 | 🐛 856 | 🌐 Python | 📅 2026-09-05：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,012 | 🐛 231 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,467 | 🐛 153 | 🌐 Python | 📅 2026-09-05：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,757 | 🐛 83 | 🌐 Python | 📅 2026-09-04：基于ggplot2的Python图形语法。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,707 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,977 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,345 | 🐛 174 | 🌐 Python | 📅 2026-09-06：PyTorch 的开源差异化计算机视觉库。
...
* [tesserocr](https://github.com/sirfz/tesserocr) ⭐ 2,173 | 🐛 46 | 🌐 Python | 📅 2026-08-04：另一个简单的，兼容 Pillow 的 `tesseract-ocr` API 装饰器，可用于 OCR。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,864 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,863 | 🐛 3,064 | 🌐 C++ | 📅 2026-09-06 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,260 | 🐛 30 | 🌐 Python | 📅 2026-09-02。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,698 | 🐛 6 | 🌐 Makefile | 📅 2026-09-04：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,736 | 🐛 429 | 🌐 C++ | 📅 2026-09-04：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,860 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,500 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-09-02：开源快速可扩展的机器学习平台。
* [NuPIC](https://github.com/numenta/nupic) ⭐ 6,349 | 🐛 465 | 🌐 Python | 📅 2024-12-03：智能计算 Numenta 平台。
* [PyBrain](https://github.com/pybrain/pybrain) ⭐ 2,856 | 🐛 156 | 🌐 Python | 📅 2024-06-27：另一个 Python 机器学习库。
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,767 | 🐛 201 | 🌐 Python | 📅 2021-08-20：一个基于 [Theano](https://github.com/Theano/Theano) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15 的机器学习库。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,293 | 🐛 86 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
* [Surprise](https://github.com/NicolasHug/Surprise) ⭐ 6,810 | 🐛 80 | 🌐 Python | 📅 2026-05-30：用于构建和分析推荐系统的科学工具。
...
* [fastFM](https://github.com/ibayer/fastFM) ⭐ 1,085 | 🐛 51 | 🌐 Python | 📅 2022-07-17：Factorization Machine 相关库。

### 分布式计算

分布式计算相关的框架和库。

* [Ray](https://github.com/ray-project/ray/) ⭐ 43,712 | 🐛 3,570 | 🌐 Python | 📅 2026-09-05：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,769 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,911 | 🐛 1,325 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,358 | 🐛 81 | 🌐 Python | 📅 2026-09-04：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,355 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 11 | 🌐 Python | 📅 2026-09-04：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,511 | 🐛 16 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
...
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,922 | 🐛 50 | 🌐 Python | 📅 2026-09-04：Python 用的 Google APIs 客户端库。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,592 | 🐛 841 | 🌐 Python | 📅 2026-09-04：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,649 | 🐛 1,885 | 🌐 Python | 📅 2026-09-05：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,272 | 🐛 258 | 🌐 Python | 📅 2026-09-05：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,109 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,977 | 🐛 177 | 🌐 Python | 📅 2026-08-31：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,787 | 🐛 861 | 🌐 Python | 📅 2026-09-05：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,045 | 🐛 1,526 | 🌐 C | 📅 2026-09-04：精简高效的 Python 编程语言实现。
...
* [PythonNet](https://github.com/pythonnet/pythonnet) ⭐ 5,514 | 🐛 165 | 🌐 C# | 📅 2026-08-16：Python 与 .NET 公共语言运行库 (CLR)的集成。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,500 | 🐛 174 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,521 | 🐛 140 | 🌐 Python | 📅 2026-09-04：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,503 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,290 | 🐛 813 | 🌐 Python | 📅 2026-09-05：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,543 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,966 | 🐛 12 | 🌐 Python | 📅 2026-09-04：一个 Python 设计模式集合。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,834 | 🐛 153 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,831 | 🐛 46 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,449 | 🐛 54 | 🌐 Python | 📅 2026-09-02：各种具有可视化效果的机器人算法的汇总。
...
* [errbot](https://github.com/errbotio/errbot/) ⭐ 3,305 | 🐛 45 | 🌐 Python | 📅 2026-08-17：实现 ChatOps 的最简单最受欢迎的聊天机器人。
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,892 | 🐛 36 | 🌐 Python | 📅 2026-09-03：包含 Jedi 补全的 Python 引擎。
...
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,565 | 🐛 159 | 🌐 C# | 📅 2026-08-28：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,310 | 🐛 1,344 | 🌐 Python | 📅 2026-09-04： 开源 Python IDE。
...
* [graphene](https://github.com/graphql-python/graphene/) ⭐ 8,238 | 🐛 113 | 🌐 Python | 📅 2025-09-04：Python GraphQL 框架。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,140 | 🐛 34 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,550 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,092 | 🐛 239 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,487 | 🐛 4 | 🌐 C++ | 📅 2026-09-04：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,918 | 🐛 86 | 🌐 Python | 📅 2026-08-19：一组纯 Python 实用工具。
* [itsdangerous](https://github.com/pallets/itsdangerous) ⭐ 3,133 | 🐛 4 | 🌐 Python | 📅 2025-06-14：将受信任的数据传递到不受信任的环境的帮助工具。
* [blinker](https://github.com/jek/blinker) ⭐ 2,092 | 🐛 0 | 🌐 Python | 📅 2025-11-19：快速的 Python 运行时信号/事件分配系统。
