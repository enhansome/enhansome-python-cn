...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,965 | 🐛 18 | 🌐 Python | 📅 2026-08-16 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,033 | 🐛 56 | 🌐 Shell | 📅 2026-08-16：简单的 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,041 | 🐛 21 | 🌐 Python | 📅 2026-08-19：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,007 | 🐛 177 | 🌐 Python | 📅 2026-08-19：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,486 | 🐛 667 | 🌐 Python | 📅 2026-08-19：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,132 | 🐛 577 | 🌐 Python | 📅 2026-08-19：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,072 | 🐛 291 | 🌐 Python | 📅 2026-08-18：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,170 | 🐛 12 | 🌐 Python | 📅 2026-08-14：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,411 | 🐛 316 | 🌐 Python | 📅 2026-08-11：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,770 | 🐛 1,292 | 🌐 Python | 📅 2026-08-18：功能丰富的工具，非常有效的使用交互式 Python。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,396 | 🐛 245 | 🌐 Python | 📅 2026-08-15：管理文件系统事件的 API 和 shell 工具。
...
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,672 | 🐛 267 | 🌐 Python | 📅 2026-07-06：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
...
* 通用
  ...
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,658 | 🐛 0 | 🌐 Python | 📅 2026-08-18：字符编码检测器，兼容 Python 2 和 Python 3。
...
* 解析器
  ...
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 713 | 🐛 32 | 🌐 Python | 📅 2026-08-19：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,696 | 🐛 512 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  ...
  * [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,292 | 🐛 11 | 🌐 Python | 📅 2026-07-01：一个提供统一 API，用来读写，操作 Excel 文件的库。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,163 | 🐛 143 | 🌐 Python | 📅 2026-08-19：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,234 | 🐛 30 | 🌐 Python | 📅 2026-08-08：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,065 | 🐛 20 | 🌐 Python | 📅 2026-08-14：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
  * [Python-Markdown2](https://github.com/trentm/python-markdown2) ⭐ 2,820 | 🐛 94 | 🌐 Python | 📅 2026-08-18：纯 Python 实现的 Markdown 解析器，比 Python-Markdown 更快，更准确，可扩展。
* YAML
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,547 | 🐛 52 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,123 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,478 | 🐛 436 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,864 | 🐛 92 | 🌐 Python | 📅 2026-08-19：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,375 | 🐛 395 | 🌐 Python | 📅 2026-08-19：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,608 | 🐛 109 | 🌐 Python | 📅 2026-08-19：一个优雅地配置复杂应用程序的框架。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,089 | 🐛 371 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,277 | 🐛 597 | 🌐 Python | 📅 2026-08-17：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,717 | 🐛 454 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,058 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,202 | 🐛 710 | 🌐 Python | 📅 2026-08-19：Amazon Web Services 的通用命令行界面。
  ...
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,770 | 🐛 459 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,560 | 🐛 138 | 🌐 Python | 📅 2026-08-16： [tmux](https://github.com/tmux/tmux) ⭐ 48,725 | 🐛 25 | 🌐 C | 📅 2026-08-19 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,576 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,530 | 🐛 147 | 🌐 Python | 📅 2026-08-19：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,434 | 🐛 332 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,356 | 🐛 43 | 🌐 Python | 📅 2026-08-18：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,965 | 🐛 4 | 🌐 Python | 📅 2026-08-18：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,606 | 🐛 73 | 🌐 Python | 📅 2026-08-18：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,123 | 🐛 1 | 🌐 Python | 📅 2026-08-19：为方便人使用而创建的金融数据接口库。
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,903 | 🐛 311 | 🌐 Python | 📅 2025-10-22：一个用来管理 Amazon S3 和 CloudFront 的命令行工具。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,669 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,511 | 🐛 20 | 🌐 Python | 📅 2026-08-16：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 87,940 | 🐛 234 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,378 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的一个封装。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,560 | 🐛 709 | 🌐 Python | 📅 2026-08-19：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,791 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,566 | 🐛 47 | 🌐 Python | 📅 2026-08-19：音频音乐分析 Python 库。
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,609 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,846 | 🐛 53 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,528 | 🐛 249 | 🌐 Python | 📅 2026-08-19：基于 asyncio 的异步 HTTP 网络库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  ...
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,531 | 🐛 5 | 🌐 Python | 📅 2026-07-26 分支，支持 Python 3。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,609 | 🐛 83 | 🌐 Python | 📅 2026-08-19：Redis 的 Python 客户端。
  * [kafka-python](https://github.com/dpkp/kafka-python) ⭐ 5,897 | 🐛 18 | 🌐 Python | 📅 2026-08-17：Apache Kafka Python 客户端。
...
* 关系型数据库
  ...
  * [awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) ⭐ 3,051 | 🐛 10 | 🌐 Python | 📅 2026-06-08 系列
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,203 | 🐛 10 | 🌐 Python | 📅 2026-08-18 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,712 | 🐛 1 | 🌐 Python | 📅 2026-08-19：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,909 | 🐛 39 | 🌐 Python | 📅 2026-07-30：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,099 | 🐛 889 | 🌐 Python | 📅 2026-08-19：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,711 | 🐛 74 | 🌐 Python | 📅 2026-08-19：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,370 | 🐛 2 | 🌐 Python | 📅 2026-08-13：Django 的验证应用。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,685 | 🐛 65 | 🌐 Python | 📅 2026-08-17：JSON Web 令牌草案 01。
  * [python-jose](https://github.com/mpdavis/python-jose/) ⭐ 1,758 | 🐛 120 | 🌐 Python | 📅 2026-04-14：python 版 JOSE 实现。
...
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,309 | 🐛 60 | 🌐 Python | 📅 2026-08-13：适用于Python 3的快速可靠的后台任务处理库。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,530 | 🐛 52 | 🌐 Python | 📅 2026-08-14：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [furl](https://github.com/gruns/furl) ⭐ 2,811 | 🐛 53 | 🌐 Python | 📅 2026-02-22：一个让处理 URL 更简单小型 Python 库。
* [webargs](https://github.com/sloria/webargs) ⭐ 1,407 | 🐛 8 | 🌐 Python | 📅 2026-08-13：一个解析 HTTP 请求参数的库，内置对流行 web 框架的支持，包括 Flask, Django, Bottle, Tornado 和 Pyramid。
...
* [pyquery](https://github.com/gawel/pyquery) ⭐ 2,379 | 🐛 60 | 🌐 Python | 📅 2026-07-27：一个解析 HTML 的库，类似 jQuery。
...
* [django-bootstrap3](https://github.com/dyve/django-bootstrap3) ⭐ 2,333 | 🐛 4 | 🌐 Python | 📅 2026-08-17：集成了 Bootstrap 3 的 Django。
* [django-bootstrap4](https://github.com/zostera/django-bootstrap4) ⭐ 1,025 | 🐛 18 | 🌐 Python | 📅 2026-08-17：集成了 Bootstrap 4 的 Django。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,973 | 🐛 68 | 🌐 Python | 📅 2026-08-17：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
* [schema](https://github.com/keleshev/schema) ⭐ 2,947 | 🐛 109 | 🌐 Python | 📅 2026-06-20：一个用于对 Python 数据结构进行验证的库。
* [Schematics](https://github.com/schematics/schematics) ⭐ 2,588 | 🐛 109 | 🌐 Python | 📅 2023-07-12：数据结构验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,242 | 🐛 147 | 🌐 Python | 📅 2026-08-18：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,497 | 🐛 32 | 🌐 C++ | 📅 2026-08-13：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 770 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,161 | 🐛 133 | 🌐 C++ | 📅 2026-08-19 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 22 | 🌐 C++ | 📅 2026-08-09： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,113 | 🐛 789 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [Ajenti](https://github.com/ajenti/ajenti) ⭐ 7,956 | 🐛 10 | 🌐 Python | 📅 2026-07-22：一个你的服务器值得拥有的管理面板。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,303 | 🐛 322 | 🌐 Python | 📅 2026-08-18：异步并发和 I/O 友好的库。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,911 | 🐛 82 | 🌐 Python | 📅 2026-08-19：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,677 | 🐛 39 | 🌐 Python | 📅 2026-07-21：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [PyNacl](https://github.com/pyca/pynacl) ⭐ 1,204 | 🐛 56 | 🌐 C | 📅 2026-08-18：网络和密码学(NaCl) 库的 Python 绑定。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 5,987 | 🐛 17 | 🌐 Python | 📅 2026-08-11：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,404 | 🐛 306 | 🌐 Python | 📅 2026-08-18：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,070 | 🐛 267 | 🌐 Python | 📅 2026-07-01：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 449 | 🌐 Python | 📅 2026-08-19：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,826 | 🐛 300 | 🌐 Python | 📅 2026-08-19：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,899 | 🐛 45 | 🌐 Python | 📅 2026-08-16：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,080 | 🐛 3 | 🌐 Python | 📅 2026-08-19：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,665 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,540 | 🐛 10 | 🌐 Python | 📅 2026-08-19：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,523 | 🐛 165 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,225 | 🐛 32 | 🌐 Python | 📅 2026-08-18：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,212 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,976 | 🐛 7 | 📅 2026-06-19
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,109 | 🐛 394 | 🌐 Python | 📅 2026-08-19：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,768 | 🐛 69 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,603 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
  * [prospector](https://github.com/PyCQA/prospector) ⭐ 2,086 | 🐛 34 | 🌐 Python | 📅 2026-08-18：分析 Python 代码的工具。
  * [pycallgraph](https://github.com/gak/pycallgraph) ⚠️ Archived：这个库可以把你的 Python 应用的流程(调用图)进行可视化。
  * [pysonar2](https://github.com/yinwang0/pysonar2) ⭐ 1,426 | 🐛 2 | 🌐 Java | 📅 2026-03-02：Python 类型推断和检索工具。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,889 | 🐛 23 | 🌐 Python | 📅 2026-08-18：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,809 | 🐛 297 | 🌐 Python | 📅 2026-08-19：一个坚定的 Python 代码格式化工具。
...
* 静态类型注释生成器
  ...
  * [pytype](https://github.com/google/pytype) ⭐ 5,028 | 🐛 5 | 🌐 Python | 📅 2026-03-16：检查和推断 Python 代码中的类型，无需添加注解。
...
* 追踪器
  ...
  * [lptrace](https://github.com/khamidou/lptrace) ⭐ 699 | 🐛 7 | 🌐 Python | 📅 2018-10-26：为 Python 程序打造的 [strace](http://man7.org/linux/man-pages/man1/strace.1.html)。
  * [manhole](https://github.com/ionelmc/python-manhole) ⭐ 402 | 🐛 9 | 🌐 Python | 📅 2024-07-04：调试UNIX套接字连接，并显示所有线程的堆栈跟踪和交互式提示。

* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,442 | 🐛 236 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
  * [vprof](https://github.com/nvdv/vprof) ⭐ 3,979 | 🐛 30 | 🌐 Python | 📅 2022-07-15：视觉 Python 分析器。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,377 | 🐛 83 | 🌐 Python | 📅 2026-08-17：为 Django 显示各种调试信息。
...
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,874 | 🐛 5,953 | 🌐 Python | 📅 2026-08-19：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,582 | 🐛 2,829 | 🌐 Python | 📅 2026-08-19：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,715 | 🐛 477 | 🌐 Python | 📅 2026-08-17：马尔科夫链蒙特卡洛采样工具。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,328 | 🐛 311 | 🌐 Python | 📅 2026-08-10：地震学 Python 工具箱。
...
* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,528 | 🐛 387 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,433 | 🐛 850 | 🌐 Python | 📅 2026-08-19：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,777 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,000 | 🐛 230 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,669 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,919 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,316 | 🐛 88 | 🌐 Python | 📅 2026-08-18：PyTorch 的开源差异化计算机视觉库。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,378 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的另一包装库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,781 | 🐛 84 | 📅 2025-05-26。

* [Caffe](http://caffe.berkeleyvision.org)：一个 [Caffe](https://github.com/BVLC/caffe) ⭐ 34,560 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 的 python 接口。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,068 | 🐛 3,087 | 🌐 C++ | 📅 2026-08-19 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,076 | 🐛 26 | 🌐 Python | 📅 2026-08-11。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,610 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,673 | 🐛 422 | 🌐 C++ | 📅 2026-08-19：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,860 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,494 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-19：开源快速可扩展的机器学习平台。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,289 | 🐛 84 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,560 | 🐛 3,514 | 🌐 Python | 📅 2026-08-19：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,766 | 🐛 167 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,892 | 🐛 1,310 | 🌐 Python | 📅 2026-08-17：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,350 | 🐛 81 | 🌐 Python | 📅 2026-08-18：一个类型安全的单元、转换器与合成工具集合。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,873 | 🐛 189 | 🌐 Python | 📅 2026-08-19：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,903 | 🐛 62 | 🌐 Python | 📅 2026-07-14：Python 用的 Google APIs 客户端库。
* [gspread](https://github.com/burnash/gspread) ⭐ 7,499 | 🐛 71 | 🌐 Python | 📅 2026-07-30：Google 电子表格的 Python API。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,375 | 🐛 830 | 🌐 Python | 📅 2026-08-19：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,625 | 🐛 1,931 | 🌐 Python | 📅 2026-08-19：基础设施自动化和管理系统。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,643 | 🐛 865 | 🌐 Python | 📅 2026-08-19：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,233 | 🐛 140 | 🌐 Python | 📅 2026-08-16：一个 Python 的重构库。

### 高性能

让 Python 更快的库。

* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,995 | 🐛 1,535 | 🌐 C | 📅 2026-08-18：精简高效的 Python 编程语言实现。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,487 | 🐛 173 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,480 | 🐛 134 | 🌐 Python | 📅 2026-08-18：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,460 | 🐛 0 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 223,885 | 🐛 1,045 | 🌐 Python | 📅 2026-08-03：所有算法的 Python 实现。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,933 | 🐛 15 | 🌐 Python | 📅 2026-08-13：一个 Python 设计模式集合。
...
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,832 | 🐛 46 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
* [bidict](https://github.com/jab/bidict) ⭐ 1,585 | 🐛 1 | 🌐 Python | 📅 2026-08-19：高效的 Pythonic 的双向映射数据结构和相关功能。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,325 | 🐛 50 | 🌐 Python | 📅 2026-08-17：各种具有可视化效果的机器人算法的汇总。
...
* [errbot](https://github.com/errbotio/errbot/) ⭐ 3,298 | 🐛 44 | 🌐 Python | 📅 2026-08-17：实现 ChatOps 的最简单最受欢迎的聊天机器人。
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,895 | 🐛 36 | 🌐 Python | 📅 2026-08-17：包含 Jedi 补全的 Python 引擎。
...
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,565 | 🐛 156 | 🌐 C# | 📅 2026-08-19：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,290 | 🐛 1,345 | 🌐 Python | 📅 2026-08-19： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 44,619 | 🐛 31 | 🌐 Python | 📅 2026-08-10：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,172 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,018 | 🐛 239 | 🌐 Python | 📅 2026-02-28：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,453 | 🐛 6 | 🌐 C++ | 📅 2026-08-19：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
