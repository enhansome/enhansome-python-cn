...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 319,387 | 🐛 19 | 🌐 Python | 📅 2026-09-01 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,087 | 🐛 55 | 🌐 Shell | 📅 2026-09-08：简单的 Python 版本管理工具。
...
* [conda](https://github.com/conda/conda/) ⭐ 7,504 | 🐛 659 | 🌐 Python | 📅 2026-09-08：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,147 | 🐛 585 | 🌐 Python | 📅 2026-09-08：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,087 | 🐛 289 | 🌐 Python | 📅 2026-09-06：将 Python 程序转换成独立的执行文件（跨平台）。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,449 | 🐛 277 | 🌐 Python | 📅 2026-09-07：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,776 | 🐛 1,280 | 🌐 Python | 📅 2026-09-07：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,565 | 🐛 713 | 🌐 Python | 📅 2026-07-26 之上。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,407 | 🐛 254 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
* [aiofiles](https://github.com/Tinche/aiofiles) ⭐ 3,258 | 🐛 58 | 🌐 Python | 📅 2026-08-29：基于 asyncio，提供文件异步操作。
...
* [path.py](https://github.com/jaraco/path.py) ⭐ 1,125 | 🐛 8 | 🌐 Python | 📅 2026-04-13：对 os.path 进行封装的模块。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,051 | 🐛 193 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,674 | 🐛 270 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
* [maya](https://github.com/kennethreitz/maya) ⭐ 3,410 | 🐛 21 | 🌐 Python | 📅 2024-07-19：人性化的时间处理库。
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,633 | 🐛 484 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* Slug 化
  * [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,623 | 🐛 0 | 🌐 Python | 📅 2026-09-08：Python slug 化库，可以把 unicode 转化为 ASCII。
...
* 解析器
  ...
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 23 | 🌐 Python | 📅 2026-09-08：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,713 | 🐛 518 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,521 | 🐛 535 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  * [unoconv](https://github.com/dagwieers/unoconv) ⚠️ Archived：在 LibreOffice/OpenOffice 支持的任意文件格式之间进行转换。
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,701 | 🐛 177 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,197 | 🐛 132 | 🌐 Python | 📅 2026-09-08：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,247 | 🐛 31 | 🌐 Python | 📅 2026-09-06：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,072 | 🐛 26 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,411 | 🐛 41 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,959 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
...
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,874 | 🐛 94 | 🌐 Python | 📅 2026-09-08：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [langid.py](https://github.com/saffsd/langid.py) ⭐ 2,461 | 🐛 28 | 🌐 Python | 📅 2020-01-01：独立的语言识别系统。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,385 | 🐛 395 | 🌐 Python | 📅 2026-09-08：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,641 | 🐛 73 | 🌐 Python | 📅 2026-09-08：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,218 | 🐛 196 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,899 | 🐛 183 | 🌐 Python | 📅 2026-09-04：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,565 | 🐛 713 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,345 | 🐛 374 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,329 | 🐛 614 | 🌐 Python | 📅 2026-09-07：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,304 | 🐛 22 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,780 | 🐛 455 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,082 | 🐛 311 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,240 | 🐛 731 | 🌐 Python | 📅 2026-09-09：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,844 | 🐛 17 | 🌐 Python | 📅 2026-09-09：通过命令行获取即时的编程问题解答。
  * [PathPicker](https://github.com/facebook/PathPicker) ⭐ 5,223 | 🐛 26 | 🌐 Python | 📅 2024-09-05：从 bash 输出中选出文件。
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,776 | 🐛 461 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,572 | 🐛 139 | 🌐 Python | 📅 2026-09-05： [tmux](https://github.com/tmux/tmux) ⭐ 49,156 | 🐛 35 | 🌐 C | 📅 2026-09-08 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 14 | 🌐 Python | 📅 2026-09-08：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,561 | 🐛 144 | 🌐 Python | 📅 2026-09-07：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,487 | 🐛 337 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,375 | 🐛 41 | 🌐 Python | 📅 2026-09-04：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 1 | 🌐 Python | 📅 2026-09-08：支持自动补全和语法高亮的 MySQL 命令行客户端
  * [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02：一个加强版的 AWS 命令行。
  * [litecli](https://github.com/dbcli/litecli) ⭐ 3,297 | 🐛 46 | 🌐 Python | 📅 2026-06-18：支持自动补全和语法高亮的 SQLite 命令行工具。
  * [iredis](https://github.com/laixintao/iredis) ⭐ 2,743 | 🐛 51 | 🌐 Python | 📅 2026-09-08：支持自动补全和高亮显示的 redis 命令行工具。
  * [kube-shell](https://github.com/cloudnativelabs/kube-shell) ⭐ 2,391 | 🐛 67 | 🌐 Python | 📅 2022-11-02：K8S 命令行集成的 shell 工具。
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,637 | 🐛 79 | 🌐 Python | 📅 2026-09-07：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,491 | 🐛 8 | 🌐 Python | 📅 2026-09-02：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,723 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [python-qrcode](https://github.com/lincolnloop/python-qrcode) ⭐ 4,936 | 🐛 55 | 🌐 Python | 📅 2026-03-25：一个纯 Python 实现的二维码生成器。
* [PyMatting](https://github.com/pymatting/pymatting) ⭐ 1,914 | 🐛 11 | 🌐 Python | 📅 2026-09-08：支持 alpha matting 的库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,137 | 🐛 240 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,642 | 🐛 709 | 🌐 Python | 📅 2026-09-08：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,594 | 🐛 51 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 838 | 🐛 6 | 🌐 Python | 📅 2026-09-07：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,543 | 🐛 218 | 🌐 Python | 📅 2026-09-09：基于 asyncio 的异步 HTTP 网络库。
...
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,054 | 🐛 234 | 🌐 Python | 📅 2026-09-08：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,563 | 🐛 12 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,631 | 🐛 86 | 🌐 Python | 📅 2026-09-08：Redis 的 Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-09-08：一个小巧，富有表现力的 ORM。
  ...
  * [pydal](https://github.com/web2py/pydal/) ⭐ 536 | 🐛 149 | 🌐 Python | 📅 2026-09-08：纯 Python 数据库抽象接口层。
...
* NoSQL 数据库
  * [PynamoDB](https://github.com/jlafon/PynamoDB) ⭐ 2,646 | 🐛 319 | 🌐 Python | 📅 2026-05-29：[Amazon DynamoDB](https://aws.amazon.com/dynamodb/) 的一个 Python 风格接口。
...
* [sanic](https://github.com/channelcat/sanic/) ⭐ 18,641 | 🐛 148 | 🌐 Python | 📅 2026-07-29：基于 Python3.5+ 的异步网络框架。
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,762 | 🐛 4 | 📅 2026-08-17 系列
* [Pyramid](https://pylonsproject.org/)：一个小巧，快速，接地气的开源 Python web 框架。
  * [awesome-pyramid](https://github.com/uralbash/awesome-pyramid) ⭐ 574 | 🐛 0 | 📅 2021-07-08 系列
...
* [channels](https://github.com/django/channels) ⭐ 6,355 | 🐛 123 | 🌐 Python | 📅 2026-08-06：开发者友好的 Django 异步工具。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,912 | 🐛 32 | 🌐 Python | 📅 2026-09-03：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,106 | 🐛 885 | 🌐 Python | 📅 2026-09-08：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,203 | 🐛 80 | 🌐 Python | 📅 2026-09-01：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  ...
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,415 | 🐛 144 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,697 | 🐛 62 | 🌐 Python | 📅 2026-09-08：JSON Web 令牌草案 01。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,033 | 🐛 0 | 🌐 Python | 📅 2026-09-08：小型多线程任务队列。
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,311 | 🐛 67 | 🌐 Python | 📅 2026-09-02：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-haystack](https://github.com/django-haystack/django-haystack) ⭐ 3,733 | 🐛 581 | 🌐 Python | 📅 2026-09-08：Django 模块化搜索。
* [pysolr](https://github.com/django-haystack/pysolr) ⭐ 702 | 🐛 23 | 🌐 Python | 📅 2026-09-08：支持 [Apache Solr](https://lucene.apache.org/solr/) 的轻量级 Python 装饰器。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,343 | 🐛 54 | 🌐 Python | 📅 2026-09-08：Mailgun 库，用来抽取信息和签名。
...
* [webargs](https://github.com/sloria/webargs) ⭐ 1,407 | 🐛 8 | 🌐 Python | 📅 2026-09-08：一个解析 HTTP 请求参数的库，内置对流行 web 框架的支持，包括 Flask, Django, Bottle, Tornado 和 Pyramid。
...
* [html5lib](https://github.com/html5lib/html5lib-python) ⭐ 1,223 | 🐛 105 | 🌐 Python | 📅 2026-04-21：一个兼容标准的 HTML 文档和片段解析及序列化库。
...
* [RoboBrowser](https://github.com/jmcarp/robobrowser) ⭐ 3,691 | 🐛 59 | 🌐 Python | 📅 2020-09-10：一个简单的，Python 风格的库，用来浏览网站，而不需要一个独立安装的浏览器。
...
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,713 | 🐛 57 | 🌐 HTML | 📅 2026-09-01：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
* [python-goose](https://github.com/grangier/python-goose) ⭐ 4,107 | 🐛 107 | 🌐 HTML | 📅 2026-03-10：HTML 内容/文章提取器(python2)。
* [sumy](https://github.com/miso-belica/sumy) ⭐ 3,699 | 🐛 8 | 🌐 Python | 📅 2026-09-08：一个为文本文件和 HTML 页面进行自动摘要的模块。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,237 | 🐛 151 | 🌐 Python | 📅 2026-09-08：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,496 | 🐛 31 | 🌐 C++ | 📅 2026-09-04：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,244 | 🐛 134 | 🌐 C++ | 📅 2026-09-07 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 531 | 🐛 20 | 🌐 C++ | 📅 2026-09-06： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,122 | 🐛 794 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [flower](https://github.com/mher/flower) ⭐ 7,243 | 🐛 58 | 🌐 Python | 📅 2026-09-06：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,817 | 🐛 687 | 🌐 Python | 📅 2023-03-23：在 AWS Lambda 和 API Gateway 部署 WSGI 应用的工具。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,898 | 🐛 159 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
* [gevent](http://www.gevent.org/)：一个基于协程的 Python 网络库，使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,845 | 🐛 24 | 🌐 C++ | 📅 2026-09-01。
* [gevent](http://www.gevent.org/)：使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,845 | 🐛 24 | 🌐 C++ | 📅 2026-09-01 且基于协程的 Python 网络库。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,315 | 🐛 323 | 🌐 Python | 📅 2026-09-07：异步并发和 I/O 友好的库。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,953 | 🐛 91 | 🌐 Python | 📅 2026-09-08：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,685 | 🐛 40 | 🌐 Python | 📅 2026-08-28：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,609 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,011 | 🐛 17 | 🌐 Python | 📅 2026-09-09：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,411 | 🐛 312 | 🌐 Python | 📅 2026-09-07：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,096 | 🐛 255 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 365 | 🌐 Python | 📅 2026-09-08：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,872 | 🐛 300 | 🌐 Python | 📅 2026-09-04：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,950 | 🐛 40 | 🌐 Python | 📅 2026-09-08：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,135 | 🐛 4 | 🌐 Python | 📅 2026-09-07：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,683 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,588 | 🐛 10 | 🌐 Python | 📅 2026-09-08：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  ...
  * [responses](https://github.com/getsentry/responses) ⭐ 4,344 | 🐛 42 | 🌐 Python | 📅 2026-08-26：伪造 Python 中的 requests 库的一个通用库。
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,007 | 🐛 168 | 🌐 Python | 📅 2026-09-08：在你的测试中记录和重放 HTTP 交互。
...
* 伪数据
  * [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,839 | 🐛 15 | 🌐 Python | 📅 2026-09-07：一个帮助你生成伪数据的 Python 库。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,385 | 🐛 32 | 🌐 Python | 📅 2026-09-08：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,276 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,296 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,983 | 🐛 6 | 📅 2026-09-03
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,120 | 🐛 347 | 🌐 Python | 📅 2026-09-09：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,800 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,606 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
  * [prospector](https://github.com/PyCQA/prospector) ⭐ 2,086 | 🐛 32 | 🌐 Python | 📅 2026-09-08：分析 Python 代码的工具。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,898 | 🐛 14 | 🌐 Python | 📅 2026-09-07：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  ...
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,951 | 🐛 92 | 🌐 Python | 📅 2026-08-27：用于纠正包导入顺序的 Python 库。
...
* 调试器
  ...
  * [wdb](https://github.com/Kozea/wdb) ⭐ 1,590 | 🐛 40 | 🌐 Python | 📅 2022-12-06：一个奇异的 web 调试器，通过 WebSockets 工作。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,484 | 🐛 240 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  * [icecream](https://github.com/gruns/icecream) ⭐ 10,109 | 🐛 67 | 🌐 Python | 📅 2026-08-21：通过一个简单的函数调用检查变量、表达式和程序执行情况。
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,378 | 🐛 82 | 🌐 Python | 📅 2026-09-07：为 Django 显示各种调试信息。
...
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,084 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,913 | 🐛 5,967 | 🌐 Python | 📅 2026-09-08：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,615 | 🐛 2,805 | 🌐 Python | 📅 2026-09-08：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,741 | 🐛 490 | 🌐 Python | 📅 2026-09-08：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,120 | 🐛 56 | 🌐 Python | 📅 2026-09-08：AWS 平台上使用的 Pandas。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,332 | 🐛 307 | 🌐 Python | 📅 2026-09-03：地震学 Python 工具箱。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,020 | 🐛 22 | 📅 2026-09-08。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,598 | 🐛 390 | 🌐 Python | 📅 2026-09-08：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,447 | 🐛 855 | 🌐 Python | 📅 2026-09-08：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,772 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,019 | 🐛 232 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 326 | 🌐 Python | 📅 2026-09-08：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,723 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,983 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,348 | 🐛 152 | 🌐 Python | 📅 2026-09-08：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,879 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,334 | 🐛 3,122 | 🌐 C++ | 📅 2026-09-09 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,281 | 🐛 34 | 🌐 Python | 📅 2026-09-08。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,716 | 🐛 7 | 🌐 Makefile | 📅 2026-09-09：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,744 | 🐛 433 | 🌐 C++ | 📅 2026-09-08：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,502 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-09-08：开源快速可扩展的机器学习平台。
...
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,766 | 🐛 201 | 🌐 Python | 📅 2021-08-20：一个基于 [Theano](https://github.com/Theano/Theano) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15 的机器学习库。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,715 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 装饰器。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,296 | 🐛 86 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,748 | 🐛 3,581 | 🌐 Python | 📅 2026-09-09：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,771 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
...
* [Toolz](https://github.com/pytoolz/toolz) ⭐ 5,156 | 🐛 138 | 🌐 Python | 📅 2026-01-01：一组用于迭代器，函数和字典的函数式编程工具。
* [returns](https://github.com/dry-python/returns) ⭐ 4,360 | 🐛 81 | 🌐 Python | 📅 2026-09-07：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,354 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 15 | 🌐 Python | 📅 2026-09-08：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,510 | 🐛 19 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,900 | 🐛 192 | 🌐 Python | 📅 2026-09-08：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,926 | 🐛 48 | 🌐 Python | 📅 2026-09-08：Python 用的 Google APIs 客户端库。
...
* [gmail](https://github.com/charlierguo/gmail) ⭐ 1,809 | 🐛 64 | 🌐 Python | 📅 2023-07-09：Gmail 的 Python 接口。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,618 | 🐛 836 | 🌐 Python | 📅 2026-09-08：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,649 | 🐛 1,885 | 🌐 Python | 📅 2026-09-09：基础设施自动化和管理系统。
...
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,981 | 🐛 186 | 🌐 Python | 📅 2026-09-07：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,805 | 🐛 865 | 🌐 Python | 📅 2026-09-08：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,263 | 🐛 179 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,051 | 🐛 1,522 | 🌐 C | 📅 2026-09-08：精简高效的 Python 编程语言实现。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,527 | 🐛 135 | 🌐 Python | 📅 2026-09-09：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,513 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,396 | 🐛 729 | 🌐 Python | 📅 2026-09-08：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,545 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,971 | 🐛 12 | 🌐 Python | 📅 2026-09-04：一个 Python 设计模式集合。
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,584 | 🐛 22 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,835 | 🐛 154 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,831 | 🐛 49 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,468 | 🐛 55 | 🌐 Python | 📅 2026-09-07：各种具有可视化效果的机器人算法的汇总。
...
* Emacs
  * [elpy](https://github.com/jorgenschaefer/elpy) ⭐ 1,933 | 🐛 394 | 🌐 Emacs Lisp | 📅 2026-07-15：Emacs Python 开发环境。
* Sublime Text
...
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,317 | 🐛 1,344 | 🌐 Python | 📅 2026-09-08： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,276 | 🐛 29 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,577 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,138 | 🐛 239 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,490 | 🐛 4 | 🌐 C++ | 📅 2026-09-08：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,919 | 🐛 75 | 🌐 Python | 📅 2026-09-08：一组纯 Python 实用工具。
