...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,277 | 🐛 24 | 🌐 Python | 📅 2026-09-01 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,100 | 🐛 57 | 🌐 Shell | 📅 2026-09-11：简单的 Python 版本管理工具。
...
* [conda](https://github.com/conda/conda/) ⭐ 7,507 | 🐛 648 | 🌐 Python | 📅 2026-09-12：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,152 | 🐛 581 | 🌐 Python | 📅 2026-09-11：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,094 | 🐛 289 | 🌐 Python | 📅 2026-09-12：将 Python 程序转换成独立的执行文件（跨平台）。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,452 | 🐛 278 | 🌐 Python | 📅 2026-09-11：多平台命令行构建工具。
* [PyBuilder](https://github.com/pybuilder/pybuilder) ⭐ 2,043 | 🐛 104 | 🌐 Python | 📅 2026-09-12：纯 Python 实现的持续化构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,780 | 🐛 1,285 | 🌐 Python | 📅 2026-09-07：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,567 | 🐛 718 | 🌐 Python | 📅 2026-07-26 之上。
* [bpython](https://github.com/bpython/bpython) ⭐ 2,772 | 🐛 150 | 🌐 Python | 📅 2026-09-02：界面丰富的 Python 解析器。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,410 | 🐛 257 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
* [aiofiles](https://github.com/Tinche/aiofiles) ⭐ 3,259 | 🐛 59 | 🌐 Python | 📅 2026-08-29：基于 asyncio，提供文件异步操作。
...
* [path.py](https://github.com/jaraco/path.py) ⭐ 1,125 | 🐛 12 | 🌐 Python | 📅 2026-04-13：对 os.path 进行封装的模块。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,051 | 🐛 197 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,674 | 🐛 274 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
* [maya](https://github.com/kennethreitz/maya) ⭐ 3,410 | 🐛 21 | 🌐 Python | 📅 2024-07-19：人性化的时间处理库。
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,634 | 🐛 490 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  * [flashtext](https://github.com/vi3k6i5/flashtext) ⭐ 5,707 | 🐛 70 | 🌐 Python | 📅 2025-04-13：一个高效的文本查找替换库。
...
* Slug 化
  * [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,624 | 🐛 1 | 🌐 Python | 📅 2026-09-09：Python slug 化库，可以把 unicode 转化为 ASCII。
...
* 解析器
  ...
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 20 | 🌐 Python | 📅 2026-09-12：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,716 | 🐛 521 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,529 | 🐛 537 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  ...
  * [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,291 | 🐛 12 | 🌐 Python | 📅 2026-07-01：一个提供统一 API，用来读写，操作 Excel 文件的库。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,197 | 🐛 131 | 🌐 Python | 📅 2026-09-12：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,246 | 🐛 33 | 🌐 Python | 📅 2026-09-11：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,074 | 🐛 27 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
  * [Python-Markdown2](https://github.com/trentm/python-markdown2) ⭐ 2,822 | 🐛 94 | 🌐 Python | 📅 2026-09-12：纯 Python 实现的 Markdown 解析器，比 Python-Markdown 更快，更准确，可扩展。
* YAML
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,062 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,151 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,482 | 🐛 440 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,876 | 🐛 95 | 🌐 Python | 📅 2026-09-10：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,384 | 🐛 393 | 🌐 Python | 📅 2026-09-13：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,647 | 🐛 74 | 🌐 Python | 📅 2026-09-12：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  ...
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,902 | 🐛 179 | 🌐 Python | 📅 2026-09-12：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,567 | 🐛 718 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,359 | 🐛 374 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,333 | 🐛 622 | 🌐 Python | 📅 2026-09-11：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,305 | 🐛 20 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,844 | 🐛 457 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,087 | 🐛 311 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,252 | 🐛 733 | 🌐 Python | 📅 2026-09-11：Amazon Web Services 的通用命令行界面。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,575 | 🐛 137 | 🌐 Python | 📅 2026-09-12： [tmux](https://github.com/tmux/tmux) ⭐ 49,209 | 🐛 32 | 🌐 C | 📅 2026-09-11 会话管理器。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,503 | 🐛 338 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,383 | 🐛 41 | 🌐 Python | 📅 2026-09-09：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,976 | 🐛 0 | 🌐 Python | 📅 2026-09-12：支持自动补全和语法高亮的 MySQL 命令行客户端
  * [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02：一个加强版的 AWS 命令行。
  * [litecli](https://github.com/dbcli/litecli) ⭐ 3,298 | 🐛 46 | 🌐 Python | 📅 2026-06-18：支持自动补全和语法高亮的 SQLite 命令行工具。
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,642 | 🐛 77 | 🌐 Python | 📅 2026-09-10：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,546 | 🐛 7 | 🌐 Python | 📅 2026-09-09：为方便人使用而创建的金融数据接口库。
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,909 | 🐛 311 | 🌐 Python | 📅 2025-10-22：一个用来管理 Amazon S3 和 CloudFront 的命令行工具。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,736 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [pyvips](https://github.com/libvips/pyvips) ⭐ 814 | 🐛 2 | 🌐 Python | 📅 2026-08-30：低内存消耗且快速的图像处理库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,396 | 🐛 241 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,652 | 🐛 711 | 🌐 Python | 📅 2026-09-12：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 422 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,605 | 🐛 52 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,628 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 840 | 🐛 6 | 🌐 Python | 📅 2026-09-07：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,863 | 🐛 54 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,548 | 🐛 220 | 🌐 Python | 📅 2026-09-11：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,477 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,571 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,055 | 🐛 239 | 🌐 Python | 📅 2026-09-12：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,564 | 🐛 12 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,636 | 🐛 82 | 🌐 Python | 📅 2026-09-10：Redis 的 Python 客户端。
...
* 关系型数据库
  ...
  * [dataset](https://github.com/pudo/dataset) ⭐ 4,872 | 🐛 22 | 🌐 Python | 📅 2026-07-22：在数据库中存储字典，支持 SQLite，MySQL 和 PostgreSQL。
  ...
  * [pydal](https://github.com/web2py/pydal/) ⭐ 536 | 🐛 148 | 🌐 Python | 📅 2026-09-12：纯 Python 数据库抽象接口层。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,242 | 🐛 4 | 🌐 Python | 📅 2026-09-06 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,766 | 🐛 4 | 📅 2026-08-17 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,717 | 🐛 5 | 🌐 Python | 📅 2026-09-12：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,912 | 🐛 31 | 🌐 Python | 📅 2026-09-12：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,109 | 🐛 890 | 🌐 Python | 📅 2026-09-10：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,290 | 🐛 82 | 🌐 Python | 📅 2026-09-01：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,700 | 🐛 62 | 🌐 Python | 📅 2026-09-12：JSON Web 令牌草案 01。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,774 | 🐛 104 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,311 | 🐛 69 | 🌐 Python | 📅 2026-09-02：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-haystack](https://github.com/django-haystack/django-haystack) ⭐ 3,733 | 🐛 582 | 🌐 Python | 📅 2026-09-12：Django 模块化搜索。
...
* [django-cache-machine](https://github.com/django-cache-machine/django-cache-machine) ⭐ 882 | 🐛 23 | 🌐 Python | 📅 2023-02-20：Django 模型的自动缓存和失效。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,537 | 🐛 50 | 🌐 Python | 📅 2026-09-12：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,344 | 🐛 49 | 🌐 Python | 📅 2026-09-10：Mailgun 库，用来抽取信息和签名。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,390 | 🐛 134 | 🌐 Python | 📅 2026-09-12：HTML/CSS 转 PDF 工具。
...
* [MechanicalSoup](https://github.com/hickford/MechanicalSoup) ⭐ 4,892 | 🐛 39 | 🌐 Python | 📅 2026-08-04：用于自动和网络站点交互的 Python 库。
* [RoboBrowser](https://github.com/jmcarp/robobrowser) ⭐ 3,689 | 🐛 59 | 🌐 Python | 📅 2020-09-10：一个简单的，Python 风格的库，用来浏览网站，而不需要一个独立安装的浏览器。
* [ScrapydWeb](https://github.com/my8100/scrapydweb) ⭐ 3,413 | 🐛 64 | 🌐 Python | 📅 2025-02-19：一个用于 Scrapyd 集群管理的全功能 web UI，支持 Scrapy 日志分析和可视化，自动打包，定时器任务和邮件通知等特色功能。
...
* [sumy](https://github.com/miso-belica/sumy) ⭐ 3,701 | 🐛 7 | 🌐 Python | 📅 2026-09-09：一个为文本文件和 HTML 页面进行自动摘要的模块。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,979 | 🐛 53 | 🌐 Python | 📅 2026-09-07：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,239 | 🐛 145 | 🌐 Python | 📅 2026-09-11：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,496 | 🐛 32 | 🌐 C++ | 📅 2026-09-04：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
...
* [Ajenti](https://github.com/ajenti/ajenti) ⭐ 7,966 | 🐛 10 | 🌐 Python | 📅 2026-09-12：一个你的服务器值得拥有的管理面板。
* [flower](https://github.com/mher/flower) ⭐ 7,242 | 🐛 54 | 🌐 Python | 📅 2026-09-12：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,070 | 🐛 130 | 🌐 Python | 📅 2026-09-07：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [sh](https://github.com/amoffat/sh) ⭐ 7,240 | 🐛 3 | 🌐 Python | 📅 2026-07-25：一个完备的 subprocess 替代库。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,322 | 🐛 326 | 🌐 Python | 📅 2026-09-07：异步并发和 I/O 友好的库。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,959 | 🐛 91 | 🌐 Python | 📅 2026-09-12：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,686 | 🐛 40 | 🌐 Python | 📅 2026-08-28：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,613 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,014 | 🐛 17 | 🌐 Python | 📅 2026-09-12：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,413 | 🐛 311 | 🌐 Python | 📅 2026-09-09：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,104 | 🐛 255 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,201 | 🐛 363 | 🌐 Python | 📅 2026-09-11：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,884 | 🐛 302 | 🌐 Python | 📅 2026-09-12：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,961 | 🐛 42 | 🌐 Python | 📅 2026-09-13：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,148 | 🐛 5 | 🌐 Python | 📅 2026-09-07：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,691 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,598 | 🐛 8 | 🌐 Python | 📅 2026-09-12：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  ...
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,009 | 🐛 169 | 🌐 Python | 📅 2026-09-08：在你的测试中记录和重放 HTTP 交互。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,427 | 🐛 32 | 🌐 Python | 📅 2026-09-08：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,295 | 🐛 13 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,307 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,903 | 🐛 14 | 🌐 Python | 📅 2026-09-12：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,840 | 🐛 313 | 🌐 Python | 📅 2026-09-11：一个坚定的 Python 代码格式化工具。
...
* 静态类型注释生成器
  ...
  * [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 5,001 | 🐛 78 | 🌐 Python | 📅 2026-02-11：通过收集运行时的类型来为 Python 生成静态类型注释的系统。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,494 | 🐛 240 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,379 | 🐛 78 | 🌐 Python | 📅 2026-09-12：为 Django 显示各种调试信息。
  ...
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 0 | 🌐 Python | 📅 2026-09-13：[statsd](https://github.com/etsy/statsd/) ⭐ 18,076 | 🐛 92 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,091 | 🐛 368 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,921 | 🐛 5,988 | 🌐 Python | 📅 2026-09-12：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,623 | 🐛 2,807 | 🌐 Python | 📅 2026-09-12：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,749 | 🐛 493 | 🌐 Python | 📅 2026-09-10：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,120 | 🐛 61 | 🌐 Python | 📅 2026-09-12：AWS 平台上使用的 Pandas。
* [Karate Club](https://github.com/benedekrozemberczki/karateclub) ⭐ 2,286 | 🐛 12 | 🌐 Python | 📅 2024-07-17：用于图形结构化数据的无监督机器学习工具箱。
* [Optimus](https://github.com/ironmussa/Optimus) ⭐ 1,537 | 🐛 30 | 🌐 Python | 📅 2024-12-02：在使用 PySpark 时，让敏捷数据科学工作流程变得简单。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,018 | 🐛 23 | 📅 2026-09-08。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,610 | 🐛 390 | 🌐 Python | 📅 2026-09-10：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,446 | 🐛 854 | 🌐 Python | 📅 2026-09-12：用 Python 进行交互式 web 绘图。
...
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,472 | 🐛 148 | 🌐 Python | 📅 2026-09-12：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,758 | 🐛 80 | 🌐 Python | 📅 2026-09-11：基于ggplot2的Python图形语法。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 323 | 🌐 Python | 📅 2026-09-11：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,736 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,989 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,353 | 🐛 190 | 🌐 Python | 📅 2026-09-13：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,899 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,741 | 🐛 3,111 | 🌐 C++ | 📅 2026-09-12 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,313 | 🐛 29 | 🌐 Python | 📅 2026-09-12。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,731 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,757 | 🐛 436 | 🌐 C++ | 📅 2026-09-11：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,504 | 🐛 2,881 | 🌐 Jupyter Notebook | 📅 2026-09-08：开源快速可扩展的机器学习平台。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,718 | 🐛 4 | 🌐 C++ | 📅 2026-09-13 装饰器。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,785 | 🐛 3,604 | 🌐 Python | 📅 2026-09-12：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,772 | 🐛 173 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,915 | 🐛 1,332 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 19 | 🌐 Python | 📅 2026-09-10：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,507 | 🐛 15 | 🌐 Python | 📅 2026-09-10：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,902 | 🐛 194 | 🌐 Python | 📅 2026-09-11：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,931 | 🐛 46 | 🌐 Python | 📅 2026-09-11：Python 用的 Google APIs 客户端库。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,665 | 🐛 835 | 🌐 Python | 📅 2026-09-11：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,653 | 🐛 1,879 | 🌐 Python | 📅 2026-09-12：基础设施自动化和管理系统。
...
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,990 | 🐛 164 | 🌐 Python | 📅 2026-09-12：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,828 | 🐛 837 | 🌐 Python | 📅 2026-09-12：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,236 | 🐛 150 | 🌐 Python | 📅 2026-09-07：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,060 | 🐛 1,524 | 🌐 C | 📅 2026-09-11：精简高效的 Python 编程语言实现。
...
* [IronPython](https://github.com/IronLanguages/ironpython3) ⭐ 2,760 | 🐛 314 | 🌐 C# | 📅 2026-08-31：用 C＃ 编写的 Python 编程语言的实现。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,540 | 🐛 138 | 🌐 Python | 📅 2026-09-12：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,525 | 🐛 2 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,516 | 🐛 505 | 🌐 Python | 📅 2026-09-12：所有算法的 Python 实现。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,980 | 🐛 12 | 🌐 Python | 📅 2026-09-12：一个 Python 设计模式集合。
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,589 | 🐛 22 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,837 | 🐛 156 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,831 | 🐛 50 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,491 | 🐛 55 | 🌐 Python | 📅 2026-09-07：各种具有可视化效果的机器人算法的汇总。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,351 | 🐛 25 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,602 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,183 | 🐛 240 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,499 | 🐛 4 | 🌐 C++ | 📅 2026-09-12：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,921 | 🐛 79 | 🌐 Python | 📅 2026-09-08：一组纯 Python 实用工具。
