...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 316,381 | 🐛 15 | 🌐 Python | 📅 2026-08-25 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,051 | 🐛 55 | 🌐 Shell | 📅 2026-08-26：简单的 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,035 | 🐛 12 | 🌐 Python | 📅 2026-08-24：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,008 | 🐛 173 | 🌐 Python | 📅 2026-08-22：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,495 | 🐛 654 | 🌐 Python | 📅 2026-08-26：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,136 | 🐛 585 | 🌐 Python | 📅 2026-08-27：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,082 | 🐛 291 | 🌐 Python | 📅 2026-08-23：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,180 | 🐛 11 | 🌐 Python | 📅 2026-08-27：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,428 | 🐛 309 | 🌐 Python | 📅 2026-08-25：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,774 | 🐛 1,277 | 🌐 Python | 📅 2026-08-26：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,450 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,561 | 🐛 707 | 🌐 Python | 📅 2026-07-26 之上。
* [bpython](https://github.com/bpython/bpython) ⭐ 2,772 | 🐛 149 | 🌐 Python | 📅 2026-07-20：界面丰富的 Python 解析器。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,399 | 🐛 242 | 🌐 Python | 📅 2026-08-26：管理文件系统事件的 API 和 shell 工具。
* [aiofiles](https://github.com/Tinche/aiofiles) ⭐ 3,255 | 🐛 58 | 🌐 Python | 📅 2026-08-26：基于 asyncio，提供文件异步操作。
* [python-magic](https://github.com/ahupp/python-magic) ⭐ 2,917 | 🐛 27 | 🌐 Python | 📅 2026-07-20：文件类型检测的第三方库 libmagic 的 Python 接口。
* [PyFilesystem2](https://github.com/pyfilesystem/pyfilesystem2) ⭐ 2,107 | 🐛 117 | 🌐 Python | 📅 2025-05-17：Python 的文件系统抽象层。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,047 | 🐛 189 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
...
* 通用
  ...
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,662 | 🐛 1 | 🌐 Python | 📅 2026-08-23：字符编码检测器，兼容 Python 2 和 Python 3。
  * [shortuuid](https://github.com/stochastic-technologies/shortuuid) ⭐ 2,196 | 🐛 0 | 🌐 Python | 📅 2026-06-20：一个生成器库，用以生成简洁的，明白的，URL 安全的 UUID。
  * [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,711 | 🐛 13 | 🌐 Python | 📅 2026-08-27：Python 的 JSON 编码、解码器。
...
* Slug 化
  ...
  * [awesome-slugify](https://github.com/dimka665/awesome-slugify) ⭐ 490 | 🐛 18 | 🌐 Python | 📅 2020-04-17：一个 Python slug 化库，可以保持 Unicode。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,769 | 🐛 11 | 🌐 Python | 📅 2026-08-14：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,769 | 🐛 11 | 🌐 Python | 📅 2026-08-14：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,513 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 29 | 🌐 Python | 📅 2026-08-27：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,697 | 🐛 513 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,502 | 🐛 534 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  * [unoconv](https://github.com/dagwieers/unoconv) ⚠️ Archived：在 LibreOffice/OpenOffice 支持的任意文件格式之间进行转换。
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,697 | 🐛 176 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,175 | 🐛 134 | 🌐 Python | 📅 2026-08-27：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,240 | 🐛 29 | 🌐 Python | 📅 2026-08-24：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,065 | 🐛 21 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 40 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,712 | 🐛 52 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,131 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,481 | 🐛 439 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,867 | 🐛 93 | 🌐 Python | 📅 2026-08-27：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,710 | 🐛 135 | 🌐 Python | 📅 2022-11-05：一个支持对不同领域进行中文分词的工具箱。
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,634 | 🐛 44 | 🌐 Python | 📅 2020-01-19：一个用来处理中文文本的库。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,379 | 🐛 391 | 🌐 Python | 📅 2026-08-27：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,618 | 🐛 110 | 🌐 Python | 📅 2026-08-27：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,209 | 🐛 194 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,905 | 🐛 183 | 🌐 Python | 📅 2026-03-23：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,561 | 🐛 707 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,257 | 🐛 372 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,294 | 🐛 604 | 🌐 Python | 📅 2026-08-17：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,295 | 🐛 17 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,744 | 🐛 455 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,066 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,219 | 🐛 722 | 🌐 Python | 📅 2026-08-26：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,839 | 🐛 28 | 🌐 Python | 📅 2026-04-15：通过命令行获取即时的编程问题解答。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,569 | 🐛 139 | 🌐 Python | 📅 2026-08-22： [tmux](https://github.com/tmux/tmux) ⭐ 48,859 | 🐛 33 | 🌐 C | 📅 2026-08-25 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,545 | 🐛 147 | 🌐 Python | 📅 2026-08-25：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,460 | 🐛 334 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,368 | 🐛 39 | 🌐 Python | 📅 2026-08-27：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,970 | 🐛 2 | 🌐 Python | 📅 2026-08-27：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,622 | 🐛 73 | 🌐 Python | 📅 2026-08-25：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,257 | 🐛 1 | 🌐 Python | 📅 2026-08-26：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,685 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,515 | 🐛 25 | 🌐 Python | 📅 2026-08-26：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
* [pywal](https://github.com/dylanaraps/pywal) ⚠️ Archived：由图像生成配色方案的工具。
* [python-qrcode](https://github.com/lincolnloop/python-qrcode) ⭐ 4,937 | 🐛 54 | 🌐 Python | 📅 2026-03-25：一个纯 Python 实现的二维码生成器。
...
* [pyvips](https://github.com/libvips/pyvips) ⭐ 812 | 🐛 2 | 🌐 Python | 📅 2026-07-31：低内存消耗且快速的图像处理库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,338 | 🐛 234 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,383 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的一个封装。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,591 | 🐛 712 | 🌐 Python | 📅 2026-08-27：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,576 | 🐛 51 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
* [dejavu](https://github.com/worldveil/dejavu) ⭐ 6,784 | 🐛 132 | 🌐 Python | 📅 2024-04-22：音频指纹提取和识别。
* [pyAudioAnalysis](https://github.com/tyiannak/pyAudioAnalysis) ⭐ 6,255 | 🐛 205 | 🌐 Python | 📅 2025-08-04：音频特征提取，分类，分段和应用。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 833 | 🐛 6 | 🌐 Python | 📅 2026-08-23：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [vidgear](https://github.com/abhiTronix/vidgear) ⭐ 3,721 | 🐛 1 | 🌐 Python | 📅 2026-05-18： 强大的多线程视频处理框架。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,529 | 🐛 225 | 🌐 Python | 📅 2026-08-27：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,444 | 🐛 143 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,573 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,051 | 🐛 225 | 🌐 Python | 📅 2026-08-26：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
* [treq](https://github.com/twisted/treq) ⭐ 604 | 🐛 55 | 🌐 Python | 📅 2026-08-19：类似 requests 的 Python API 构建于 Twisted HTTP 客户端之上。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,557 | 🐛 9 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,845 | 🐛 14 | 🌐 Python | 📅 2026-08-18：纯 Python MySQL 驱动，兼容 mysql-python。
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,536 | 🐛 4 | 🌐 Python | 📅 2026-08-22 分支，支持 Python 3。
  * [aiomysql](https://github.com/aio-libs/aiomysql) ⭐ 1,896 | 🐛 117 | 🌐 Python | 📅 2026-03-27：基于 asyncio 的异步 MySQL 数据库操作库。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,621 | 🐛 90 | 🌐 Python | 📅 2026-08-26：Redis 的 Python 客户端。
  * [kafka-python](https://github.com/dpkp/kafka-python) ⭐ 5,898 | 🐛 19 | 🌐 Python | 📅 2026-08-24：Apache Kafka Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-08-27：一个小巧，富有表现力的 ORM。
...
* NoSQL 数据库
  * [PynamoDB](https://github.com/jlafon/PynamoDB) ⭐ 2,649 | 🐛 319 | 🌐 Python | 📅 2026-05-29：[Amazon DynamoDB](https://aws.amazon.com/dynamodb/) 的一个 Python 风格接口。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,221 | 🐛 10 | 🌐 Python | 📅 2026-08-18 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,755 | 🐛 2 | 📅 2026-08-17 系列
...
* [channels](https://github.com/django/channels) ⭐ 6,353 | 🐛 122 | 🌐 Python | 📅 2026-08-06：开发者友好的 Django 异步工具。
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,714 | 🐛 1 | 🌐 Python | 📅 2026-08-26：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,910 | 🐛 37 | 🌐 Python | 📅 2026-08-27：Django 1.2+ ，实现了单个对象权限。
* [django-rules](https://github.com/dfunckt/django-rules) ⭐ 1,977 | 🐛 41 | 🌐 Python | 📅 2025-10-11：一个小巧但是强大的应用，提供对象级别的权限管理，且不需要使用数据库。
...
* [indico](https://github.com/indico/indico) ⭐ 2,100 | 🐛 880 | 🌐 Python | 📅 2026-08-26：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,874 | 🐛 79 | 🌐 Python | 📅 2026-08-26：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
  * [hug](https://github.com/hugapi/hug) ⭐ 6,883 | 🐛 189 | 🌐 Python | 📅 2024-07-04：一个为纯净公开的 API 打造的 Python 3 框架。
...
* OAuth
  ...
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,406 | 🐛 142 | 🌐 Python | 📅 2026-08-27：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,334 | 🐛 41 | 🌐 Python | 📅 2026-08-23：为 Django 用户准备的 OAuth2。
  * [python-oauth2](https://github.com/joestump/python-oauth2) ⭐ 3,009 | 🐛 75 | 🌐 Python | 📅 2024-04-09：一个完全测试的抽象接口。用来创建 OAuth 客户端和服务端。
  * [OAuthLib](https://github.com/idan/oauthlib) ⭐ 2,980 | 🐛 117 | 🌐 Python | 📅 2026-07-14：一个 OAuth 请求-签名逻辑通用、 完整的实现。
  * [python-social-auth](https://github.com/omab/python-social-auth) ⭐ 2,800 | 🐛 24 | 🌐 Python | 📅 2022-07-01：一个设置简单的社会化验证方式。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,695 | 🐛 64 | 🌐 Python | 📅 2026-08-24：JSON Web 令牌草案 01。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,752 | 🐛 101 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,014 | 🐛 0 | 🌐 Python | 📅 2026-08-16：小型多线程任务队列。
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,309 | 🐛 63 | 🌐 Python | 📅 2026-08-13：适用于Python 3的快速可靠的后台任务处理库。
...
* [pysolr](https://github.com/django-haystack/pysolr) ⭐ 701 | 🐛 23 | 🌐 Python | 📅 2026-08-21：支持 [Apache Solr](https://lucene.apache.org/solr/) 的轻量级 Python 装饰器。
...
* [django-activity-stream](https://github.com/justquick/django-activity-stream) ⭐ 2,442 | 🐛 25 | 🌐 Python | 📅 2025-12-15：从你的站点行为中生成通用活动信息流。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,531 | 🐛 54 | 🌐 Python | 📅 2026-08-27：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,342 | 🐛 72 | 🌐 Python | 📅 2026-08-26：Mailgun 库，用来抽取信息和签名。
...
* [furl](https://github.com/gruns/furl) ⭐ 2,810 | 🐛 52 | 🌐 Python | 📅 2026-02-22：一个让处理 URL 更简单小型 Python 库。
* [webargs](https://github.com/sloria/webargs) ⭐ 1,406 | 🐛 8 | 🌐 Python | 📅 2026-08-26：一个解析 HTTP 请求参数的库，内置对流行 web 框架的支持，包括 Flask, Django, Bottle, Tornado 和 Pyramid。
...
* [xmltodict](https://github.com/martinblech/xmltodict) ⭐ 5,751 | 🐛 5 | 🌐 Python | 📅 2026-08-19：像处理 JSON 一样处理 XML。
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,388 | 🐛 139 | 🌐 Python | 📅 2026-08-26：HTML/CSS 转 PDF 工具。
...
* [MechanicalSoup](https://github.com/hickford/MechanicalSoup) ⭐ 4,888 | 🐛 39 | 🌐 Python | 📅 2026-08-04：用于自动和网络站点交互的 Python 库。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,144 | 🐛 514 | 🌐 Python | 📅 2026-08-09：使用 Python 进行新闻提取，文章提取以及内容策展。
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,699 | 🐛 66 | 🌐 HTML | 📅 2026-08-27：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
...
* [python-readability](https://github.com/buriy/python-readability) ⭐ 2,894 | 🐛 21 | 🌐 HTML | 📅 2026-08-26：arc90 公司 readability 工具的 Python 高速端口。
...
* [django-bootstrap3](https://github.com/dyve/django-bootstrap3) ⭐ 2,332 | 🐛 0 | 🌐 Python | 📅 2026-08-17：集成了 Bootstrap 3 的 Django。
* [django-bootstrap4](https://github.com/zostera/django-bootstrap4) ⭐ 1,024 | 🐛 18 | 🌐 Python | 📅 2026-08-17：集成了 Bootstrap 4 的 Django。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,977 | 🐛 65 | 🌐 Python | 📅 2026-08-24：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,497 | 🐛 32 | 🌐 C++ | 📅 2026-08-13：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 772 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,201 | 🐛 133 | 🌐 C++ | 📅 2026-08-27 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 22 | 🌐 C++ | 📅 2026-08-24： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,121 | 🐛 790 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [django-taggit](https://github.com/alex/django-taggit) ⭐ 3,446 | 🐛 113 | 🌐 Python | 📅 2026-08-24：简单的 Django 标记工具。

### 管理面板

管理界面库。

* [Ajenti](https://github.com/ajenti/ajenti) ⭐ 7,962 | 🐛 10 | 🌐 Python | 📅 2026-07-22：一个你的服务器值得拥有的管理面板。
* [flower](https://github.com/mher/flower) ⭐ 7,234 | 🐛 156 | 🌐 Python | 📅 2026-08-16：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,071 | 🐛 128 | 🌐 Python | 📅 2026-08-16：一个用于 Flask 的简单可扩展的管理界面框架。
* [django-xadmin](https://github.com/sshwsfc/django-xadmin) ⭐ 4,751 | 🐛 386 | 🌐 Python | 📅 2025-12-16：Django admin 的一个替代品，具有很多不错的功能。
* [django-jet](https://github.com/geex-arts/django-jet) ⭐ 3,622 | 🐛 303 | 🌐 Python | 📅 2025-11-26：具有改进功能的现代响应式 Django 管理界面模板。
* [Wooey](https://github.com/wooey/wooey) ⭐ 2,246 | 🐛 57 | 🌐 Python | 📅 2026-08-04：一个 Django 应用，可以为 Python 脚本创建 web 用户界面。
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,822 | 🐛 687 | 🌐 Python | 📅 2023-03-23：在 AWS Lambda 和 API Gateway 部署 WSGI 应用的工具。
...
* [delegator.py](https://github.com/amitt001/delegator.py) ⭐ 1,742 | 🐛 12 | 🌐 Python | 📅 2022-12-01：人性化的 [Subprocesses](https://docs.python.org/3/library/subprocess.html) 2.0 版本。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,888 | 🐛 155 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,307 | 🐛 322 | 🌐 Python | 📅 2026-08-27：异步并发和 I/O 友好的库。
...
* [netius](https://github.com/hivesolutions/netius) ⭐ 118 | 🐛 9 | 🌐 Python | 📅 2026-08-27：异步，非常快速。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,927 | 🐛 86 | 🌐 Python | 📅 2026-08-24：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,679 | 🐛 42 | 🌐 Python | 📅 2026-07-21：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,812 | 🐛 706 | 🌐 Python | 📅 2026-08-27：tkinter，Qt，WxPython 和 Remi 的封装。
* [Eel](https://github.com/ChrisKnott/Eel) ⚠️ Archived：用于制作简单离线 HTML/JS GUI 应用的库。
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 5,993 | 🐛 17 | 🌐 Python | 📅 2026-08-11：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,406 | 🐛 308 | 🌐 Python | 📅 2026-08-23：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,087 | 🐛 253 | 🌐 Python | 📅 2026-08-23：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,201 | 🐛 422 | 🌐 Python | 📅 2026-08-27：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,847 | 🐛 300 | 🌐 Python | 📅 2026-08-26：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,914 | 🐛 50 | 🌐 Python | 📅 2026-08-25：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,107 | 🐛 3 | 🌐 Python | 📅 2026-08-26：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,668 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,564 | 🐛 8 | 🌐 Python | 📅 2026-08-26：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  ...
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,984 | 🐛 161 | 🌐 Python | 📅 2026-08-25：在你的测试中记录和重放 HTTP 交互。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,278 | 🐛 34 | 🌐 Python | 📅 2026-08-26：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,241 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,276 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。

### 代码分析和 Lint 工具

进行代码分析、解析和操作代码库的库和工具。

* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,979 | 🐛 7 | 📅 2026-06-19

  * [pyre-check](https://github.com/facebook/pyre-check) ⚠️ Archived：性能类型检查。
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,115 | 🐛 372 | 🌐 Python | 📅 2026-08-27：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,780 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,604 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
...
* Lint 工具
  * [YAPF](https://github.com/google/yapf) ⭐ 13,981 | 🐛 417 | 🌐 Python | 📅 2026-08-21：Google 的 Python 代码格式化工具。

  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,895 | 🐛 13 | 🌐 Python | 📅 2026-08-25：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,818 | 🐛 302 | 🌐 Python | 📅 2026-08-20：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,947 | 🐛 84 | 🌐 Python | 📅 2026-08-27：用于纠正包导入顺序的 Python 库。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,446 | 🐛 238 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,379 | 🐛 84 | 🌐 Python | 📅 2026-08-25：为 Django 显示各种调试信息。
  * [pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,275 | 🐛 55 | 🌐 Python | 📅 2026-07-30：解析和分析 ELF 文件以及 DWARF 调试信息。
  * [django-devserver](https://github.com/dcramer/django-devserver) ⭐ 1,265 | 🐛 59 | 🌐 Python | 📅 2020-02-26：一个 Django 运行服务器的替代品。
  * [flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) ⭐ 979 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-03：django-debug-toolbar 的 flask 版。
...
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,070 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,894 | 🐛 5,965 | 🌐 Python | 📅 2026-08-27：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,593 | 🐛 2,806 | 🌐 Python | 📅 2026-08-27：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,723 | 🐛 487 | 🌐 Python | 📅 2026-08-24：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,119 | 🐛 53 | 🌐 Python | 📅 2026-08-26：AWS 平台上使用的 Pandas。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,330 | 🐛 309 | 🌐 Python | 📅 2026-08-27：地震学 Python 工具箱。
...
* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,556 | 🐛 388 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,436 | 🐛 844 | 🌐 Python | 📅 2026-08-26：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,775 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,006 | 🐛 228 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,615 | 🐛 329 | 🌐 Python | 📅 2026-08-27：具有 matplotlib 支持的 Python 制图库。
...
* [Dash](https://plot.ly/products/dash/)：构建在 Flask、React 和 Plotly 之上，旨在用于分析 Web 应用程序。
  * [awesome-dash](https://github.com/Acrotrend/awesome-dash) ⭐ 2,269 | 🐛 1 | 🌐 Python | 📅 2024-12-30
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,685 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,943 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,329 | 🐛 114 | 🌐 Python | 📅 2026-08-27：PyTorch 的开源差异化计算机视觉库。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,383 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的另一包装库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,814 | 🐛 84 | 📅 2025-05-26。

* [Caffe](http://caffe.berkeleyvision.org)：一个 [Caffe](https://github.com/BVLC/caffe) ⭐ 34,556 | 🐛 1,592 | 🌐 C++ | 📅 2024-07-31 的 python 接口。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,721 | 🐛 2,943 | 🌐 C++ | 📅 2026-08-27 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,177 | 🐛 28 | 🌐 Python | 📅 2026-08-26。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,649 | 🐛 2 | 🌐 Makefile | 📅 2026-08-21：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,698 | 🐛 421 | 🌐 C++ | 📅 2026-08-26：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,861 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,494 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-26：开源快速可扩展的机器学习平台。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,289 | 🐛 86 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
* [Surprise](https://github.com/NicolasHug/Surprise) ⭐ 6,808 | 🐛 80 | 🌐 Python | 📅 2026-05-30：用于构建和分析推荐系统的科学工具。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,617 | 🐛 3,539 | 🌐 Python | 📅 2026-08-27：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,765 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,897 | 🐛 1,313 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,356 | 🐛 81 | 🌐 Python | 📅 2026-08-25：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,349 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 8 | 🌐 Python | 📅 2026-08-12：比 `itertools` 拥有更多的可迭代对象的操作方式。
...
* [CyToolz](https://github.com/pytoolz/cytoolz/) ⭐ 1,112 | 🐛 34 | 🌐 Python | 📅 2025-12-01：Toolz 的 Cython 实现：高性能函数式工具。

### 第三方 API

用来访问第三方 API 的库。 参见： [List of Python API Wrappers and Libraries](https://github.com/realpython/list-of-python-api-wrappers) ⭐ 2,163 | 🐛 11 | 📅 2023-08-29。

* [boto3](https://github.com/boto/boto3) ⭐ 9,883 | 🐛 190 | 🌐 Python | 📅 2026-08-27：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,915 | 🐛 45 | 🌐 Python | 📅 2026-08-26：Python 用的 Google APIs 客户端库。
* [gspread](https://github.com/burnash/gspread) ⭐ 7,503 | 🐛 72 | 🌐 Python | 📅 2026-07-30：Google 电子表格的 Python API。
* [facebook-sdk](https://github.com/mobolic/facebook-sdk) ⭐ 2,795 | 🐛 38 | 🌐 Python | 📅 2024-08-02：Facebook 平台的 Python SDK。
* [twython](https://github.com/ryanmcgrath/twython) ⭐ 1,860 | 🐛 29 | 🌐 Python | 📅 2022-07-30：Twitter API 的封装。
* [gmail](https://github.com/charlierguo/gmail) ⭐ 1,803 | 🐛 64 | 🌐 Python | 📅 2023-07-09：Gmail 的 Python 接口。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,479 | 🐛 834 | 🌐 Python | 📅 2026-08-26：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,637 | 🐛 1,928 | 🌐 Python | 📅 2026-08-27：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,265 | 🐛 259 | 🌐 Python | 📅 2026-08-27：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,108 | 🐛 181 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,966 | 🐛 173 | 🌐 Python | 📅 2026-08-27：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,696 | 🐛 863 | 🌐 Python | 📅 2026-08-27：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,260 | 🐛 178 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,012 | 🐛 1,536 | 🌐 C | 📅 2026-08-27：精简高效的 Python 编程语言实现。
...
* [PythonNet](https://github.com/pythonnet/pythonnet) ⭐ 5,512 | 🐛 165 | 🌐 C# | 📅 2026-08-16：Python 与 .NET 公共语言运行库 (CLR)的集成。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,492 | 🐛 173 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,501 | 🐛 137 | 🌐 Python | 📅 2026-08-27：一个非常棒的操作数据包的库。
* [keyboard](https://github.com/boppreh/keyboard) ⭐ 3,963 | 🐛 414 | 🌐 Python | 📅 2026-07-10：在 Windows 和 Linux 上挂钩并模拟全局键盘事件。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,477 | 🐛 0 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,053 | 🐛 1,055 | 🌐 Python | 📅 2026-08-27：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,541 | 🐛 5 | 🌐 Python | 📅 2026-08-01：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,975 | 🐛 38 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
  * [python-ds](https://github.com/prabhupant/python-ds) ⭐ 3,089 | 🐛 34 | 🌐 Python | 📅 2024-04-06：用于面试的数据结构和算法的集合。
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,948 | 🐛 17 | 🌐 Python | 📅 2026-08-20：一个 Python 设计模式集合。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,833 | 🐛 150 | 🌐 Python | 📅 2026-08-27：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,393 | 🐛 51 | 🌐 Python | 📅 2026-08-24：各种具有可视化效果的机器人算法的汇总。
...
* [errbot](https://github.com/errbotio/errbot/) ⭐ 3,300 | 🐛 45 | 🌐 Python | 📅 2026-08-17：实现 ChatOps 的最简单最受欢迎的聊天机器人。
...
* Vim
  ...
  * [python-mode](https://github.com/python-mode/python-mode) ⭐ 5,465 | 🐛 39 | 🌐 Vim Script | 📅 2026-05-24：一个将 Vim 转换为 Python IDE 的多合一插件。
  * [jedi-vim](https://github.com/davidhalter/jedi-vim) ⭐ 5,307 | 🐛 31 | 🌐 Python | 📅 2026-06-16：用于 Python 的 Jedi 自动补全库的 Vim 绑定。
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,564 | 🐛 157 | 🌐 C# | 📅 2026-08-25：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,297 | 🐛 1,344 | 🌐 Python | 📅 2026-08-27： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 44,798 | 🐛 32 | 🌐 Python | 📅 2026-08-10：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,244 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,049 | 🐛 239 | 🌐 Python | 📅 2026-02-28：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,469 | 🐛 5 | 🌐 C++ | 📅 2026-08-26：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,917 | 🐛 72 | 🌐 Python | 📅 2026-08-19：一组纯 Python 实用工具。
* [itsdangerous](https://github.com/pallets/itsdangerous) ⭐ 3,128 | 🐛 4 | 🌐 Python | 📅 2025-06-14：将受信任的数据传递到不受信任的环境的帮助工具。
* [blinker](https://github.com/jek/blinker) ⭐ 2,087 | 🐛 0 | 🌐 Python | 📅 2025-11-19：快速的 Python 运行时信号/事件分配系统。
