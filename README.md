...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 317,024 | 🐛 18 | 🌐 Python | 📅 2026-08-25 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,058 | 🐛 55 | 🌐 Shell | 📅 2026-08-29：简单的 Python 版本管理工具。
* [p](https://github.com/qw3rtman/p) ⭐ 771 | 🐛 25 | 🌐 Shell | 📅 2019-11-01：非常简单的交互式 Python 版本管理工具。
...
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,007 | 🐛 173 | 🌐 Python | 📅 2026-08-22：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,499 | 🐛 660 | 🌐 Python | 📅 2026-08-29：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,140 | 🐛 589 | 🌐 Python | 📅 2026-08-29：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,086 | 🐛 291 | 🌐 Python | 📅 2026-08-23：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,185 | 🐛 12 | 🌐 Python | 📅 2026-08-29：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,430 | 🐛 311 | 🌐 Python | 📅 2026-08-28：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,773 | 🐛 1,279 | 🌐 Python | 📅 2026-08-28：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,564 | 🐛 708 | 🌐 Python | 📅 2026-07-26 之上。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,402 | 🐛 243 | 🌐 Python | 📅 2026-08-30：管理文件系统事件的 API 和 shell 工具。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,048 | 🐛 190 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,673 | 🐛 266 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
* [maya](https://github.com/kennethreitz/maya) ⭐ 3,410 | 🐛 21 | 🌐 Python | 📅 2024-07-19：人性化的时间处理库。
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,631 | 🐛 475 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  * [flashtext](https://github.com/vi3k6i5/flashtext) ⭐ 5,712 | 🐛 70 | 🌐 Python | 📅 2025-04-13：一个高效的文本查找替换库。
  * [pypinyin](https://github.com/mozillazg/python-pinyin) ⭐ 5,357 | 🐛 45 | 🌐 Python | 📅 2026-07-20：汉字拼音转换工具 Python 版。
  * [ftfy](https://github.com/LuminosoInsight/python-ftfy) ⭐ 4,060 | 🐛 25 | 🌐 Python | 📅 2024-10-30：让 Unicode 文本更完整更连贯。
  * [thefuzz](https://github.com/seatgeek/thefuzz) ⭐ 3,647 | 🐛 47 | 🌐 Python | 📅 2025-03-03：模糊字符串匹配。
  * [textdistance](https://github.com/orsinium/textdistance) ⭐ 3,540 | 🐛 10 | 🌐 Python | 📅 2025-04-18：支持 30 多种算法来计算序列之间的距离。
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,663 | 🐛 1 | 🌐 Python | 📅 2026-08-23：字符编码检测器，兼容 Python 2 和 Python 3。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,769 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,769 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,513 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 31 | 🌐 Python | 📅 2026-08-30：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,700 | 🐛 515 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  ...
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,697 | 🐛 175 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,177 | 🐛 133 | 🌐 Python | 📅 2026-08-28：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,244 | 🐛 28 | 🌐 Python | 📅 2026-08-24：John Gruber’s Markdown 的 Python 版实现。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,410 | 🐛 40 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,755 | 🐛 52 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
...
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,869 | 🐛 93 | 🌐 Python | 📅 2026-08-29：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,379 | 🐛 392 | 🌐 Python | 📅 2026-08-30：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,622 | 🐛 109 | 🌐 Python | 📅 2026-08-29：一个优雅地配置复杂应用程序的框架。
* [python-decouple](https://github.com/henriquebastos/python-decouple) ⭐ 3,037 | 🐛 22 | 🌐 Python | 📅 2024-11-28：将设置和代码完全隔离。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,210 | 🐛 194 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,906 | 🐛 183 | 🌐 Python | 📅 2026-03-23：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,564 | 🐛 708 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,274 | 🐛 372 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,303 | 🐛 604 | 🌐 Python | 📅 2026-08-17：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,296 | 🐛 17 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,749 | 🐛 456 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,067 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,229 | 🐛 724 | 🌐 Python | 📅 2026-08-28：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,841 | 🐛 28 | 🌐 Python | 📅 2026-04-15：通过命令行获取即时的编程问题解答。
  * [PathPicker](https://github.com/facebook/PathPicker) ⭐ 5,224 | 🐛 26 | 🌐 Python | 📅 2024-09-05：从 bash 输出中选出文件。
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,770 | 🐛 460 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,570 | 🐛 139 | 🌐 Python | 📅 2026-08-29： [tmux](https://github.com/tmux/tmux) ⭐ 48,903 | 🐛 38 | 🌐 C | 📅 2026-08-28 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,550 | 🐛 147 | 🌐 Python | 📅 2026-08-25：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,467 | 🐛 336 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,370 | 🐛 41 | 🌐 Python | 📅 2026-08-29：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,970 | 🐛 1 | 🌐 Python | 📅 2026-08-29：支持自动补全和语法高亮的 MySQL 命令行客户端
  * [SAWS](https://github.com/donnemartin/saws) ⭐ 5,303 | 🐛 39 | 🌐 Python | 📅 2024-04-02：一个加强版的 AWS 命令行。
  * [litecli](https://github.com/dbcli/litecli) ⭐ 3,293 | 🐛 46 | 🌐 Python | 📅 2026-06-18：支持自动补全和语法高亮的 SQLite 命令行工具。
...
* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,301 | 🐛 1 | 🌐 Python | 📅 2026-08-28：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,690 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,515 | 🐛 28 | 🌐 Python | 📅 2026-08-27：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
...
* [pyvips](https://github.com/libvips/pyvips) ⭐ 812 | 🐛 2 | 🌐 Python | 📅 2026-08-29：低内存消耗且快速的图像处理库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,457 | 🐛 234 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,598 | 🐛 716 | 🌐 Python | 📅 2026-08-29：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,794 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,581 | 🐛 51 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 834 | 🐛 6 | 🌐 Python | 📅 2026-08-23：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [GeoIP2](https://github.com/maxmind/GeoIP2-python) ⭐ 1,217 | 🐛 5 | 🌐 Python | 📅 2026-08-25：GeoIP2 Webservice 客户端与数据库 Python API。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,535 | 🐛 229 | 🌐 Python | 📅 2026-08-29：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,453 | 🐛 143 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,573 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,054 | 🐛 225 | 🌐 Python | 📅 2026-08-26：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,844 | 🐛 15 | 🌐 Python | 📅 2026-08-18：纯 Python MySQL 驱动，兼容 mysql-python。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,623 | 🐛 85 | 🌐 Python | 📅 2026-08-28：Redis 的 Python 客户端。
  * [kafka-python](https://github.com/dpkp/kafka-python) ⭐ 5,898 | 🐛 20 | 🌐 Python | 📅 2026-08-27：Apache Kafka Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,985 | 🐛 0 | 🌐 Python | 📅 2026-08-29：一个小巧，富有表现力的 ORM。
...
* NoSQL 数据库
  * [PynamoDB](https://github.com/jlafon/PynamoDB) ⭐ 2,648 | 🐛 319 | 🌐 Python | 📅 2026-05-29：[Amazon DynamoDB](https://aws.amazon.com/dynamodb/) 的一个 Python 风格接口。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,912 | 🐛 33 | 🌐 Python | 📅 2026-08-28：Django 1.2+ ，实现了单个对象权限。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,928 | 🐛 80 | 🌐 Python | 📅 2026-08-26：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,375 | 🐛 2 | 🌐 Python | 📅 2026-08-13：Django 的验证应用。
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,408 | 🐛 142 | 🌐 Python | 📅 2026-08-27：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,334 | 🐛 42 | 🌐 Python | 📅 2026-08-23：为 Django 用户准备的 OAuth2。
  * [python-oauth2](https://github.com/joestump/python-oauth2) ⭐ 3,009 | 🐛 75 | 🌐 Python | 📅 2024-04-09：一个完全测试的抽象接口。用来创建 OAuth 客户端和服务端。
...
* 其他
  ...
  * [python-jose](https://github.com/mpdavis/python-jose/) ⭐ 1,756 | 🐛 120 | 🌐 Python | 📅 2026-04-14：python 版 JOSE 实现。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,753 | 🐛 102 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,019 | 🐛 0 | 🌐 Python | 📅 2026-08-16：小型多线程任务队列。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,532 | 🐛 53 | 🌐 Python | 📅 2026-08-29：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,388 | 🐛 139 | 🌐 Python | 📅 2026-08-28：HTML/CSS 转 PDF 工具。
...
* [ScrapydWeb](https://github.com/my8100/scrapydweb) ⭐ 3,410 | 🐛 63 | 🌐 Python | 📅 2025-02-19：一个用于 Scrapyd 集群管理的全功能 web UI，支持 Scrapy 日志分析和可视化，自动打包，定时器任务和邮件通知等特色功能。
...
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,701 | 🐛 60 | 🌐 HTML | 📅 2026-08-27：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
...
* [micawber](https://github.com/coleifer/micawber) ⭐ 680 | 🐛 0 | 🌐 Python | 📅 2026-08-30：一个小型网页内容提取库，用来从 URLs 提取富内容。
...
* [django-bootstrap3](https://github.com/dyve/django-bootstrap3) ⭐ 2,330 | 🐛 1 | 🌐 Python | 📅 2026-08-28：集成了 Bootstrap 3 的 Django。
* [django-bootstrap4](https://github.com/zostera/django-bootstrap4) ⭐ 1,024 | 🐛 18 | 🌐 Python | 📅 2026-08-28：集成了 Bootstrap 4 的 Django。
...
* [Schematics](https://github.com/schematics/schematics) ⭐ 2,587 | 🐛 109 | 🌐 Python | 📅 2023-07-12：数据结构验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,242 | 🐛 145 | 🌐 Python | 📅 2026-08-26：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,496 | 🐛 32 | 🌐 C++ | 📅 2026-08-13：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 773 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,214 | 🐛 134 | 🌐 C++ | 📅 2026-08-27 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 22 | 🌐 C++ | 📅 2026-08-24： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,119 | 🐛 790 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [Ajenti](https://github.com/ajenti/ajenti) ⭐ 7,963 | 🐛 10 | 🌐 Python | 📅 2026-07-22：一个你的服务器值得拥有的管理面板。
* [flower](https://github.com/mher/flower) ⭐ 7,235 | 🐛 156 | 🌐 Python | 📅 2026-08-16：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,071 | 🐛 128 | 🌐 Python | 📅 2026-08-16：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,894 | 🐛 156 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [netius](https://github.com/hivesolutions/netius) ⭐ 118 | 🐛 7 | 🌐 Python | 📅 2026-08-29：异步，非常快速。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,934 | 🐛 88 | 🌐 Python | 📅 2026-08-29：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,809 | 🐛 706 | 🌐 Python | 📅 2026-08-28：tkinter，Qt，WxPython 和 Remi 的封装。
* [Eel](https://github.com/ChrisKnott/Eel) ⚠️ Archived：用于制作简单离线 HTML/JS GUI 应用的库。
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 5,999 | 🐛 14 | 🌐 Python | 📅 2026-08-29：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,406 | 🐛 309 | 🌐 Python | 📅 2026-08-23：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,089 | 🐛 254 | 🌐 Python | 📅 2026-08-29：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,201 | 🐛 438 | 🌐 Python | 📅 2026-08-28：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,850 | 🐛 301 | 🌐 Python | 📅 2026-08-28：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,920 | 🐛 47 | 🌐 Python | 📅 2026-08-30：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,115 | 🐛 3 | 🌐 Python | 📅 2026-08-26：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,671 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,566 | 🐛 8 | 🌐 Python | 📅 2026-08-29：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,525 | 🐛 167 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
  * [responses](https://github.com/getsentry/responses) ⭐ 4,345 | 🐛 40 | 🌐 Python | 📅 2026-08-26：伪造 Python 中的 requests 库的一个通用库。
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,987 | 🐛 161 | 🌐 Python | 📅 2026-08-25：在你的测试中记录和重放 HTTP 交互。
  * [httmock](https://github.com/patrys/httmock) ⭐ 472 | 🐛 15 | 🌐 Python | 📅 2023-09-29：针对 Python 2.6+ 和 3.2+ 生成 伪造请求的库。
  * [mocket](https://github.com/mindflayer/python-mocket) ⭐ 311 | 🐛 6 | 🌐 Python | 📅 2026-08-26：gevent/asyncio/SSL 支持的 socket mock 框架。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,309 | 🐛 34 | 🌐 Python | 📅 2026-08-28：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,243 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,280 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,980 | 🐛 7 | 📅 2026-06-19
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,117 | 🐛 378 | 🌐 Python | 📅 2026-08-30：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,782 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,605 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
  * [prospector](https://github.com/PyCQA/prospector) ⭐ 2,087 | 🐛 32 | 🌐 Python | 📅 2026-08-24：分析 Python 代码的工具。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,895 | 🐛 13 | 🌐 Python | 📅 2026-08-28：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,821 | 🐛 317 | 🌐 Python | 📅 2026-08-20：一个坚定的 Python 代码格式化工具。
...
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,073 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,898 | 🐛 5,967 | 🌐 Python | 📅 2026-08-29：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,599 | 🐛 2,806 | 🌐 Python | 📅 2026-08-29：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,731 | 🐛 490 | 🌐 Python | 📅 2026-08-24：马尔科夫链蒙特卡洛采样工具。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,024 | 🐛 32 | 📅 2026-08-19。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,565 | 🐛 388 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,437 | 🐛 847 | 🌐 Python | 📅 2026-08-29：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,775 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,008 | 🐛 228 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,460 | 🐛 147 | 🌐 Python | 📅 2026-08-16：用于 Python 的声明式统计可视化库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,690 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,951 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,334 | 🐛 122 | 🌐 Python | 📅 2026-08-29：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,835 | 🐛 84 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,021 | 🐛 2,966 | 🌐 C++ | 📅 2026-08-30 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,211 | 🐛 30 | 🌐 Python | 📅 2026-08-27。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,660 | 🐛 3 | 🌐 Makefile | 📅 2026-08-21：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,710 | 🐛 428 | 🌐 C++ | 📅 2026-08-27：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,859 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,496 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-26：开源快速可扩展的机器学习平台。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,648 | 🐛 3,537 | 🌐 Python | 📅 2026-08-29：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,768 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,904 | 🐛 1,319 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 279 | 🌐 Python | 📅 2024-07-27：一个 Python 流处理库，核心思想来源 [Kafka Streams](https://kafka.apache.org/documentation/streams/)。
...
* [Toolz](https://github.com/pytoolz/toolz) ⭐ 5,152 | 🐛 138 | 🌐 Python | 📅 2026-01-01：一组用于迭代器，函数和字典的函数式编程工具。
...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,088 | 🐛 10 | 🌐 Python | 📅 2026-08-12：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,510 | 🐛 15 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
* [fn.py](https://github.com/kachayev/fn.py) ⭐ 3,367 | 🐛 33 | 🌐 Python | 📅 2022-08-30：在 Python 中进行函数式编程：实现了一些享受函数式编程缺失的功能。
* [CyToolz](https://github.com/pytoolz/cytoolz/) ⭐ 1,113 | 🐛 34 | 🌐 Python | 📅 2025-12-01：Toolz 的 Cython 实现：高性能函数式工具。

### 第三方 API

用来访问第三方 API 的库。 参见： [List of Python API Wrappers and Libraries](https://github.com/realpython/list-of-python-api-wrappers) ⭐ 2,162 | 🐛 11 | 📅 2023-08-29。

* [boto3](https://github.com/boto/boto3) ⭐ 9,887 | 🐛 191 | 🌐 Python | 📅 2026-08-28：Amazon Web Services 的 Python 接口。
...
* [facebook-sdk](https://github.com/mobolic/facebook-sdk) ⭐ 2,796 | 🐛 38 | 🌐 Python | 📅 2024-08-02：Facebook 平台的 Python SDK。
* [twython](https://github.com/ryanmcgrath/twython) ⭐ 1,860 | 🐛 29 | 🌐 Python | 📅 2022-07-30：Twitter API 的封装。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,495 | 🐛 836 | 🌐 Python | 📅 2026-08-27：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,638 | 🐛 1,943 | 🌐 Python | 📅 2026-08-29：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,271 | 🐛 260 | 🌐 Python | 📅 2026-08-27：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,110 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,972 | 🐛 175 | 🌐 Python | 📅 2026-08-27：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,715 | 🐛 857 | 🌐 Python | 📅 2026-08-29：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,263 | 🐛 178 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
* [Spiff](https://github.com/knipknap/SpiffWorkflow) ⭐ 1,913 | 🐛 8 | 🌐 Python | 📅 2026-08-10：使用纯 Python 实现的强大的工作流引擎。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,234 | 🐛 142 | 🌐 Python | 📅 2026-08-25：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,021 | 🐛 1,535 | 🌐 C | 📅 2026-08-28：精简高效的 Python 编程语言实现。
...
* [IronPython](https://github.com/IronLanguages/ironpython3) ⭐ 2,759 | 🐛 313 | 🌐 C# | 📅 2026-08-17：用 C＃ 编写的 Python 编程语言的实现。
* [PeachPy](https://github.com/Maratyszcza/PeachPy) ⭐ 2,058 | 🐛 28 | 🌐 Python | 📅 2023-09-25：嵌入 Python 的 x86-64 汇编器。可以被用作 Python 内联的汇编器或者是独立的汇编器，用于 Windows，Linux，OS X，Native Client 或者 Go 。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,493 | 🐛 174 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,502 | 🐛 131 | 🌐 Python | 📅 2026-08-28：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,480 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,116 | 🐛 1,064 | 🌐 Python | 📅 2026-08-29：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,541 | 🐛 5 | 🌐 Python | 📅 2026-08-27：数据结构和算法的简单示例。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,950 | 🐛 17 | 🌐 Python | 📅 2026-08-20：一个 Python 设计模式集合。
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,581 | 🐛 21 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,835 | 🐛 151 | 🌐 Python | 📅 2026-08-27：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,403 | 🐛 51 | 🌐 Python | 📅 2026-08-24：各种具有可视化效果的机器人算法的汇总。
...
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,299 | 🐛 1,340 | 🌐 Python | 📅 2026-08-29： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 44,858 | 🐛 32 | 🌐 Python | 📅 2026-08-28：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,259 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,056 | 🐛 239 | 🌐 Python | 📅 2026-02-28：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,919 | 🐛 75 | 🌐 Python | 📅 2026-08-19：一组纯 Python 实用工具。
* [itsdangerous](https://github.com/pallets/itsdangerous) ⭐ 3,130 | 🐛 4 | 🌐 Python | 📅 2025-06-14：将受信任的数据传递到不受信任的环境的帮助工具。
