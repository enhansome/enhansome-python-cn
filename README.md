...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,358 | 🐛 21 | 🌐 Python | 📅 2026-09-22 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,109 | 🐛 57 | 🌐 Shell | 📅 2026-09-21：简单的 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,026 | 🐛 16 | 🌐 Python | 📅 2026-09-18：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,004 | 🐛 175 | 🌐 Python | 📅 2026-09-22：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,511 | 🐛 657 | 🌐 Python | 📅 2026-09-22：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,159 | 🐛 587 | 🌐 Python | 📅 2026-09-22：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,103 | 🐛 291 | 🌐 Python | 📅 2026-09-20：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,191 | 🐛 15 | 🌐 Python | 📅 2026-09-19：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,477 | 🐛 273 | 🌐 Python | 📅 2026-09-19：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,784 | 🐛 1,293 | 🌐 Python | 📅 2026-09-14：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,452 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,581 | 🐛 722 | 🌐 Python | 📅 2026-07-26 之上。
...
* [Jupyter Notebook (IPython)](https://jupyter.org)：一个能够让你最大限度地以交互式方式使用 Python 的丰富工具包。
  * [awesome-jupyter](https://github.com/markusschanta/awesome-jupyter) ⭐ 4,676 | 🐛 7 | 📅 2026-09-22

### 文件

文件管理和 MIME（多用途的网际邮件扩充协议）类型检测。

* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,415 | 🐛 264 | 🌐 Python | 📅 2026-09-22：管理文件系统事件的 API 和 shell 工具。
...
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,636 | 🐛 493 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  ...
  * [pypinyin](https://github.com/mozillazg/python-pinyin) ⭐ 5,363 | 🐛 45 | 🌐 Python | 📅 2026-07-20：汉字拼音转换工具 Python 版。
  * [ftfy](https://github.com/LuminosoInsight/python-ftfy) ⭐ 4,065 | 🐛 27 | 🌐 Python | 📅 2024-10-30：让 Unicode 文本更完整更连贯。
  * [thefuzz](https://github.com/seatgeek/thefuzz) ⭐ 3,651 | 🐛 47 | 🌐 Python | 📅 2025-03-03：模糊字符串匹配。
  * [textdistance](https://github.com/orsinium/textdistance) ⭐ 3,541 | 🐛 10 | 🌐 Python | 📅 2025-04-18：支持 30 多种算法来计算序列之间的距离。
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,668 | 🐛 0 | 🌐 Python | 📅 2026-08-30：字符编码检测器，兼容 Python 2 和 Python 3。
...
* Slug 化
  * [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,624 | 🐛 0 | 🌐 Python | 📅 2026-09-22：Python slug 化库，可以把 unicode 转化为 ASCII。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,728 | 🐛 522 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  ...
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,706 | 🐛 177 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,223 | 🐛 134 | 🌐 Python | 📅 2026-09-22：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  ...
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,074 | 🐛 32 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,409 | 🐛 44 | 🌐 Python | 📅 2026-09-21：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,342 | 🐛 54 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,165 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,487 | 🐛 440 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,882 | 🐛 95 | 🌐 Python | 📅 2026-09-20：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,389 | 🐛 396 | 🌐 Python | 📅 2026-09-23：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,668 | 🐛 72 | 🌐 Python | 📅 2026-09-22：一个优雅地配置复杂应用程序的框架。
* [python-decouple](https://github.com/henriquebastos/python-decouple) ⭐ 3,036 | 🐛 24 | 🌐 Python | 📅 2024-11-28：将设置和代码完全隔离。
...
* 命令行程序开发
  ...
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,906 | 🐛 180 | 🌐 Python | 📅 2026-09-12：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,581 | 🐛 722 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,418 | 🐛 379 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,344 | 🐛 627 | 🌐 Python | 📅 2026-09-20：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,867 | 🐛 461 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,104 | 🐛 318 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,271 | 🐛 745 | 🌐 Python | 📅 2026-09-23：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,842 | 🐛 18 | 🌐 Python | 📅 2026-09-12：通过命令行获取即时的编程问题解答。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,585 | 🐛 137 | 🌐 Python | 📅 2026-09-20： [tmux](https://github.com/tmux/tmux) ⭐ 49,431 | 🐛 41 | 🌐 C | 📅 2026-09-22 会话管理器。
  * [copier](https://github.com/pykong/copier) ⭐ 3,588 | 🐛 144 | 🌐 Python | 📅 2026-09-18：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,565 | 🐛 336 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,393 | 🐛 49 | 🌐 Python | 📅 2026-09-20：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 0 | 🌐 Python | 📅 2026-09-22：支持自动补全和语法高亮的 MySQL 命令行客户端
  ...
  * [iredis](https://github.com/laixintao/iredis) ⭐ 2,748 | 🐛 49 | 🌐 Python | 📅 2026-09-21：支持自动补全和高亮显示的 redis 命令行工具。
  * [kube-shell](https://github.com/cloudnativelabs/kube-shell) ⭐ 2,390 | 🐛 67 | 🌐 Python | 📅 2022-11-02：K8S 命令行集成的 shell 工具。
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,651 | 🐛 75 | 🌐 Python | 📅 2026-09-22：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,699 | 🐛 0 | 🌐 Python | 📅 2026-09-20：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,774 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,519 | 🐛 36 | 🌐 Python | 📅 2026-09-21：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 90,046 | 🐛 250 | 🌐 Python | 📅 2026-09-16: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,695 | 🐛 708 | 🌐 Python | 📅 2026-09-22：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,799 | 🐛 424 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,622 | 🐛 51 | 🌐 Python | 📅 2026-09-21：音频音乐分析 Python 库。
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,643 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,862 | 🐛 55 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,556 | 🐛 231 | 🌐 Python | 📅 2026-09-22：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,503 | 🐛 140 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,571 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,061 | 🐛 246 | 🌐 Python | 📅 2026-09-22：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,846 | 🐛 15 | 🌐 Python | 📅 2026-09-19：纯 Python MySQL 驱动，兼容 mysql-python。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,648 | 🐛 84 | 🌐 Python | 📅 2026-09-22：Redis 的 Python 客户端。
...
* 关系型数据库
  ...
  * [awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) ⭐ 3,059 | 🐛 10 | 🌐 Python | 📅 2026-06-08 系列
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  ...
  * [awesome-django(by shahraizali)](https://github.com/shahraizali/awesome-django) ⭐ 1,917 | 🐛 8 | 📅 2026-03-22 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,719 | 🐛 8 | 🌐 Python | 📅 2026-09-20：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
* [autobahn-python](https://github.com/crossbario/autobahn-python) ⭐ 2,541 | 🐛 191 | 🌐 Python | 📅 2026-09-22：适用于 Twisted 和 asyncio 的 Python WebSocket 和 WAMP。

### 权限

允许或拒绝用户访问数据或功能的库。

* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,915 | 🐛 33 | 🌐 Python | 📅 2026-09-18：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,109 | 🐛 885 | 🌐 Python | 📅 2026-09-21：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,545 | 🐛 85 | 🌐 Python | 📅 2026-09-18：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,374 | 🐛 2 | 🌐 Python | 📅 2026-09-17：Django 的验证应用。
  ...
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,339 | 🐛 54 | 🌐 Python | 📅 2026-09-02：为 Django 用户准备的 OAuth2。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,703 | 🐛 50 | 🌐 Python | 📅 2026-09-22：JSON Web 令牌草案 01。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,538 | 🐛 56 | 🌐 Python | 📅 2026-09-22：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,392 | 🐛 118 | 🌐 Python | 📅 2026-09-21：HTML/CSS 转 PDF 工具。
...
* [untangle](https://github.com/stchris/untangle) ⭐ 630 | 🐛 16 | 🌐 Python | 📅 2026-09-22：将 XML 文档转换为 Python 对象，使其可以方便的访问。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,161 | 🐛 516 | 🌐 Python | 📅 2026-09-15：使用 Python 进行新闻提取，文章提取以及内容策展。
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,720 | 🐛 57 | 🌐 HTML | 📅 2026-09-01：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
* [python-goose](https://github.com/grangier/python-goose) ⭐ 4,109 | 🐛 105 | 🌐 HTML | 📅 2026-03-10：HTML 内容/文章提取器(python2)。
* [sumy](https://github.com/miso-belica/sumy) ⭐ 3,697 | 🐛 7 | 🌐 Python | 📅 2026-09-09：一个为文本文件和 HTML 页面进行自动摘要的模块。
* [python-readability](https://github.com/buriy/python-readability) ⭐ 2,894 | 🐛 22 | 🌐 HTML | 📅 2026-08-27：arc90 公司 readability 工具的 Python 高速端口。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,239 | 🐛 145 | 🌐 Python | 📅 2026-09-15：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,497 | 🐛 31 | 🌐 C++ | 📅 2026-09-04：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,270 | 🐛 78 | 🌐 C++ | 📅 2026-09-22 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 533 | 🐛 20 | 🌐 C++ | 📅 2026-09-06： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,125 | 🐛 796 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [flower](https://github.com/mher/flower) ⭐ 7,239 | 🐛 36 | 🌐 Python | 📅 2026-09-22：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,901 | 🐛 164 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,334 | 🐛 331 | 🌐 Python | 📅 2026-09-21：异步并发和 I/O 友好的库。
...
* [AutobahnPython](https://github.com/crossbario/autobahn-python) ⭐ 2,541 | 🐛 191 | 🌐 Python | 📅 2026-09-22：给 Python、使用的 WebSocket & WAMP 基于 Twisted 和 [asyncio](https://docs.python.org/3/library/asyncio.html)。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,979 | 🐛 101 | 🌐 Python | 📅 2026-09-22：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [RPyC](https://github.com/tomerfiliba/rpyc) ⭐ 1,704 | 🐛 93 | 🌐 Python | 📅 2026-09-22 (Remote Python Call)：适用于 Python 的透明且对称的RPC库。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,633 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,819 | 🐛 708 | 🌐 Python | 📅 2026-08-30：tkinter，Qt，WxPython 和 Remi 的封装。
...
* [Toga](https://github.com/pybee/toga) ⭐ 5,414 | 🐛 311 | 🌐 Python | 📅 2026-09-21：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,122 | 🐛 257 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,206 | 🐛 412 | 🌐 Python | 📅 2026-09-22：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,906 | 🐛 301 | 🌐 Python | 📅 2026-09-21：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 9,003 | 🐛 44 | 🌐 Python | 📅 2026-09-20：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,177 | 🐛 2 | 🌐 Python | 📅 2026-09-21：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,705 | 🐛 583 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,620 | 🐛 9 | 🌐 Python | 📅 2026-09-22：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,525 | 🐛 171 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
...
* 对象工厂
  * [mixer](https://github.com/klen/mixer) ⭐ 953 | 🐛 49 | 🌐 Python | 📅 2024-03-08：另外一个测试固件 (test fixtures) 替代库，支持 Django, Flask, SQLAlchemy, Peewee 等。
...
* 伪数据
  * [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,841 | 🐛 16 | 🌐 Python | 📅 2026-09-18：一个帮助你生成伪数据的 Python 库。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,495 | 🐛 32 | 🌐 Python | 📅 2026-09-20：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,319 | 🐛 14 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,317 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。

### 代码分析和 Lint 工具

进行代码分析、解析和操作代码库的库和工具。

* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,985 | 🐛 7 | 📅 2026-09-03

  * [pyre-check](https://github.com/facebook/pyre-check) ⚠️ Archived：性能类型检查。
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,124 | 🐛 354 | 🌐 Python | 📅 2026-09-23：带有静态类型的Python库存根的集合。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,909 | 🐛 14 | 🌐 Python | 📅 2026-09-21：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,850 | 🐛 294 | 🌐 Python | 📅 2026-09-22：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,953 | 🐛 84 | 🌐 Python | 📅 2026-09-22：用于纠正包导入顺序的 Python 库。
...
* 调试器
  ...
  * [pdb++](https://github.com/antocuni/pdb) ⭐ 1,467 | 🐛 108 | 🌐 Python | 📅 2024-04-15：另一种 pdb 的替代。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,511 | 🐛 244 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  * [icecream](https://github.com/gruns/icecream) ⭐ 10,109 | 🐛 69 | 🌐 Python | 📅 2026-08-21：通过一个简单的函数调用检查变量、表达式和程序执行情况。
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,379 | 🐛 81 | 🌐 Python | 📅 2026-09-21：为 Django 显示各种调试信息。
  ...
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 0 | 🌐 Python | 📅 2026-09-20：[statsd](https://github.com/etsy/statsd/) ⭐ 18,075 | 🐛 92 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,109 | 🐛 368 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,963 | 🐛 6,025 | 🌐 Python | 📅 2026-09-22：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,643 | 🐛 2,823 | 🌐 Python | 📅 2026-09-22：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,768 | 🐛 509 | 🌐 Python | 📅 2026-09-21：马尔科夫链蒙特卡洛采样工具。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,025 | 🐛 24 | 📅 2026-09-08。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,638 | 🐛 389 | 🌐 Python | 📅 2026-09-22：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,457 | 🐛 845 | 🌐 Python | 📅 2026-09-22：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,034 | 🐛 236 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,482 | 🐛 147 | 🌐 Python | 📅 2026-09-22：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,760 | 🐛 76 | 🌐 Python | 📅 2026-09-22：基于ggplot2的Python图形语法。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,619 | 🐛 316 | 🌐 Python | 📅 2026-09-17：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,774 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,022 | 🐛 531 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,378 | 🐛 175 | 🌐 Python | 📅 2026-09-22：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,958 | 🐛 88 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,260 | 🐛 3,316 | 🌐 C++ | 📅 2026-09-23 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,407 | 🐛 20 | 🌐 Python | 📅 2026-09-22。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,763 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,786 | 🐛 434 | 🌐 C++ | 📅 2026-09-22：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,860 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,509 | 🐛 2,857 | 🌐 Jupyter Notebook | 📅 2026-09-21：开源快速可扩展的机器学习平台。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,721 | 🐛 1 | 🌐 C++ | 📅 2026-09-23 装饰器。
...
* [Surprise](https://github.com/NicolasHug/Surprise) ⭐ 6,817 | 🐛 80 | 🌐 Python | 📅 2026-05-30：用于构建和分析推荐系统的科学工具。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,900 | 🐛 3,594 | 🌐 Python | 📅 2026-09-23：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,777 | 🐛 177 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,923 | 🐛 1,338 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,366 | 🐛 81 | 🌐 Python | 📅 2026-09-21：一个类型安全的单元、转换器与合成工具集合。
...
* [funcy](https://github.com/Suor/funcy) ⭐ 3,511 | 🐛 10 | 🌐 Python | 📅 2026-09-19：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,907 | 🐛 202 | 🌐 Python | 📅 2026-09-22：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,934 | 🐛 49 | 🌐 Python | 📅 2026-09-15：Python 用的 Google APIs 客户端库。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,773 | 🐛 835 | 🌐 Python | 📅 2026-09-22：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,672 | 🐛 1,893 | 🌐 Python | 📅 2026-09-19：基础设施自动化和管理系统。
...
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 6,010 | 🐛 156 | 🌐 Python | 📅 2026-09-22：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,900 | 🐛 840 | 🌐 Python | 📅 2026-09-22：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,270 | 🐛 182 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,082 | 🐛 1,525 | 🌐 C | 📅 2026-09-21：精简高效的 Python 编程语言实现。
...
* [IronPython](https://github.com/IronLanguages/ironpython3) ⭐ 2,761 | 🐛 312 | 🌐 C# | 📅 2026-09-23：用 C＃ 编写的 Python 编程语言的实现。
* [PeachPy](https://github.com/Maratyszcza/PeachPy) ⭐ 2,061 | 🐛 28 | 🌐 Python | 📅 2023-09-25：嵌入 Python 的 x86-64 汇编器。可以被用作 Python 内联的汇编器或者是独立的汇编器，用于 Windows，Linux，OS X，Native Client 或者 Go 。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,559 | 🐛 139 | 🌐 Python | 📅 2026-09-22：一个非常棒的操作数据包的库。
* [keyboard](https://github.com/boppreh/keyboard) ⭐ 3,970 | 🐛 414 | 🌐 Python | 📅 2026-07-10：在 Windows 和 Linux 上挂钩并模拟全局键盘事件。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,566 | 🐛 0 | 📅 2026-09-22 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,882 | 🐛 173 | 🌐 Python | 📅 2026-09-22：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,549 | 🐛 6 | 🌐 Python | 📅 2026-09-18：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,983 | 🐛 42 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
  * [python-ds](https://github.com/prabhupant/python-ds) ⭐ 3,091 | 🐛 34 | 🌐 Python | 📅 2024-04-06：用于面试的数据结构和算法的集合。
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 43,005 | 🐛 12 | 🌐 Python | 📅 2026-09-22：一个 Python 设计模式集合。
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,594 | 🐛 23 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,844 | 🐛 159 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,832 | 🐛 52 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
* [bidict](https://github.com/jab/bidict) ⭐ 1,587 | 🐛 2 | 🌐 Python | 📅 2026-08-25：高效的 Pythonic 的双向映射数据结构和相关功能。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,568 | 🐛 56 | 🌐 Python | 📅 2026-09-22：各种具有可视化效果的机器人算法的汇总。
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,886 | 🐛 38 | 🌐 Python | 📅 2026-09-23：包含 Jedi 补全的 Python 引擎。
...
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,337 | 🐛 1,351 | 🌐 Python | 📅 2026-09-23： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,511 | 🐛 25 | 🌐 Python | 📅 2026-09-13：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,684 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,224 | 🐛 240 | 🌐 Python | 📅 2026-09-18：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,524 | 🐛 4 | 🌐 C++ | 📅 2026-09-22：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,925 | 🐛 95 | 🌐 Python | 📅 2026-09-08：一组纯 Python 实用工具。
