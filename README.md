...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 317,428 | 🐛 19 | 🌐 Python | 📅 2026-08-25 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,053 | 🐛 55 | 🌐 Shell | 📅 2026-08-31：简单的 Python 版本管理工具。
* [p](https://github.com/qw3rtman/p) ⭐ 770 | 🐛 25 | 🌐 Shell | 📅 2019-11-01：非常简单的交互式 Python 版本管理工具。
...
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,005 | 🐛 174 | 🌐 Python | 📅 2026-08-31：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,498 | 🐛 659 | 🌐 Python | 📅 2026-08-31：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,142 | 🐛 591 | 🌐 Python | 📅 2026-08-31：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,086 | 🐛 294 | 🌐 Python | 📅 2026-08-30：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,184 | 🐛 11 | 🌐 Python | 📅 2026-08-30：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,432 | 🐛 313 | 🌐 Python | 📅 2026-08-28：多平台命令行构建工具。
* [PyBuilder](https://github.com/pybuilder/pybuilder) ⭐ 2,037 | 🐛 103 | 🌐 Python | 📅 2026-08-25：纯 Python 实现的持续化构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,777 | 🐛 1,279 | 🌐 Python | 📅 2026-08-28：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,566 | 🐛 709 | 🌐 Python | 📅 2026-07-26 之上。
* [bpython](https://github.com/bpython/bpython) ⭐ 2,774 | 🐛 149 | 🌐 Python | 📅 2026-07-20：界面丰富的 Python 解析器。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,405 | 🐛 240 | 🌐 Python | 📅 2026-08-31：管理文件系统事件的 API 和 shell 工具。
* [aiofiles](https://github.com/Tinche/aiofiles) ⭐ 3,255 | 🐛 57 | 🌐 Python | 📅 2026-08-29：基于 asyncio，提供文件异步操作。
* [python-magic](https://github.com/ahupp/python-magic) ⭐ 2,916 | 🐛 27 | 🌐 Python | 📅 2026-07-20：文件类型检测的第三方库 libmagic 的 Python 接口。
...
* [arrow](https://github.com/crsmithdev/arrow) ⭐ 9,050 | 🐛 191 | 🌐 Python | 📅 2026-06-22：更好的 Python 日期时间操作类库。
* [pendulum](https://github.com/sdispater/pendulum) ⭐ 6,671 | 🐛 267 | 🌐 Python | 📅 2026-08-20：一个比 arrow 更具有明确的，可预测的行为的时间操作库。
* [maya](https://github.com/kennethreitz/maya) ⭐ 3,409 | 🐛 21 | 🌐 Python | 📅 2024-07-19：人性化的时间处理库。
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,631 | 🐛 477 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  ...
  * [ftfy](https://github.com/LuminosoInsight/python-ftfy) ⭐ 4,061 | 🐛 25 | 🌐 Python | 📅 2024-10-30：让 Unicode 文本更完整更连贯。
  ...
  * [chardet](https://github.com/chardet/chardet) ⭐ 2,665 | 🐛 0 | 🌐 Python | 📅 2026-08-30：字符编码检测器，兼容 Python 2 和 Python 3。
  * [shortuuid](https://github.com/stochastic-technologies/shortuuid) ⭐ 2,196 | 🐛 0 | 🌐 Python | 📅 2026-06-20：一个生成器库，用以生成简洁的，明白的，URL 安全的 UUID。
  * [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,711 | 🐛 14 | 🌐 Python | 📅 2026-08-29：Python 的 JSON 编码、解码器。
  * [pyfiglet](https://github.com/pwaller/pyfiglet) ⭐ 1,583 | 🐛 2 | 🌐 Python | 📅 2026-08-02：figlet 的 Python 实现。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,768 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,768 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,513 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 35 | 🌐 Python | 📅 2026-09-01：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,702 | 🐛 516 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,504 | 🐛 535 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
  * [unoconv](https://github.com/dagwieers/unoconv) ⚠️ Archived：在 LibreOffice/OpenOffice 支持的任意文件格式之间进行转换。
  * [docxtpl](https://github.com/elapouya/python-docx-template) ⭐ 2,698 | 🐛 175 | 🌐 Python | 📅 2026-07-07：通过 jinja2 模版编辑 docx 文档。
  * [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,291 | 🐛 11 | 🌐 Python | 📅 2026-07-01：一个提供统一 API，用来读写，操作 Excel 文件的库。
  * [xlwt](https://github.com/python-excel/xlwt) ⚠️ Archived / [xlrd](https://github.com/python-excel/xlrd) ⭐ 2,206 | 🐛 3 | 🌐 Python | 📅 2026-07-15：读写 Excel 文件的数据和格式信息。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,183 | 🐛 131 | 🌐 Python | 📅 2026-08-31：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,245 | 🐛 27 | 🌐 Python | 📅 2026-08-30：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,069 | 🐛 21 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,799 | 🐛 52 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,136 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,480 | 🐛 439 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,870 | 🐛 93 | 🌐 Python | 📅 2026-08-29：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
* [pkuseg-python](https://github.com/lancopku/pkuseg-python) ⭐ 6,711 | 🐛 135 | 🌐 Python | 📅 2022-11-05：一个支持对不同领域进行中文分词的工具箱。
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,633 | 🐛 44 | 🌐 Python | 📅 2020-01-19：一个用来处理中文文本的库。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,379 | 🐛 390 | 🌐 Python | 📅 2026-08-31：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
* [pdoc](https://github.com/BurntSushi/pdoc) ⭐ 2,511 | 🐛 69 | 🌐 Python | 📅 2026-07-01：一个可以替换 Epydoc 的库，可以自动生成 Python 库的 API 文档。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,627 | 🐛 104 | 🌐 Python | 📅 2026-08-31：一个优雅地配置复杂应用程序的框架。
* [python-decouple](https://github.com/henriquebastos/python-decouple) ⭐ 3,038 | 🐛 22 | 🌐 Python | 📅 2024-11-28：将设置和代码完全隔离。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,208 | 🐛 195 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,905 | 🐛 183 | 🌐 Python | 📅 2026-03-23：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,566 | 🐛 709 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,292 | 🐛 372 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,305 | 🐛 604 | 🌐 Python | 📅 2026-08-31：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,296 | 🐛 18 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
  * [asciimatics](https://github.com/peterbrittain/asciimatics) ⭐ 4,301 | 🐛 17 | 🌐 Python | 📅 2026-07-04：跨平台，全屏终端包（即鼠标/键盘输入和彩色，定位文本输出），完整的复杂动画和特殊效果的高级 API。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,756 | 🐛 456 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,070 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,232 | 🐛 724 | 🌐 Python | 📅 2026-08-31：Amazon Web Services 的通用命令行界面。
  * [howdoi](https://github.com/gleitz/howdoi) ⭐ 10,842 | 🐛 28 | 🌐 Python | 📅 2026-04-15：通过命令行获取即时的编程问题解答。
  * [PathPicker](https://github.com/facebook/PathPicker) ⭐ 5,224 | 🐛 26 | 🌐 Python | 📅 2024-09-05：从 bash 输出中选出文件。
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,774 | 🐛 461 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,570 | 🐛 139 | 🌐 Python | 📅 2026-08-29： [tmux](https://github.com/tmux/tmux) ⭐ 48,950 | 🐛 35 | 🌐 C | 📅 2026-09-01 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,551 | 🐛 148 | 🌐 Python | 📅 2026-08-25：用于呈现项目模板的库和命令行实用程序。
  * [percol](https://github.com/mooz/percol) ⭐ 3,327 | 🐛 51 | 🌐 Python | 📅 2023-12-30：向 UNIX shell 传统管道概念中加入交互式选择功能。
  * [pyftpdlib](https://github.com/giampaolo/pyftpdlib) ⭐ 1,819 | 🐛 139 | 🌐 Python | 📅 2026-04-23：一个速度极快和可扩展的 Python FTP 服务库。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,476 | 🐛 336 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,370 | 🐛 39 | 🌐 Python | 📅 2026-08-31：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,972 | 🐛 1 | 🌐 Python | 📅 2026-08-31：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,627 | 🐛 76 | 🌐 Python | 📅 2026-08-31：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,340 | 🐛 3 | 🌐 Python | 📅 2026-08-28：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,702 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
* [thumbor](https://github.com/thumbor/thumbor) ⭐ 10,515 | 🐛 30 | 🌐 Python | 📅 2026-08-30：一个小型图像服务，具有剪裁，尺寸重设和翻转功能。
...
* [pyvips](https://github.com/libvips/pyvips) ⭐ 812 | 🐛 2 | 🌐 Python | 📅 2026-08-30：低内存消耗且快速的图像处理库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,554 | 🐛 233 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,385 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的一个封装。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,602 | 🐛 712 | 🌐 Python | 📅 2026-09-01：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,794 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,582 | 🐛 51 | 🌐 Python | 📅 2026-08-22：音频音乐分析 Python 库。
* [dejavu](https://github.com/worldveil/dejavu) ⭐ 6,784 | 🐛 132 | 🌐 Python | 📅 2024-04-22：音频指纹提取和识别。
* [pyAudioAnalysis](https://github.com/tyiannak/pyAudioAnalysis) ⭐ 6,258 | 🐛 205 | 🌐 Python | 📅 2025-08-04：音频特征提取，分类，分段和应用。
* [matchering](https://github.com/sergree/matchering) ⭐ 2,615 | 🐛 34 | 🌐 Python | 📅 2026-07-08：用于音频母带制作的库。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 834 | 🐛 6 | 🌐 Python | 📅 2026-08-31：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
* [audiolazy](https://github.com/danilobellini/audiolazy) ⭐ 711 | 🐛 14 | 🌐 Python | 📅 2022-04-30：Python 的数字信号处理包。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,857 | 🐛 53 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
* [django-countries](https://github.com/SmileyChris/django-countries) ⭐ 1,532 | 🐛 5 | 🌐 Python | 📅 2026-06-10：一个 Django 应用程序，提供用于表格的国家选择功能，国旗图标静态文件以及模型中的国家字段。
* [GeoIP2](https://github.com/maxmind/GeoIP2-python) ⭐ 1,218 | 🐛 7 | 🌐 Python | 📅 2026-08-31：GeoIP2 Webservice 客户端与数据库 Python API。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,535 | 🐛 231 | 🌐 Python | 📅 2026-09-01：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,463 | 🐛 143 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,573 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,054 | 🐛 226 | 🌐 Python | 📅 2026-08-26：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,558 | 🐛 11 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  ...
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,536 | 🐛 4 | 🌐 Python | 📅 2026-08-22 分支，支持 Python 3。
  * [aiomysql](https://github.com/aio-libs/aiomysql) ⭐ 1,897 | 🐛 117 | 🌐 Python | 📅 2026-03-27：基于 asyncio 的异步 MySQL 数据库操作库。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,625 | 🐛 85 | 🌐 Python | 📅 2026-08-31：Redis 的 Python 客户端。
  * [kafka-python](https://github.com/dpkp/kafka-python) ⭐ 5,899 | 🐛 20 | 🌐 Python | 📅 2026-08-31：Apache Kafka Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-08-29：一个小巧，富有表现力的 ORM。
  * [dataset](https://github.com/pudo/dataset) ⭐ 4,871 | 🐛 22 | 🌐 Python | 📅 2026-07-22：在数据库中存储字典，支持 SQLite，MySQL 和 PostgreSQL。
  * [pony](https://github.com/ponyorm/pony/) ⭐ 3,819 | 🐛 359 | 🌐 Python | 📅 2026-08-10：提供面向生成器的SQL接口的ORM。
...
* [sanic](https://github.com/channelcat/sanic/) ⭐ 18,647 | 🐛 147 | 🌐 Python | 📅 2026-07-29：基于 Python3.5+ 的异步网络框架。
* [Masonite](https://github.com/MasoniteFramework/masonite) ⭐ 2,361 | 🐛 1 | 🌐 Python | 📅 2026-06-07：以开发者为中心的现代 Python Web 框架。
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,225 | 🐛 10 | 🌐 Python | 📅 2026-08-18 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,757 | 🐛 3 | 📅 2026-08-17 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,715 | 🐛 1 | 🌐 Python | 📅 2026-08-29：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,910 | 🐛 33 | 🌐 Python | 📅 2026-08-28：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,103 | 🐛 882 | 🌐 Python | 📅 2026-08-31：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* [money](https://github.com/carlospalol/money) ⭐ 236 | 🐛 12 | 🌐 Python | 📅 2023-04-08：一个货币类库。带有可选的 CLDR 后端本地化格式，提供可扩展的货币兑换解决方案。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,977 | 🐛 80 | 🌐 Python | 📅 2026-08-26：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
  * [hug](https://github.com/hugapi/hug) ⭐ 6,882 | 🐛 189 | 🌐 Python | 📅 2024-07-04：一个为纯净公开的 API 打造的 Python 3 框架。
  ...
  * [sandman2](https://github.com/jeffknupp/sandman2) ⭐ 2,042 | 🐛 45 | 🌐 Python | 📅 2026-08-31：为数据库驱动的系统自动生成 REST API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,374 | 🐛 2 | 🌐 Python | 📅 2026-08-13：Django 的验证应用。
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,408 | 🐛 142 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,335 | 🐛 43 | 🌐 Python | 📅 2026-08-23：为 Django 用户准备的 OAuth2。
  * [python-oauth2](https://github.com/joestump/python-oauth2) ⭐ 3,010 | 🐛 75 | 🌐 Python | 📅 2024-04-09：一个完全测试的抽象接口。用来创建 OAuth 客户端和服务端。
  * [OAuthLib](https://github.com/idan/oauthlib) ⭐ 2,980 | 🐛 119 | 🌐 Python | 📅 2026-07-14：一个 OAuth 请求-签名逻辑通用、 完整的实现。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,696 | 🐛 63 | 🌐 Python | 📅 2026-08-31：JSON Web 令牌草案 01。
  * [python-jose](https://github.com/mpdavis/python-jose/) ⭐ 1,756 | 🐛 122 | 🌐 Python | 📅 2026-04-14：python 版 JOSE 实现。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,756 | 🐛 102 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,023 | 🐛 0 | 🌐 Python | 📅 2026-08-31：小型多线程任务队列。
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,311 | 🐛 64 | 🌐 Python | 📅 2026-08-13：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-compressor](https://github.com/django-compressor/django-compressor) ⭐ 2,871 | 🐛 121 | 🌐 Python | 📅 2026-08-25：将链接和内联的 JavaScript 或 CSS 压缩到一个单独的缓存文件中。
...
* [django-cacheops](https://github.com/Suor/django-cacheops) ⭐ 2,273 | 🐛 22 | 🌐 Python | 📅 2026-04-15：具有自动颗粒化事件驱动失效功能的 ORM。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,534 | 🐛 54 | 🌐 Python | 📅 2026-08-29：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
* [inbox](https://github.com/nylas/sync-engine) ⚠️ Archived：一个开源电子邮件工具箱。
* [flanker](https://github.com/mailgun/flanker) ⭐ 1,650 | 🐛 78 | 🌐 Python | 📅 2026-04-08：一个 email 地址和 Mime 解析库。
* [inbox.py](https://github.com/kennethreitz/inbox.py) ⭐ 1,500 | 🐛 3 | 🌐 Python | 📅 2016-07-11：Python SMTP 服务器。
* [Talon](https://github.com/mailgun/talon) ⭐ 1,342 | 🐛 64 | 🌐 Python | 📅 2026-08-31：Mailgun 库，用来抽取信息和签名。
...
* [furl](https://github.com/gruns/furl) ⭐ 2,810 | 🐛 53 | 🌐 Python | 📅 2026-02-22：一个让处理 URL 更简单小型 Python 库。
* [webargs](https://github.com/sloria/webargs) ⭐ 1,406 | 🐛 10 | 🌐 Python | 📅 2026-09-01：一个解析 HTTP 请求参数的库，内置对流行 web 框架的支持，包括 Flask, Django, Bottle, Tornado 和 Pyramid。
...
* [xmltodict](https://github.com/martinblech/xmltodict) ⭐ 5,752 | 🐛 5 | 🌐 Python | 📅 2026-08-19：像处理 JSON 一样处理 XML。
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,388 | 🐛 139 | 🌐 Python | 📅 2026-08-30：HTML/CSS 转 PDF 工具。
...
* [MarkupSafe](https://github.com/pallets/markupsafe) ⭐ 696 | 🐛 15 | 🌐 Python | 📅 2025-09-27：为 Python 实现 XML/HTML/XHTML 标记安全字符串。
...
* [ScrapydWeb](https://github.com/my8100/scrapydweb) ⭐ 3,411 | 🐛 63 | 🌐 Python | 📅 2025-02-19：一个用于 Scrapyd 集群管理的全功能 web UI，支持 Scrapy 日志分析和可视化，自动打包，定时器任务和邮件通知等特色功能。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,146 | 🐛 514 | 🌐 Python | 📅 2026-08-31：使用 Python 进行新闻提取，文章提取以及内容策展。
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,702 | 🐛 61 | 🌐 HTML | 📅 2026-09-01：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
* [python-goose](https://github.com/grangier/python-goose) ⭐ 4,106 | 🐛 107 | 🌐 HTML | 📅 2026-03-10：HTML 内容/文章提取器(python2)。
* [sumy](https://github.com/miso-belica/sumy) ⭐ 3,702 | 🐛 7 | 🌐 Python | 📅 2026-08-31：一个为文本文件和 HTML 页面进行自动摘要的模块。
...
* [micawber](https://github.com/coleifer/micawber) ⭐ 679 | 🐛 0 | 🌐 Python | 📅 2026-08-30：一个小型网页内容提取库，用来从 URLs 提取富内容。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,979 | 🐛 59 | 🌐 Python | 📅 2026-08-31：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [voluptuous](https://github.com/alecthomas/voluptuous) ⭐ 1,850 | 🐛 45 | 🌐 Python | 📅 2026-07-25：一个 Python 数据验证库。主要是为了验证传入 Python 的 JSON，YAML 等数据。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,240 | 🐛 150 | 🌐 Python | 📅 2026-09-01：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,496 | 🐛 33 | 🌐 C++ | 📅 2026-09-01：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 773 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,218 | 🐛 135 | 🌐 C++ | 📅 2026-08-31 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 22 | 🌐 C++ | 📅 2026-08-30： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,119 | 🐛 791 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。

### 反垃圾技术

帮助你和电子垃圾进行战斗的库。

* [django-simple-captcha](https://github.com/mbi/django-simple-captcha) ⭐ 1,421 | 🐛 39 | 🌐 Python | 📅 2026-07-30：一个简单、高度可定制的 Django 应用，可以为任何 Django 表单添加验证码。
...
* [Ajenti](https://github.com/ajenti/ajenti) ⭐ 7,965 | 🐛 10 | 🌐 Python | 📅 2026-07-22：一个你的服务器值得拥有的管理面板。
* [flower](https://github.com/mher/flower) ⭐ 7,237 | 🐛 156 | 🌐 Python | 📅 2026-08-16：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,070 | 🐛 128 | 🌐 Python | 📅 2026-08-16：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [Wooey](https://github.com/wooey/wooey) ⭐ 2,245 | 🐛 57 | 🌐 Python | 📅 2026-08-04：一个 Django 应用，可以为 Python 脚本创建 web 用户界面。
* [jet-bridge](https://github.com/jet-admin/jet-bridge) ⭐ 1,798 | 🐛 12 | 🌐 Python | 📅 2026-08-18：管理面板框架，适用于任何具有良好 UI 的应用（例如 Django）。
...
* [makesite](https://github.com/sunainapai/makesite) ⭐ 1,868 | 🐛 7 | 🌐 Python | 📅 2023-03-04：简单轻量的站点/博客生成器（小于 130 行代码）。
...
* [sh](https://github.com/amoffat/sh) ⭐ 7,242 | 🐛 2 | 🌐 Python | 📅 2026-07-25：一个完备的 subprocess 替代库。
...
* [delegator.py](https://github.com/amitt001/delegator.py) ⭐ 1,741 | 🐛 12 | 🌐 Python | 📅 2022-12-01：人性化的 [Subprocesses](https://docs.python.org/3/library/subprocess.html) 2.0 版本。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,895 | 🐛 158 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
* [gevent](http://www.gevent.org/)：一个基于协程的 Python 网络库，使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,841 | 🐛 22 | 🌐 C++ | 📅 2026-08-10。
* [gevent](http://www.gevent.org/)：使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,841 | 🐛 22 | 🌐 C++ | 📅 2026-08-10 且基于协程的 Python 网络库。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,309 | 🐛 325 | 🌐 Python | 📅 2026-08-31：异步并发和 I/O 友好的库。
...
* [netius](https://github.com/hivesolutions/netius) ⭐ 118 | 🐛 6 | 🌐 Python | 📅 2026-08-31：异步，非常快速。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,939 | 🐛 87 | 🌐 Python | 📅 2026-09-01：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,679 | 🐛 40 | 🌐 Python | 📅 2026-08-28：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [PyNacl](https://github.com/pyca/pynacl) ⭐ 1,205 | 🐛 57 | 🌐 C | 📅 2026-08-25：网络和密码学(NaCl) 库的 Python 绑定。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,589 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) ⭐ 13,811 | 🐛 706 | 🌐 Python | 📅 2026-08-30：tkinter，Qt，WxPython 和 Remi 的封装。
* [Eel](https://github.com/ChrisKnott/Eel) ⚠️ Archived：用于制作简单离线 HTML/JS GUI 应用的库。
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,001 | 🐛 14 | 🌐 Python | 📅 2026-08-31：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,408 | 🐛 308 | 🌐 Python | 📅 2026-08-31：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,088 | 🐛 253 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 404 | 🌐 Python | 📅 2026-08-31：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,852 | 🐛 301 | 🌐 Python | 📅 2026-08-31：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,928 | 🐛 44 | 🌐 Python | 📅 2026-08-31：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
  * [nose2](https://github.com/nose-devs/nose2) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-08-31 `nose`的继任者，基于 `unittest2`。
  * [green](https://github.com/CleanCut/green) ⭐ 805 | 🐛 8 | 🌐 Python | 📅 2024-11-12：干净，多彩的测试工具。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,116 | 🐛 4 | 🌐 Python | 📅 2026-08-26：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,672 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,573 | 🐛 11 | 🌐 Python | 📅 2026-08-30：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,524 | 🐛 168 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
  * [responses](https://github.com/getsentry/responses) ⭐ 4,345 | 🐛 42 | 🌐 Python | 📅 2026-08-26：伪造 Python 中的 requests 库的一个通用库。
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,988 | 🐛 161 | 🌐 Python | 📅 2026-08-25：在你的测试中记录和重放 HTTP 交互。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,328 | 🐛 34 | 🌐 Python | 📅 2026-08-28：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,247 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,283 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。

### 代码分析和 Lint 工具

进行代码分析、解析和操作代码库的库和工具。

* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,981 | 🐛 7 | 📅 2026-06-19

  * [pyre-check](https://github.com/facebook/pyre-check) ⚠️ Archived：性能类型检查。
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,118 | 🐛 369 | 🌐 Python | 📅 2026-09-01：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,788 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
...
* Lint 工具
  * [YAPF](https://github.com/google/yapf) ⭐ 13,982 | 🐛 417 | 🌐 Python | 📅 2026-08-28：Google 的 Python 代码格式化工具。

  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,896 | 🐛 14 | 🌐 Python | 📅 2026-08-31：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,827 | 🐛 311 | 🌐 Python | 📅 2026-08-31：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,949 | 🐛 85 | 🌐 Python | 📅 2026-08-27：用于纠正包导入顺序的 Python 库。
  * [autopep8](https://github.com/hhatto/autopep8) ⭐ 4,660 | 🐛 135 | 🌐 Python | 📅 2026-07-20：自动格式化 Python 代码，以使其符合 PEP8 规范。

* 静态类型注释生成器

  * [pytype](https://github.com/google/pytype) ⭐ 5,032 | 🐛 5 | 🌐 Python | 📅 2026-03-16：检查和推断 Python 代码中的类型，无需添加注解。
...
* 调试器
  ...
  * [pdb++](https://github.com/antocuni/pdb) ⭐ 1,464 | 🐛 108 | 🌐 Python | 📅 2024-04-15：另一种 pdb 的替代。
...
* 追踪器
  ...
  * [python-hunter](https://github.com/ionelmc/python-hunter) ⭐ 873 | 🐛 49 | 🌐 Python | 📅 2025-08-22：一个灵活的代码追踪工具包。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,460 | 🐛 238 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  * [icecream](https://github.com/gruns/icecream) ⭐ 10,110 | 🐛 64 | 🌐 Python | 📅 2026-08-21：通过一个简单的函数调用检查变量、表达式和程序执行情况。
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,378 | 🐛 79 | 🌐 Python | 📅 2026-09-01：为 Django 显示各种调试信息。
  ...
  * [flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) ⭐ 979 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-03：django-debug-toolbar 的 flask 版。
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 1 | 🌐 Python | 📅 2019-02-15：[statsd](https://github.com/etsy/statsd/) ⭐ 18,074 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,076 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,901 | 🐛 5,975 | 🌐 Python | 📅 2026-09-01：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,601 | 🐛 2,806 | 🌐 Python | 📅 2026-08-31：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,732 | 🐛 491 | 🌐 Python | 📅 2026-08-31：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,119 | 🐛 53 | 🌐 Python | 📅 2026-08-31：AWS 平台上使用的 Pandas。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,332 | 🐛 302 | 🌐 Python | 📅 2026-08-31：地震学 Python 工具箱。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,022 | 🐛 31 | 📅 2026-08-19。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,571 | 🐛 388 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,436 | 🐛 854 | 🌐 Python | 📅 2026-09-01：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,009 | 🐛 230 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,461 | 🐛 147 | 🌐 Python | 📅 2026-08-16：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,756 | 🐛 85 | 🌐 Python | 📅 2026-08-31：基于ggplot2的Python图形语法。
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,693 | 🐛 279 | 🌐 TypeScript | 📅 2026-05-07：Jupyter Notebook 的交互式绘图库。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,616 | 🐛 327 | 🌐 Python | 📅 2026-08-27：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,702 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,962 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,339 | 🐛 126 | 🌐 Python | 📅 2026-08-31：PyTorch 的开源差异化计算机视觉库。
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,385 | 🐛 21 | 🌐 Python | 📅 2026-07-13：[Google Tesseract OCR](https://github.com/tesseract-ocr) 的另一包装库。
* [tesserocr](https://github.com/sirfz/tesserocr) ⭐ 2,170 | 🐛 46 | 🌐 Python | 📅 2026-08-04：另一个简单的，兼容 Pillow 的 `tesseract-ocr` API 装饰器，可用于 OCR。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,843 | 🐛 84 | 📅 2025-05-26。

* [Caffe](http://caffe.berkeleyvision.org)：一个 [Caffe](https://github.com/BVLC/caffe) ⭐ 34,555 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 的 python 接口。
* [Theano](https://github.com/Theano/Theano) ⭐ 10,000 | 🐛 699 | 🌐 Python | 📅 2024-01-15：一个快速数值计算库。
* [SerpentAI](https://github.com/SerpentAI/SerpentAI) ⚠️ Archived：游戏代理框架，可使用任意视频游戏作为深度学习沙箱。
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,095 | 🐛 2,984 | 🌐 C++ | 📅 2026-09-01 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,228 | 🐛 30 | 🌐 Python | 📅 2026-08-27。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,670 | 🐛 3 | 🌐 Makefile | 📅 2026-08-21：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,718 | 🐛 429 | 🌐 C++ | 📅 2026-08-31：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,859 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,497 | 🐛 2,883 | 🌐 Jupyter Notebook | 📅 2026-08-31：开源快速可扩展的机器学习平台。
...
* [Pylearn2](https://github.com/lisa-lab/pylearn2) ⭐ 2,767 | 🐛 201 | 🌐 Python | 📅 2021-08-20：一个基于 [Theano](https://github.com/Theano/Theano) ⭐ 10,000 | 🐛 699 | 🌐 Python | 📅 2024-01-15 的机器学习库。
* [Metrics](https://github.com/benhamner/Metrics) ⭐ 1,649 | 🐛 36 | 🌐 Python | 📅 2023-01-11：机器学习的评估指标。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,706 | 🐛 2 | 🌐 C++ | 📅 2026-08-26 装饰器。
...
* [annoy](https://github.com/spotify/annoy) ⭐ 14,291 | 🐛 86 | 🌐 C++ | 📅 2025-10-29：对 C++/Python 实现的近似近邻算法进行了内存优化。
...
* [implicit](https://github.com/benfred/implicit) ⭐ 3,816 | 🐛 97 | 🌐 Python | 📅 2026-05-08：对隐式数据集进行协作过滤的快速 Python 实现。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,668 | 🐛 3,546 | 🌐 Python | 📅 2026-09-01：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,768 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,910 | 🐛 1,321 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [Toolz](https://github.com/pytoolz/toolz) ⭐ 5,153 | 🐛 138 | 🌐 Python | 📅 2026-01-01：一组用于迭代器，函数和字典的函数式编程工具。
* [returns](https://github.com/dry-python/returns) ⭐ 4,357 | 🐛 82 | 🌐 Python | 📅 2026-08-31：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,352 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,088 | 🐛 12 | 🌐 Python | 📅 2026-08-12：比 `itertools` 拥有更多的可迭代对象的操作方式。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,893 | 🐛 191 | 🌐 Python | 📅 2026-08-31：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,920 | 🐛 44 | 🌐 Python | 📅 2026-08-31：Python 用的 Google APIs 客户端库。
* [gspread](https://github.com/burnash/gspread) ⭐ 7,506 | 🐛 72 | 🌐 Python | 📅 2026-07-30：Google 电子表格的 Python API。
* [facebook-sdk](https://github.com/mobolic/facebook-sdk) ⭐ 2,797 | 🐛 38 | 🌐 Python | 📅 2024-08-02：Facebook 平台的 Python SDK。
* [twython](https://github.com/ryanmcgrath/twython) ⭐ 1,859 | 🐛 29 | 🌐 Python | 📅 2022-07-30：Twitter API 的封装。
* [gmail](https://github.com/charlierguo/gmail) ⭐ 1,805 | 🐛 64 | 🌐 Python | 📅 2023-07-09：Gmail 的 Python 接口。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,521 | 🐛 834 | 🌐 Python | 📅 2026-08-31：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,638 | 🐛 1,848 | 🌐 Python | 📅 2026-08-31：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,272 | 🐛 260 | 🌐 Python | 📅 2026-08-27：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,110 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,970 | 🐛 174 | 🌐 Python | 📅 2026-08-31：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
* [pexpect](https://github.com/pexpect/pexpect) ⭐ 2,851 | 🐛 170 | 🌐 Python | 📅 2025-04-11：在一个伪终端中控制交互程序，就像 GNU expect 一样。
* [honcho](https://github.com/nickstenning/honcho) ⭐ 1,711 | 🐛 26 | 🌐 Python | 📅 2025-06-03：[Foreman](https://github.com/ddollar/foreman) ⭐ 6,158 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 的 Python 克隆版，用来管理基于 [Procfile](https://devcenter.heroku.com/articles/procfile) 的应用。
* [honcho](https://github.com/nickstenning/honcho) ⭐ 1,711 | 🐛 26 | 🌐 Python | 📅 2025-06-03：[Foreman](https://github.com/ddollar/foreman) ⭐ 6,158 | 🐛 72 | 🌐 Ruby | 📅 2025-07-27 的 Python 克隆版，用于管理基于 Procfile 的应用。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,740 | 🐛 868 | 🌐 Python | 📅 2026-08-31：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
* [schedule](https://github.com/dbader/schedule) ⭐ 12,264 | 🐛 178 | 🌐 Python | 📅 2024-05-25：人性化的 Python 任务调度库。
* [Spiff](https://github.com/knipknap/SpiffWorkflow) ⭐ 1,914 | 🐛 9 | 🌐 Python | 📅 2026-08-31：使用纯 Python 实现的强大的工作流引擎。
...
* [gunnery](https://github.com/gunnery/gunnery) ⭐ 769 | 🐛 16 | 🌐 Python | 📅 2022-03-29：分布式系统使用的多用途任务执行工具 ，具有 web 交互界面。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,234 | 🐛 143 | 🌐 Python | 📅 2026-08-25：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,034 | 🐛 1,533 | 🌐 C | 📅 2026-08-31：精简高效的 Python 编程语言实现。
...
* [napalm](https://github.com/napalm-automation/napalm) ⭐ 2,495 | 🐛 174 | 🌐 Python | 📅 2026-08-12：可跨供应商 API 来操纵网络设备。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,507 | 🐛 130 | 🌐 Python | 📅 2026-08-30：一个非常棒的操作数据包的库。
* [keyboard](https://github.com/boppreh/keyboard) ⭐ 3,964 | 🐛 414 | 🌐 Python | 📅 2026-07-10：在 Windows 和 Linux 上挂钩并模拟全局键盘事件。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,490 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,153 | 🐛 1,059 | 🌐 Python | 📅 2026-08-31：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,544 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,980 | 🐛 39 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
  * [python-ds](https://github.com/prabhupant/python-ds) ⭐ 3,089 | 🐛 34 | 🌐 Python | 📅 2024-04-06：用于面试的数据结构和算法的集合。
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,953 | 🐛 17 | 🌐 Python | 📅 2026-08-20：一个 Python 设计模式集合。
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,582 | 🐛 21 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,834 | 🐛 151 | 🌐 Python | 📅 2026-08-27：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,830 | 🐛 46 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
* [bidict](https://github.com/jab/bidict) ⭐ 1,587 | 🐛 1 | 🌐 Python | 📅 2026-08-25：高效的 Pythonic 的双向映射数据结构和相关功能。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,423 | 🐛 56 | 🌐 Python | 📅 2026-08-31：各种具有可视化效果的机器人算法的汇总。
...
* [errbot](https://github.com/errbotio/errbot/) ⭐ 3,302 | 🐛 45 | 🌐 Python | 📅 2026-08-17：实现 ChatOps 的最简单最受欢迎的聊天机器人。

### 编辑器插件和 IDE

* Emacs
  * [elpy](https://github.com/jorgenschaefer/elpy) ⭐ 1,938 | 🐛 394 | 🌐 Emacs Lisp | 📅 2026-07-15：Emacs Python 开发环境。
* Sublime Text
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,896 | 🐛 36 | 🌐 Python | 📅 2026-08-23：包含 Jedi 补全的 Python 引擎。
...
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,300 | 🐛 1,341 | 🌐 Python | 📅 2026-08-31： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,025 | 🐛 32 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,514 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,071 | 🐛 239 | 🌐 Python | 📅 2026-02-28：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,477 | 🐛 5 | 🌐 C++ | 📅 2026-08-29：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [itsdangerous](https://github.com/pallets/itsdangerous) ⭐ 3,132 | 🐛 4 | 🌐 Python | 📅 2025-06-14：将受信任的数据传递到不受信任的环境的帮助工具。
* [blinker](https://github.com/jek/blinker) ⭐ 2,089 | 🐛 0 | 🌐 Python | 📅 2025-11-19：快速的 Python 运行时信号/事件分配系统。
