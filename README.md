...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,882 | 🐛 18 | 🌐 Python | 📅 2026-09-01 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,082 | 🐛 54 | 🌐 Shell | 📅 2026-09-06：简单的 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,033 | 🐛 13 | 🌐 Python | 📅 2026-08-24：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,007 | 🐛 176 | 🌐 Python | 📅 2026-08-31：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,504 | 🐛 661 | 🌐 Python | 📅 2026-09-04：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,144 | 🐛 586 | 🌐 Python | 📅 2026-09-04：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,086 | 🐛 289 | 🌐 Python | 📅 2026-09-06：将 Python 程序转换成独立的执行文件（跨平台）。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,440 | 🐛 279 | 🌐 Python | 📅 2026-09-05：多平台命令行构建工具。
...
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,450 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,566 | 🐛 713 | 🌐 Python | 📅 2026-07-26 之上。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,407 | 🐛 250 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
...
* [dateutil](https://github.com/dateutil/dateutil) ⭐ 2,631 | 🐛 479 | 🌐 Python | 📅 2026-05-19：Python 标准包 [datetime](https://docs.python.org/3/library/datetime.html) 的扩展。
...
* 通用
  ...
  * [simplejson](https://github.com/simplejson/simplejson) ⭐ 1,710 | 🐛 15 | 🌐 Python | 📅 2026-08-29：Python 的 JSON 编码、解码器。
...
* Slug 化
  * [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,623 | 🐛 16 | 🌐 Python | 📅 2026-04-27：Python slug 化库，可以把 unicode 转化为 ASCII。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,772 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,772 | 🐛 12 | 🌐 Python | 📅 2026-08-28：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,513 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 32 | 🌐 Python | 📅 2026-09-06：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,710 | 🐛 514 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
  * [python-pptx](https://github.com/scanny/python-pptx) ⭐ 3,512 | 🐛 535 | 🌐 Python | 📅 2024-08-07：可用于创建和修改 ppt 文件的 Python 库。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,192 | 🐛 133 | 🌐 Python | 📅 2026-09-04：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,246 | 🐛 29 | 🌐 Python | 📅 2026-09-06：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,071 | 🐛 23 | 🌐 Python | 📅 2026-08-21：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,917 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,143 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
* [gensim](https://github.com/piskvorky/gensim) ⭐ 16,480 | 🐛 439 | 🌐 Python | 📅 2025-11-01：人性化的话题建模库。
* [Stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,873 | 🐛 94 | 🌐 Python | 📅 2026-09-05：斯坦福 NLP 集团的官方 Python 库，支持 60 多种语言。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,384 | 🐛 389 | 🌐 Python | 📅 2026-09-06：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,639 | 🐛 73 | 🌐 Python | 📅 2026-09-06：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  * [python-fire](https://github.com/google/python-fire) ⭐ 28,215 | 🐛 196 | 🌐 Python | 📅 2026-07-01：Google 出品的一个基于 Python 类的构建命令行界面的库。
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,899 | 🐛 183 | 🌐 Python | 📅 2026-09-04：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,566 | 🐛 713 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,333 | 🐛 375 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,308 | 🐛 614 | 🌐 Python | 📅 2026-09-06：一个可在循环和命令行中使用的快速、可扩展的进度条。
  * [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,302 | 🐛 21 | 🌐 Python | 📅 2026-05-24：一款新的进度条，具有实时吞吐量信息以及非常酷的动画。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,770 | 🐛 456 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,077 | 🐛 311 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,236 | 🐛 728 | 🌐 Python | 📅 2026-09-04：Amazon Web Services 的通用命令行界面。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,572 | 🐛 139 | 🌐 Python | 📅 2026-09-05： [tmux](https://github.com/tmux/tmux) ⭐ 49,103 | 🐛 33 | 🌐 C | 📅 2026-09-05 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,580 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,558 | 🐛 149 | 🌐 Python | 📅 2026-09-04：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,486 | 🐛 337 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,373 | 🐛 37 | 🌐 Python | 📅 2026-09-04：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,974 | 🐛 2 | 🌐 Python | 📅 2026-09-05：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,633 | 🐛 78 | 🌐 Python | 📅 2026-09-06：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,448 | 🐛 7 | 🌐 Python | 📅 2026-09-02：为方便人使用而创建的金融数据接口库。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,975 | 🐛 242 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,627 | 🐛 712 | 🌐 Python | 📅 2026-09-06：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,792 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 837 | 🐛 7 | 🌐 Python | 📅 2026-09-06：一个用来读取 MP3, OGG, FLAC 以及 Wave 文件音乐元数据的库。
...
* [vidgear](https://github.com/abhiTronix/vidgear) ⭐ 3,724 | 🐛 1 | 🌐 Python | 📅 2026-05-18： 强大的多线程视频处理框架。
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,858 | 🐛 54 | 🌐 Python | 📅 2026-07-12：Python 地址编码工具箱。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,538 | 🐛 214 | 🌐 Python | 📅 2026-09-06：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,461 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,572 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,053 | 🐛 228 | 🌐 Python | 📅 2026-09-05：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  ...
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,537 | 🐛 4 | 🌐 Python | 📅 2026-09-06 分支，支持 Python 3。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,628 | 🐛 81 | 🌐 Python | 📅 2026-09-04：Redis 的 Python 客户端。
  * [kafka-python](https://github.com/dpkp/kafka-python) ⭐ 5,900 | 🐛 18 | 🌐 Python | 📅 2026-09-03：Apache Kafka Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,985 | 🐛 0 | 🌐 Python | 📅 2026-09-06：一个小巧，富有表现力的 ORM。
  * [dataset](https://github.com/pudo/dataset) ⭐ 4,871 | 🐛 25 | 🌐 Python | 📅 2026-07-22：在数据库中存储字典，支持 SQLite，MySQL 和 PostgreSQL。
...
* [sanic](https://github.com/channelcat/sanic/) ⭐ 18,642 | 🐛 148 | 🌐 Python | 📅 2026-07-29：基于 Python3.5+ 的异步网络框架。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,238 | 🐛 4 | 🌐 Python | 📅 2026-09-06 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,761 | 🐛 3 | 📅 2026-08-17 系列
...
* [autobahn-python](https://github.com/crossbario/autobahn-python) ⭐ 2,542 | 🐛 187 | 🌐 Python | 📅 2026-07-15：适用于 Twisted 和 asyncio 的 Python WebSocket 和 WAMP。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,159 | 🐛 92 | 🌐 Python | 📅 2026-09-01：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,376 | 🐛 2 | 🌐 Python | 📅 2026-09-01：Django 的验证应用。
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,413 | 🐛 144 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,697 | 🐛 63 | 🌐 Python | 📅 2026-09-02：JSON Web 令牌草案 01。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,766 | 🐛 103 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [daramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,312 | 🐛 65 | 🌐 Python | 📅 2026-09-02：适用于Python 3的快速可靠的后台任务处理库。
...
* [django-haystack](https://github.com/django-haystack/django-haystack) ⭐ 3,733 | 🐛 581 | 🌐 Python | 📅 2026-08-21：Django 模块化搜索。
...
* [Stream-Framework](https://github.com/tschellenbach/Stream-Framework) ⭐ 4,744 | 🐛 76 | 🌐 Python | 📅 2025-12-04：使用 Cassandra 和 Redis 创建动态消息和通知系统。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,537 | 🐛 48 | 🌐 Python | 📅 2026-09-06：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,342 | 🐛 56 | 🌐 Python | 📅 2026-09-05：Mailgun 库，用来抽取信息和签名。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,390 | 🐛 137 | 🌐 Python | 📅 2026-09-03：HTML/CSS 转 PDF 工具。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,151 | 🐛 514 | 🌐 Python | 📅 2026-08-31：使用 Python 进行新闻提取，文章提取以及内容策展。
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,709 | 🐛 57 | 🌐 HTML | 📅 2026-09-01：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,977 | 🐛 56 | 🌐 Python | 📅 2026-09-06：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,237 | 🐛 133 | 🌐 C++ | 📅 2026-09-06 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 531 | 🐛 20 | 🌐 C++ | 📅 2026-09-06： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,123 | 🐛 792 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [flower](https://github.com/mher/flower) ⭐ 7,243 | 🐛 68 | 🌐 Python | 📅 2026-09-06：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
* [flask-admin](https://github.com/flask-admin/flask-admin) ⭐ 6,070 | 🐛 130 | 🌐 Python | 📅 2026-09-01：一个用于 Flask 的简单可扩展的管理界面框架。
...
* [Cactus](https://github.com/koenbok/Cactus/) ⭐ 3,465 | 🐛 99 | 🌐 Python | 📅 2023-08-28：为设计师设计的静态站点生成器。
...
* [sh](https://github.com/amoffat/sh) ⭐ 7,240 | 🐛 2 | 🌐 Python | 📅 2026-07-25：一个完备的 subprocess 替代库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,896 | 🐛 159 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,315 | 🐛 328 | 🌐 Python | 📅 2026-09-01：异步并发和 I/O 友好的库。
...
* [AutobahnPython](https://github.com/crossbario/autobahn-python) ⭐ 2,542 | 🐛 187 | 🌐 Python | 📅 2026-07-15：给 Python、使用的 WebSocket & WAMP 基于 Twisted 和 [asyncio](https://docs.python.org/3/library/asyncio.html)。
* [Crossbar](https://github.com/crossbario/crossbar/) ⭐ 2,063 | 🐛 305 | 🌐 Python | 📅 2026-08-31：开源统一应用路由(Websocket & WAMP for Python on Autobahn)。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,949 | 🐛 88 | 🌐 Python | 📅 2026-09-01：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [PyNacl](https://github.com/pyca/pynacl) ⭐ 1,204 | 🐛 58 | 🌐 C | 📅 2026-08-25：网络和密码学(NaCl) 库的 Python 绑定。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,601 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,010 | 🐛 15 | 🌐 Python | 📅 2026-09-06：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,410 | 🐛 316 | 🌐 Python | 📅 2026-09-06：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,095 | 🐛 253 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 390 | 🌐 Python | 📅 2026-09-04：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,868 | 🐛 300 | 🌐 Python | 📅 2026-09-04：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,943 | 🐛 45 | 🌐 Python | 📅 2026-09-06：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,132 | 🐛 4 | 🌐 Python | 📅 2026-09-06：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,677 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,582 | 🐛 11 | 🌐 Python | 📅 2026-09-07：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  ...
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,004 | 🐛 167 | 🌐 Python | 📅 2026-09-01：在你的测试中记录和重放 HTTP 交互。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,372 | 🐛 33 | 🌐 Python | 📅 2026-09-04：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,264 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,983 | 🐛 6 | 📅 2026-09-03
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,119 | 🐛 344 | 🌐 Python | 📅 2026-09-07：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,795 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
...
* Lint 工具
  * [YAPF](https://github.com/google/yapf) ⭐ 13,985 | 🐛 419 | 🌐 Python | 📅 2026-08-28：Google 的 Python 代码格式化工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,829 | 🐛 308 | 🌐 Python | 📅 2026-09-04：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,950 | 🐛 90 | 🌐 Python | 📅 2026-08-27：用于纠正包导入顺序的 Python 库。
...
* 静态类型注释生成器
  ...
  * [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,997 | 🐛 78 | 🌐 Python | 📅 2026-02-11：通过收集运行时的类型来为 Python 生成静态类型注释的系统。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,477 | 🐛 239 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,375 | 🐛 78 | 🌐 Python | 📅 2026-09-06：为 Django 显示各种调试信息。
  * [pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,278 | 🐛 55 | 🌐 Python | 📅 2026-07-30：解析和分析 ELF 文件以及 DWARF 调试信息。
  ...
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 1 | 🌐 Python | 📅 2019-02-15：[statsd](https://github.com/etsy/statsd/) ⭐ 18,076 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,081 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,910 | 🐛 5,967 | 🌐 Python | 📅 2026-09-06：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,608 | 🐛 2,803 | 🌐 Python | 📅 2026-09-06：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,740 | 🐛 490 | 🌐 Python | 📅 2026-09-03：马尔科夫链蒙特卡洛采样工具。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,332 | 🐛 308 | 🌐 Python | 📅 2026-09-03：地震学 Python 工具箱。
...
* [bccb](https://github.com/chapmanb/bcbb) ⭐ 646 | 🐛 20 | 🌐 Python | 📅 2025-02-05：生物分析相关代码集合。
...
* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,589 | 🐛 388 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,445 | 🐛 858 | 🌐 Python | 📅 2026-09-06：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,773 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,016 | 🐛 232 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,468 | 🐛 153 | 🌐 Python | 📅 2026-09-05：用于 Python 的声明式统计可视化库。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 327 | 🌐 Python | 📅 2026-09-04：具有 matplotlib 支持的 Python 制图库。
...
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,347 | 🐛 173 | 🌐 Python | 📅 2026-09-06：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,869 | 🐛 85 | 📅 2025-05-26。

* [Caffe](http://caffe.berkeleyvision.org)：一个 [Caffe](https://github.com/BVLC/caffe) ⭐ 34,551 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 的 python 接口。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,906 | 🐛 3,119 | 🌐 C++ | 📅 2026-09-07 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,271 | 🐛 30 | 🌐 Python | 📅 2026-09-02。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,704 | 🐛 6 | 🌐 Makefile | 📅 2026-09-04：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,740 | 🐛 430 | 🌐 C++ | 📅 2026-09-04：可扩展，便携式和分布式梯度提升库。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,720 | 🐛 3,569 | 🌐 Python | 📅 2026-09-06：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,768 | 🐛 170 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,911 | 🐛 1,326 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,354 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 9 | 🌐 Python | 📅 2026-09-06：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,510 | 🐛 16 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,895 | 🐛 192 | 🌐 Python | 📅 2026-09-04：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,922 | 🐛 51 | 🌐 Python | 📅 2026-09-04：Python 用的 Google APIs 客户端库。
...
* [gmail](https://github.com/charlierguo/gmail) ⭐ 1,808 | 🐛 64 | 🌐 Python | 📅 2023-07-09：Gmail 的 Python 接口。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,601 | 🐛 845 | 🌐 Python | 📅 2026-09-04：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,647 | 🐛 1,885 | 🌐 Python | 📅 2026-09-05：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,272 | 🐛 257 | 🌐 Python | 📅 2026-09-06：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,108 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,979 | 🐛 182 | 🌐 Python | 📅 2026-08-31：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
* [pexpect](https://github.com/pexpect/pexpect) ⭐ 2,848 | 🐛 170 | 🌐 Python | 📅 2025-04-11：在一个伪终端中控制交互程序，就像 GNU expect 一样。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,791 | 🐛 862 | 🌐 Python | 📅 2026-09-06：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,235 | 🐛 147 | 🌐 Python | 📅 2026-09-04：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,045 | 🐛 1,527 | 🌐 C | 📅 2026-09-04：精简高效的 Python 编程语言实现。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,521 | 🐛 139 | 🌐 Python | 📅 2026-09-06：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,507 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,320 | 🐛 777 | 🌐 Python | 📅 2026-09-06：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,541 | 🐛 4 | 🌐 Python | 📅 2026-08-30：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,981 | 🐛 39 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
...
* 设计模式
  ...
  * [transitions](https://github.com/pytransitions/transitions) ⭐ 6,582 | 🐛 22 | 🌐 Python | 📅 2025-09-11：轻量级的，面向对象的有限状态机实现。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,833 | 🐛 153 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,458 | 🐛 54 | 🌐 Python | 📅 2026-09-02：各种具有可视化效果的机器人算法的汇总。
...
* Emacs
  * [elpy](https://github.com/jorgenschaefer/elpy) ⭐ 1,935 | 🐛 394 | 🌐 Emacs Lisp | 📅 2026-07-15：Emacs Python 开发环境。
* Sublime Text
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,891 | 🐛 36 | 🌐 Python | 📅 2026-09-03：包含 Jedi 补全的 Python 引擎。
  * [python-mode](https://github.com/python-mode/python-mode) ⭐ 5,466 | 🐛 39 | 🌐 Vim Script | 📅 2026-05-24：一个将 Vim 转换为 Python IDE 的多合一插件。
  * [jedi-vim](https://github.com/davidhalter/jedi-vim) ⭐ 5,306 | 🐛 31 | 🌐 Python | 📅 2026-06-16：用于 Python 的 Jedi 自动补全库的 Vim 绑定。
* Visual Studio
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,155 | 🐛 34 | 🌐 Python | 📅 2026-09-01：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,559 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,095 | 🐛 239 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,489 | 🐛 4 | 🌐 C++ | 📅 2026-09-04：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
