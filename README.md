...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,890 | 🐛 18 | 🌐 Python | 📅 2026-09-15 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,033 | 🐛 15 | 🌐 Python | 📅 2026-08-24：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,004 | 🐛 178 | 🌐 Python | 📅 2026-09-14：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,507 | 🐛 656 | 🌐 Python | 📅 2026-09-15：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,154 | 🐛 581 | 🌐 Python | 📅 2026-09-15：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,096 | 🐛 291 | 🌐 Python | 📅 2026-09-13：将 Python 程序转换成独立的执行文件（跨平台）。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,458 | 🐛 275 | 🌐 Python | 📅 2026-09-15：多平台命令行构建工具。
...
* [IPython](https://github.com/ipython/ipython) ⭐ 16,782 | 🐛 1,287 | 🌐 Python | 📅 2026-09-14：功能丰富的工具，非常有效的使用交互式 Python。
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,451 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,574 | 🐛 718 | 🌐 Python | 📅 2026-07-26 之上。
...
* [Jupyter Notebook (IPython)](https://jupyter.org)：一个能够让你最大限度地以交互式方式使用 Python 的丰富工具包。
  * [awesome-jupyter](https://github.com/markusschanta/awesome-jupyter) ⭐ 4,669 | 🐛 10 | 📅 2026-09-15

### 文件

文件管理和 MIME（多用途的网际邮件扩充协议）类型检测。

* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,412 | 🐛 260 | 🌐 Python | 📅 2026-09-06：管理文件系统事件的 API 和 shell 工具。
...
* [path.py](https://github.com/jaraco/path.py) ⭐ 1,124 | 🐛 12 | 🌐 Python | 📅 2026-04-13：对 os.path 进行封装的模块。
...
* 通用
  ...
  * [shortuuid](https://github.com/stochastic-technologies/shortuuid) ⭐ 2,200 | 🐛 0 | 🌐 Python | 📅 2026-06-20：一个生成器库，用以生成简洁的，明白的，URL 安全的 UUID。
...
* 解析器
  * [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,773 | 🐛 12 | 🌐 Python | 📅 2026-09-10：解析，格式化，储存，验证电话号码。
  * [python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,773 | 🐛 12 | 🌐 Python | 📅 2026-09-10：解析，格式化，存储，校验国际电话号码。
  * [python-user-agents](https://github.com/selwin/python-user-agents) ⭐ 1,514 | 🐛 47 | 🌐 Python | 📅 2023-02-16：浏览器 user agent 解析器。
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 18 | 🌐 Python | 📅 2026-09-15：把一个人名分解为几个独立的部分。
...
* Office
  * [python-docx](https://github.com/python-openxml/python-docx) ⭐ 5,720 | 🐛 521 | 🌐 Python | 📅 2026-08-01：读取，查询以及修改 Microsoft Word 2007/2008 docx 文件。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,204 | 🐛 131 | 🌐 Python | 📅 2026-09-15：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,247 | 🐛 26 | 🌐 Python | 📅 2026-09-11：John Gruber’s Markdown 的 Python 版实现。
...
* CSV
  * [csvkit](https://github.com/wireservice/csvkit) ⭐ 6,410 | 🐛 43 | 🌐 Python | 📅 2026-08-03：用于转换和操作 CSV 的工具。
* Archive
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 83,126 | 🐛 53 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,154 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
...
* [SnowNLP](https://github.com/isnowfy/snownlp) ⭐ 6,629 | 🐛 44 | 🌐 Python | 📅 2020-01-19：一个用来处理中文文本的库。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,387 | 🐛 388 | 🌐 Python | 📅 2026-09-15：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,656 | 🐛 73 | 🌐 Python | 📅 2026-09-16：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  ...
  * [Gooey](https://github.com/chriskiehl/Gooey) ⭐ 21,903 | 🐛 180 | 🌐 Python | 📅 2026-09-12：一条命令，将命令行程序变成一个 GUI 程序。
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,574 | 🐛 718 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,368 | 🐛 374 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,339 | 🐛 622 | 🌐 Python | 📅 2026-09-11：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,852 | 🐛 457 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,087 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,258 | 🐛 736 | 🌐 Python | 📅 2026-09-15：Amazon Web Services 的通用命令行界面。
  ...
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,579 | 🐛 137 | 🌐 Python | 📅 2026-09-12： [tmux](https://github.com/tmux/tmux) ⭐ 49,277 | 🐛 39 | 🌐 C | 📅 2026-09-15 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,581 | 🐛 14 | 🌐 Python | 📅 2026-09-08：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,573 | 🐛 148 | 🌐 Python | 📅 2026-09-07：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  * [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,517 | 🐛 338 | 🌐 Python | 📅 2024-12-17：一个命令行 HTTP 客户端，cURL 的替代品，易用性更好。
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,388 | 🐛 43 | 🌐 Python | 📅 2026-09-09：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,975 | 🐛 0 | 🌐 Python | 📅 2026-09-15：支持自动补全和语法高亮的 MySQL 命令行客户端
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,644 | 🐛 76 | 🌐 Python | 📅 2026-09-15：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,594 | 🐛 8 | 🌐 Python | 📅 2026-09-09：为方便人使用而创建的金融数据接口库。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,745 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [nude.py](https://github.com/hhatto/nude.py) ⭐ 920 | 🐛 9 | 🌐 Python | 📅 2020-11-23：裸体检测。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,598 | 🐛 244 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,666 | 🐛 715 | 🌐 Python | 📅 2026-09-15：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,793 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,613 | 🐛 51 | 🌐 Python | 📅 2026-09-15：音频音乐分析 Python 库。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,547 | 🐛 220 | 🌐 Python | 📅 2026-09-16：基于 asyncio 的异步 HTTP 网络库。
* [httpx](https://github.com/encode/httpx) ⭐ 15,482 | 🐛 142 | 🌐 Python | 📅 2026-03-29：下一代 Python HTTP 客户端。
* [grequests](https://github.com/kennethreitz/grequests) ⭐ 4,571 | 🐛 11 | 🌐 Python | 📅 2024-08-08：requests 库 + gevent ，用于异步 HTTP 请求。
* [urllib3](https://github.com/shazow/urllib3) ⭐ 4,058 | 🐛 239 | 🌐 Python | 📅 2026-09-15：一个具有线程安全连接池，支持文件 post，清晰友好的 HTTP 库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,566 | 🐛 16 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,843 | 🐛 16 | 🌐 Python | 📅 2026-09-11：纯 Python MySQL 驱动，兼容 mysql-python。
  * ysqlclient：[mysql-python](https://github.com/PyMySQL/mysqlclient-python) ⭐ 2,539 | 🐛 3 | 🌐 Python | 📅 2026-09-11 分支，支持 Python 3。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,642 | 🐛 83 | 🌐 Python | 📅 2026-09-15：Redis 的 Python 客户端。
...
* 关系型数据库
  * [Peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-09-14：一个小巧，富有表现力的 ORM。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,245 | 🐛 4 | 🌐 Python | 📅 2026-09-06 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,716 | 🐛 9 | 🌐 Python | 📅 2026-09-13：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,915 | 🐛 31 | 🌐 Python | 📅 2026-09-12：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,108 | 🐛 891 | 🌐 Python | 📅 2026-09-14：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 102,354 | 🐛 78 | 🌐 Python | 📅 2026-09-14：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  * [django-allauth](https://github.com/pennersr/django-allauth) ⭐ 10,376 | 🐛 2 | 🌐 Python | 📅 2026-09-11：Django 的验证应用。
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,422 | 🐛 144 | 🌐 Python | 📅 2026-08-31：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) ⭐ 3,336 | 🐛 46 | 🌐 Python | 📅 2026-09-02：为 Django 用户准备的 OAuth2。
...
* 其他
  * [PyJWT](https://github.com/jpadilla/pyjwt) ⭐ 5,700 | 🐛 55 | 🌐 Python | 📅 2026-09-14：JSON Web 令牌草案 01。
...
* [Jinja2](https://github.com/pallets/jinja) ⭐ 11,779 | 🐛 104 | 🌐 Python | 📅 2025-06-14：一个现代的，对设计师友好的模板引擎。
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,035 | 🐛 0 | 🌐 Python | 📅 2026-09-15：小型多线程任务队列。
...
* [django-cacheops](https://github.com/Suor/django-cacheops) ⭐ 2,275 | 🐛 23 | 🌐 Python | 📅 2026-04-15：具有自动颗粒化事件驱动失效功能的 ORM。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,537 | 🐛 51 | 🌐 Python | 📅 2026-09-15：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [Talon](https://github.com/mailgun/talon) ⭐ 1,345 | 🐛 50 | 🌐 Python | 📅 2026-09-15：Mailgun 库，用来抽取信息和签名。
...
* [xhtml2pdf](https://github.com/xhtml2pdf/xhtml2pdf) ⭐ 2,391 | 🐛 133 | 🌐 Python | 📅 2026-09-16：HTML/CSS 转 PDF 工具。
...
* [newspaper](https://github.com/codelucas/newspaper) ⭐ 15,155 | 🐛 515 | 🌐 Python | 📅 2026-09-15：使用 Python 进行新闻提取，文章提取以及内容策展。
...
* [python-readability](https://github.com/buriy/python-readability) ⭐ 2,892 | 🐛 21 | 🌐 HTML | 📅 2026-08-27：arc90 公司 readability 工具的 Python 高速端口。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,980 | 🐛 53 | 🌐 Python | 📅 2026-09-15：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,238 | 🐛 147 | 🌐 Python | 📅 2026-09-15：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,497 | 🐛 31 | 🌐 C++ | 📅 2026-09-04：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 774 | 🐛 16 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,253 | 🐛 139 | 🌐 C++ | 📅 2026-09-15 。
...
* [flower](https://github.com/mher/flower) ⭐ 7,240 | 🐛 47 | 🌐 Python | 📅 2026-09-13：一个对 Celery 集群进行实时监控和提供 web 管理界面的工具。
...
* [django-jet](https://github.com/geex-arts/django-jet) ⭐ 3,623 | 🐛 303 | 🌐 Python | 📅 2025-11-26：具有改进功能的现代响应式 Django 管理界面模板。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,900 | 🐛 160 | 🌐 Cython | 📅 2026-07-14：在 libuv 之上超快速实现 asyncio 事件循环。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,328 | 🐛 327 | 🌐 Python | 📅 2026-09-14：异步并发和 I/O 友好的库。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,966 | 🐛 93 | 🌐 Python | 📅 2026-09-14：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
* [daphne](https://github.com/django/daphne) ⭐ 2,688 | 🐛 40 | 🌐 Python | 📅 2026-08-28：用于 ASGI 和 ASGI-HTTP 的，支持 HTTP，HTTP2 和 WebSocket 协议的服务器。
...
* [DearPyGui](https://github.com/RaylockLLC/DearPyGui/) ⭐ 15,619 | 🐛 329 | 🌐 C++ | 📅 2026-05-13：一个简单的可使用 GPU 加速的 Python GUI 框架。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 6,016 | 🐛 17 | 🌐 Python | 📅 2026-09-15：围绕网页视图组件的轻量级跨平台的原生包装。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,109 | 🐛 255 | 🌐 Python | 📅 2026-08-30：旨在带来愉悦体验的 Python 日志库。
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,203 | 🐛 349 | 🌐 Python | 📅 2026-09-15：Python 版 Sentry SDK。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,885 | 🐛 299 | 🌐 Python | 📅 2026-09-15：一个通用的自动化测试框架。
  * [hypothesis](https://github.com/DRMacIver/hypothesis) ⭐ 8,969 | 🐛 43 | 🌐 Python | 📅 2026-09-14：Hypothesis 是一个基于先进的 Quickcheck 风格特性的测试库。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,159 | 🐛 3 | 🌐 Python | 📅 2026-09-15：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,697 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,600 | 🐛 7 | 🌐 Python | 📅 2026-09-15：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* Mock 测试
  * [freezegun](https://github.com/spulec/freezegun) ⭐ 4,525 | 🐛 169 | 🌐 Python | 📅 2025-08-19：通过伪造日期模块来生成不同的时间。
  * [responses](https://github.com/getsentry/responses) ⭐ 4,344 | 🐛 44 | 🌐 Python | 📅 2026-09-14：伪造 Python 中的 requests 库的一个通用库。
  * [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,009 | 🐛 169 | 🌐 Python | 📅 2026-09-15：在你的测试中记录和重放 HTTP 交互。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,451 | 🐛 31 | 🌐 Python | 📅 2026-09-15：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,302 | 🐛 14 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,984 | 🐛 6 | 📅 2026-09-03
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,120 | 🐛 347 | 🌐 Python | 📅 2026-09-16：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,810 | 🐛 71 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
  * [code2flow](https://github.com/scottrogowski/code2flow) ⭐ 4,609 | 🐛 38 | 🌐 Python | 📅 2025-07-27：把你的 Python 和 JavaScript 代码转换为流程图。
...
* Lint 工具
  ...
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,906 | 🐛 14 | 🌐 Python | 📅 2026-09-13：有史以来最严格的 Python 代码审查工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,843 | 🐛 306 | 🌐 Python | 📅 2026-09-16：一个坚定的 Python 代码格式化工具。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,501 | 🐛 240 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) ⭐ 8,380 | 🐛 80 | 🌐 Python | 📅 2026-09-14：为 Django 显示各种调试信息。
  * [pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,280 | 🐛 55 | 🌐 Python | 📅 2026-07-30：解析和分析 ELF 文件以及 DWARF 调试信息。
...
* [zipline](https://github.com/quantopian/zipline) ⭐ 20,097 | 🐛 368 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,942 | 🐛 6,000 | 🌐 Python | 📅 2026-09-14：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,622 | 🐛 2,817 | 🌐 Python | 📅 2026-09-15：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,753 | 🐛 503 | 🌐 Python | 📅 2026-09-14：马尔科夫链蒙特卡洛采样工具。
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,119 | 🐛 52 | 🌐 Python | 📅 2026-09-15：AWS 平台上使用的 Pandas。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,333 | 🐛 308 | 🌐 Python | 📅 2026-09-14：地震学 Python 工具箱。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,029 | 🐛 23 | 📅 2026-09-08。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,620 | 🐛 390 | 🌐 Python | 📅 2026-09-10：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,455 | 🐛 851 | 🌐 Python | 📅 2026-09-15：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,022 | 🐛 234 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,475 | 🐛 148 | 🌐 Python | 📅 2026-09-15：用于 Python 的声明式统计可视化库。
...
* [Cartopy](https://github.com/SciTools/cartopy) ⭐ 1,618 | 🐛 321 | 🌐 Python | 📅 2026-09-15：具有 matplotlib 支持的 Python 制图库。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,745 | 🐛 832 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,994 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,358 | 🐛 186 | 🌐 Python | 📅 2026-09-15：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,922 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,114 | 🐛 3,139 | 🌐 C++ | 📅 2026-09-16 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,342 | 🐛 29 | 🌐 Python | 📅 2026-09-12。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,738 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,767 | 🐛 435 | 🌐 C++ | 📅 2026-09-15：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,862 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,504 | 🐛 2,879 | 🌐 Jupyter Notebook | 📅 2026-09-08：开源快速可扩展的机器学习平台。
...
* [vowpal\_porpoise](https://github.com/josephreisinger/vowpal_porpoise) ⭐ 174 | 🐛 8 | 🌐 Python | 📅 2020-01-07：Python 版 [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/) ⭐ 8,720 | 🐛 1 | 🌐 C++ | 📅 2026-09-14 装饰器。
...
* [implicit](https://github.com/benfred/implicit) ⭐ 3,822 | 🐛 97 | 🌐 Python | 📅 2026-05-08：对隐式数据集进行协作过滤的快速 Python 实现。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,816 | 🐛 3,595 | 🌐 Python | 📅 2026-09-16：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,774 | 🐛 176 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,919 | 🐛 1,333 | 🌐 Python | 📅 2026-08-24：用于分析计算的灵活的并行计算库。
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,364 | 🐛 81 | 🌐 Python | 📅 2026-09-15：一个类型安全的单元、转换器与合成工具集合。
* [Coconut](https://github.com/evhub/coconut) ⭐ 4,357 | 🐛 90 | 🌐 Python | 📅 2026-02-16：为了简单、优雅、更 Pythonic 的函数式编程而构建的 Python 变体。
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,090 | 🐛 16 | 🌐 Python | 📅 2026-09-14：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,508 | 🐛 15 | 🌐 Python | 📅 2026-09-15：炫酷又实用的函数式工具。
...
* [boto3](https://github.com/boto/boto3) ⭐ 9,900 | 🐛 199 | 🌐 Python | 📅 2026-09-15：Amazon Web Services 的 Python 接口。
* [google-api-python-client](https://github.com/google/google-api-python-client) ⭐ 8,932 | 🐛 45 | 🌐 Python | 📅 2026-09-15：Python 用的 Google APIs 客户端库。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,693 | 🐛 830 | 🌐 Python | 📅 2026-09-15：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,657 | 🐛 1,878 | 🌐 Python | 📅 2026-09-15：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,274 | 🐛 258 | 🌐 Python | 📅 2026-09-14：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,113 | 🐛 182 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,998 | 🐛 160 | 🌐 Python | 📅 2026-09-14：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,848 | 🐛 856 | 🌐 Python | 📅 2026-09-15：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [Rope](https://github.com/python-rope/rope) ⭐ 2,236 | 🐛 150 | 🌐 Python | 📅 2026-09-15：一个 Python 的重构库。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 22,067 | 🐛 1,525 | 🌐 C | 📅 2026-09-16：精简高效的 Python 编程语言实现。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,546 | 🐛 139 | 🌐 Python | 📅 2026-09-12：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,535 | 🐛 1 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 224,618 | 🐛 397 | 🌐 Python | 📅 2026-09-15：所有算法的 Python 实现。
...
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,985 | 🐛 12 | 🌐 Python | 📅 2026-09-12：一个 Python 设计模式集合。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,841 | 🐛 156 | 🌐 Python | 📅 2026-09-01：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,522 | 🐛 56 | 🌐 Python | 📅 2026-09-14：各种具有可视化效果的机器人算法的汇总。
...
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,328 | 🐛 1,345 | 🌐 Python | 📅 2026-09-14： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,396 | 🐛 25 | 🌐 Python | 📅 2026-09-13：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,614 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,195 | 🐛 240 | 🌐 Python | 📅 2026-09-01：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,505 | 🐛 4 | 🌐 C++ | 📅 2026-09-12：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,923 | 🐛 81 | 🌐 Python | 📅 2026-09-08：一组纯 Python 实用工具。
