...
[awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,702 | 🐛 17 | 🌐 Python | 📅 2026-08-16 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。由「开源前哨」和「Python开发者」微信公号团队维护更新。
...
* [pyenv](https://github.com/yyuu/pyenv) ⭐ 45,028 | 🐛 56 | 🌐 Shell | 📅 2026-08-16：简单的 Python 版本管理工具。
...
* [pipenv](https://github.com/pypa/pipenv) ⭐ 25,041 | 🐛 20 | 🌐 Python | 📅 2026-08-18：Python 官方推荐的新一代包管理工具。
* [pip-tools](https://github.com/nvie/pip-tools) ⭐ 8,008 | 🐛 177 | 🌐 Python | 📅 2026-08-17：保证 Python 包依赖关系更新的一组工具。
* [conda](https://github.com/conda/conda/) ⭐ 7,486 | 🐛 659 | 🌐 Python | 📅 2026-08-18：跨平台的 Python 二进制包管理工具。
...
* [warehouse](https://github.com/pypa/warehouse) ⭐ 4,131 | 🐛 577 | 🌐 Python | 📅 2026-08-18：下一代 PyPI。
...
* [PyInstaller](https://github.com/pyinstaller/pyinstaller) ⭐ 13,070 | 🐛 289 | 🌐 Python | 📅 2026-08-18：将 Python 程序转换成独立的执行文件（跨平台）。
* [pyarmor](https://github.com/dashingsoft/pyarmor) ⭐ 5,169 | 🐛 12 | 🌐 Python | 📅 2026-08-14：一个用于加密 python 脚本的工具，也可以将加密后的脚本绑定到固件上，或设置已加密脚本的有效期。
...
* [PlatformIO](https://github.com/platformio/platformio) ⭐ 9,409 | 🐛 317 | 🌐 Python | 📅 2026-08-11：多平台命令行构建工具。
...
* [ptpython](https://github.com/jonathanslenders/ptpython) ⭐ 5,446 | 🐛 265 | 🌐 Python | 📅 2025-11-21：高级交互式 Python 解析器， 构建于 [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,555 | 🐛 705 | 🌐 Python | 📅 2026-07-26 之上。
...
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,395 | 🐛 243 | 🌐 Python | 📅 2026-08-15：管理文件系统事件的 API 和 shell 工具。
...
* 解析器
  ...
  * [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 713 | 🐛 31 | 🌐 Python | 📅 2026-08-18：把一个人名分解为几个独立的部分。
...
* PDF
  * [PyPDF2](https://github.com/mstamy2/PyPDF2) ⭐ 10,161 | 🐛 141 | 🌐 Python | 📅 2026-08-17：一个可以分割，合并和转换 PDF 页面的库。
...
* Markdown
  * [Python-Markdown](https://github.com/waylan/Python-Markdown) ⭐ 4,233 | 🐛 30 | 🌐 Python | 📅 2026-08-08：John Gruber’s Markdown 的 Python 版实现。
  * [Mistune](https://github.com/lepture/mistune) ⭐ 3,065 | 🐛 20 | 🌐 Python | 📅 2026-08-14：快速并且功能齐全的纯 Python 实现的 Markdown 解析器。
  * [Python-Markdown2](https://github.com/trentm/python-markdown2) ⭐ 2,820 | 🐛 92 | 🌐 Python | 📅 2026-08-18：纯 Python 实现的 Markdown 解析器，比 Python-Markdown 更快，更准确，可扩展。
* YAML
...
* [funNLP](https://github.com/fighting41love/funNLP) ⭐ 82,526 | 🐛 52 | 🌐 Python | 📅 2024-05-10：中文自然语言处理的工具和数据集。
* [jieba](https://github.com/fxsjy/jieba) ⭐ 35,121 | 🐛 700 | 🌐 Python | 📅 2024-08-21：中文分词工具。
...
* [readthedocs](https://github.com/rtfd/readthedocs.org/) ⭐ 8,374 | 🐛 395 | 🌐 Python | 📅 2026-08-18：一个基于 Sphinx/MkDocs 的在线文档托管系统，对开源项目免费开放使用。
...
* [hydra](https://github.com/facebookresearch/hydra) ⭐ 10,605 | 🐛 109 | 🌐 Python | 📅 2026-08-18：一个优雅地配置复杂应用程序的框架。
...
* 命令行程序开发
  ...
  * [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) ⭐ 10,555 | 🐛 705 | 🌐 Python | 📅 2026-07-26：一个用于构建强大的交互式命令行程序的库。
...
* 终端呈现方式
  * [rich](https://github.com/willmcgugan/rich) ⭐ 57,083 | 🐛 371 | 🌐 Python | 📅 2026-06-23：一个在终端中支持富文本和格式美化的 Python 库， 同时提供了`RichHandler`日志处理程序。
  * [tqdm](https://github.com/tqdm/tqdm) ⭐ 31,276 | 🐛 594 | 🌐 Python | 📅 2026-08-17：一个可在循环和命令行中使用的快速、可扩展的进度条。
...
* 生产力工具
  * [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,719 | 🐛 454 | 🌐 Python | 📅 2024-07-19：修正你之前的命令行指令。
  * [cookiecutter](https://github.com/audreyr/cookiecutter) ⭐ 25,057 | 🐛 312 | 🌐 Python | 📅 2026-04-01：从 cookiecutters（项目模板）创建项目的一个命令行工具。
  * [aws-cli](https://github.com/aws/aws-cli) ⭐ 17,193 | 🐛 708 | 🌐 Python | 📅 2026-08-18：Amazon Web Services 的通用命令行界面。
  ...
  * [Invoke](https://github.com/pyinvoke/invoke#readme) ⭐ 4,769 | 🐛 459 | 🌐 Python | 📅 2026-04-07：用于管理面向 shell 的子进程，同时支持将可执行的 Python 代码组织成命令行可调用的状态。
  * [tmuxp](https://github.com/tony/tmuxp) ⭐ 4,560 | 🐛 138 | 🌐 Python | 📅 2026-08-16： [tmux](https://github.com/tmux/tmux) ⭐ 48,707 | 🐛 27 | 🌐 C | 📅 2026-08-18 会话管理器。
  * [doitlive](https://github.com/sloria/doitlive) ⭐ 3,576 | 🐛 14 | 🌐 Python | 📅 2026-08-11：一个用来在终端中进行现场演示的工具。
  * [copier](https://github.com/pykong/copier) ⭐ 3,527 | 🐛 144 | 🌐 Python | 📅 2026-08-18：用于呈现项目模板的库和命令行实用程序。
...
* 高级 CLI
  ...
  * [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,354 | 🐛 42 | 🌐 Python | 📅 2026-08-18：支持自动补全和语法高亮的 Postgres 命令行工具。
  * [mycli](https://github.com/dbcli/mycli) ⭐ 11,962 | 🐛 4 | 🌐 Python | 📅 2026-08-18：支持自动补全和语法高亮的 MySQL 命令行客户端
  * [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02：一个加强版的 AWS 命令行。
  * [litecli](https://github.com/dbcli/litecli) ⭐ 3,291 | 🐛 46 | 🌐 Python | 📅 2026-06-18：支持自动补全和语法高亮的 SQLite 命令行工具。
...
* Shell
  * [xonsh](https://github.com/xonsh/xonsh/) ⭐ 9,605 | 🐛 72 | 🌐 Python | 📅 2026-08-18：一种基于 python 的跨平台，面向 unix 的 shell 语言和命令提示符。

### 下载器

用来进行下载的库.

* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,109 | 🐛 2 | 🌐 Python | 📅 2026-08-18：为方便人使用而创建的金融数据接口库。
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,900 | 🐛 311 | 🌐 Python | 📅 2025-10-22：一个用来管理 Amazon S3 和 CloudFront 的命令行工具。
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,664 | 🐛 831 | 🌐 Python | 📅 2026-06-25：简单易用的 Python 人脸识别库。
...
* [python-qrcode](https://github.com/lincolnloop/python-qrcode) ⭐ 4,928 | 🐛 53 | 🌐 Python | 📅 2026-03-25：一个纯 Python 实现的二维码生成器。
...
* [paddleocr](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 87,880 | 🐛 233 | 🌐 Python | 📅 2026-07-22: 除光学字符识别外还引入了表格识别。
...
* [beets](https://github.com/beetbox/beets) ⭐ 15,554 | 🐛 708 | 🌐 Python | 📅 2026-08-18：一个音乐库管理器和 [MusicBrainz](https://musicbrainz.org/) 标记器。
* [pydub](https://github.com/jiaaro/pydub) ⭐ 9,791 | 🐛 421 | 🌐 Python | 📅 2026-03-19：通过简单、简洁的高层接口来操作音频文件。
* [librosa](https://github.com/librosa/librosa) ⭐ 8,565 | 🐛 47 | 🌐 Python | 📅 2026-08-18：音频音乐分析 Python 库。
* [dejavu](https://github.com/worldveil/dejavu) ⭐ 6,780 | 🐛 132 | 🌐 Python | 📅 2024-04-22：音频指纹提取和识别。
...
* [aiohttp](https://github.com/aio-libs/aiohttp) ⭐ 16,527 | 🐛 245 | 🌐 Python | 📅 2026-08-18：基于 asyncio 的异步 HTTP 网络库。
...
* [TinyDB](https://github.com/msiemens/tinydb) ⭐ 7,553 | 🐛 5 | 🌐 Python | 📅 2026-08-10：一个微型的，面向文档型数据库。
...
* MySQL：[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) 系列
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,842 | 🐛 14 | 🌐 Python | 📅 2026-08-18：纯 Python MySQL 驱动，兼容 mysql-python。
...
* NoSQL 数据库
  * [redis-py](https://github.com/andymccurdy/redis-py) ⭐ 13,609 | 🐛 85 | 🌐 Python | 📅 2026-08-18：Redis 的 Python 客户端。
...
* [sanic](https://github.com/channelcat/sanic/) ⭐ 18,642 | 🐛 146 | 🌐 Python | 📅 2026-07-29：基于 Python3.5+ 的异步网络框架。
...
* [Django](https://www.djangoproject.com/)：Python 界最流行的 web 框架。
  * [awesome-django(by wsvincent)](https://github.com/wsvincent/awesome-django) ⭐ 11,202 | 🐛 10 | 🌐 Python | 📅 2026-08-18 系列
...
* [Flask](http://flask.pocoo.org/)：一个 Python 微型框架。
  * [awesome-flask](https://github.com/humiaozuzu/awesome-flask) ⭐ 12,749 | 🐛 1 | 📅 2026-08-17 系列
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,712 | 🐛 1 | 🌐 Python | 📅 2026-08-18：一个用于构建 WebSocket 服务器和客户端的库，着重于正确性和简单性。
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,909 | 🐛 38 | 🌐 Python | 📅 2026-07-30：Django 1.2+ ，实现了单个对象权限。
...
* [indico](https://github.com/indico/indico) ⭐ 2,099 | 🐛 893 | 🌐 Python | 📅 2026-08-18：一个功能丰富的事件管理系统，由 @[CERN](https://en.wikipedia.org/wiki/CERN) 开发。
...
* 与框架无关的
  * [fastapi](https://github.com/tiangolo/fastapi) ⭐ 101,681 | 🐛 86 | 🌐 Python | 📅 2026-08-18：一个现代，快速，基于标准 Python 类型注解的的 web框架，可使用 Python3.6+ 版本构建 API。
...
* OAuth
  ...
  * [authlib](https://github.com/lepture/authlib) ⭐ 5,399 | 🐛 141 | 🌐 Python | 📅 2026-08-11：一个强大的Python库，用来构建 OAuth 和 OpenID 服务端。包括：JWS, JWK, JWA, JWT。
...
* [modoboa](https://github.com/tonioo/modoboa) ⭐ 3,531 | 🐛 51 | 🌐 Python | 📅 2026-08-14：一个邮件托管和管理平台，具有现代的、简约的 Web UI。
...
* [textract](https://github.com/deanmalmgren/textract) ⭐ 4,692 | 🐛 69 | 🌐 HTML | 📅 2026-08-05：从任何格式的文档中提取文本，Word，PowerPoint，PDFs 等等。
...
* [jsonschema](https://github.com/Julian/jsonschema) ⭐ 4,973 | 🐛 66 | 🌐 Python | 📅 2026-08-17：[JSON Schema](http://json-schema.org/) 的 python 实现，用于 JSON 数据的验证。
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) ⭐ 7,242 | 🐛 146 | 🌐 Python | 📅 2026-08-18：一个轻量级的库，用于将复杂对象与简单 Python 数据类型相互转换。
* [ultrajson](https://github.com/esnme/ultrajson) ⭐ 4,497 | 🐛 32 | 🌐 C++ | 📅 2026-08-13：使用 Python 绑定的，用 C 编写的快速 JSON 解码器和编码器。
* [pysimdjson](https://github.com/TkTech/pysimdjson) ⭐ 770 | 🐛 19 | 🌐 Python | 📅 2026-04-26：与 Python 绑定的 [simdjson](https://github.com/lemire/simdjson) ⭐ 24,157 | 🐛 133 | 🌐 C++ | 📅 2026-08-18 。
* [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) ⭐ 532 | 🐛 22 | 🌐 C++ | 📅 2026-08-09： [RapidJSON](https://github.com/Tencent/rapidjson) ⭐ 15,112 | 🐛 789 | 🌐 C++ | 📅 2025-02-05 的 Python 封装。
...
* [gevent](http://www.gevent.org/)：一个基于协程的 Python 网络库，使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,838 | 🐛 21 | 🌐 C++ | 📅 2026-08-10。
* [gevent](http://www.gevent.org/)：使用 [greenlet](https://github.com/python-greenlet/greenlet) ⭐ 1,838 | 🐛 21 | 🌐 C++ | 📅 2026-08-10 且基于协程的 Python 网络库。
...
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,910 | 🐛 82 | 🌐 Python | 📅 2026-08-18：使用 uvloop 和 httptools 实现的闪电般快速的 ASGI 服务器。
...
* [pywebview](https://github.com/r0x0r/pywebview/) ⭐ 5,986 | 🐛 17 | 🌐 Python | 📅 2026-08-11：围绕网页视图组件的轻量级跨平台的原生包装。
* [Toga](https://github.com/pybee/toga) ⭐ 5,402 | 🐛 306 | 🌐 Python | 📅 2026-08-18：一个 Python 原生的，操作系统原生的 GUI 工具包。
...
* [loguru](https://github.com/Delgan/loguru) ⭐ 24,069 | 🐛 267 | 🌐 Python | 📅 2026-07-01：旨在带来愉悦体验的 Python 日志库。
...
* 测试框架
  * [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,825 | 🐛 303 | 🌐 Python | 📅 2026-08-18：一个通用的自动化测试框架。
...
* GUI / Web 测试
  * [locust](https://github.com/locustio/locust) ⭐ 28,076 | 🐛 3 | 🌐 Python | 📅 2026-08-10：使用 Python 编写的，可扩展的用户加载测试工具。
  * [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,663 | 🐛 584 | 🌐 Python | 📅 2024-08-20：PyAutoGUI 是一个人性化的跨平台 GUI 自动测试模块。
  * [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,537 | 🐛 9 | 🌐 Python | 📅 2026-08-18：基于属性的自动测试工具，用于测试使用 Open API / Swagger 规范构建的 Web 应用程序。
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,213 | 🐛 32 | 🌐 Python | 📅 2026-08-18：自动 SQL 注入和数据库接管工具。
* [setoolkit](https://github.com/trustedsec/social-engineer-toolkit) ⭐ 15,205 | 🐛 12 | 🌐 Python | 📅 2026-06-04：社会工程工具包。
* [fsociety](https://github.com/Manisso/fsociety) ⭐ 12,255 | 🐛 95 | 🌐 Python | 📅 2026-07-21：一款渗透测试框架。
...
* 静态类型检查，也可以参考 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing) ⭐ 1,977 | 🐛 7 | 📅 2026-06-19
  ...
  * [typeshed](https://github.com/python/typeshed) ⭐ 5,109 | 🐛 370 | 🌐 Python | 📅 2026-08-18：带有静态类型的Python库存根的集合。
  * [mypy](http://mypy-lang.org/)：在编译期间检查变量类型。

* 代码分析
  * [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,766 | 🐛 69 | 🌐 Python | 📅 2026-04-30：用于发现和分析无效 Python 代码的工具。
...
* 代码格式化
  * [black](https://github.com/ambv/black) ⭐ 41,806 | 🐛 305 | 🌐 Python | 📅 2026-08-17：一个坚定的 Python 代码格式化工具。
  * [isort](https://github.com/timothycrosley/isort) ⭐ 6,946 | 🐛 87 | 🌐 Python | 📅 2026-08-18：用于纠正包导入顺序的 Python 库。
...
* 性能分析器
  * [py-spy](https://github.com/benfred/py-spy) ⭐ 15,438 | 🐛 236 | 🌐 Rust | 📅 2026-08-14：Python 程序采样分析器，使用 Rust 实现。
...
* 其他
  ...
  * [python-statsd](https://github.com/WoLpH/python-statsd) ⭐ 110 | 🐛 1 | 🌐 Python | 📅 2019-02-15：[statsd](https://github.com/etsy/statsd/) ⭐ 18,073 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 服务器的 Python 客户端。

### 科学计算和数据分析

用来进行科学计算和数据分析的库。

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,049 | 🐛 370 | 🌐 Python | 📅 2024-02-13：一个 Python 算法交易库。
* [SymPy](https://github.com/sympy/sympy) ⭐ 14,869 | 🐛 5,953 | 🌐 Python | 📅 2026-08-17：一个用于符号数学的 Python 库。
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,580 | 🐛 2,827 | 🌐 Python | 📅 2026-08-18：统计建模和计量经济学。
* [PyMC](https://github.com/pymc-devs/pymc3) ⭐ 9,711 | 🐛 479 | 🌐 Python | 📅 2026-08-17：马尔科夫链蒙特卡洛采样工具。
...
* [ObsPy](https://github.com/obspy/obspy/wiki/) ⭐ 1,327 | 🐛 311 | 🌐 Python | 📅 2026-08-10：地震学 Python 工具箱。
...
进行数据可视化的库。 参见：[awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization) ⭐ 35,016 | 🐛 28 | 📅 2026-08-17。

* [diagrams](https://github.com/mingrammer/diagrams) ⭐ 42,521 | 🐛 387 | 🌐 Python | 📅 2026-08-16：用图表作为代码。
* [bokeh](https://github.com/bokeh/bokeh) ⭐ 20,431 | 🐛 852 | 🌐 Python | 📅 2026-08-18：用 Python 进行交互式 web 绘图。
* [pyecharts](https://github.com/chenjiandongx/pyecharts) ⭐ 15,777 | 🐛 4 | 🌐 Python | 📅 2026-08-04：基于百度 Echarts 的数据可视化库。
* [Seaborn](https://github.com/mwaskom/seaborn) ⭐ 13,999 | 🐛 230 | 🌐 Python | 📅 2026-07-06：使用 Matplotlib 进行统计数据可视化。
* [Altair](https://github.com/altair-viz/altair) ⭐ 10,454 | 🐛 143 | 🌐 Python | 📅 2026-08-16：用于 Python 的声明式统计可视化库。
* [plotnine](https://github.com/has2k1/plotnine) ⭐ 4,756 | 🐛 84 | 🌐 Python | 📅 2026-08-15：基于ggplot2的Python图形语法。
...
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,664 | 🐛 831 | 🌐 Python | 📅 2026-06-25：简单的面部识别库。
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,918 | 🐛 530 | 🌐 Python | 📅 2025-12-05：支持40多种语言的即用型 OCR。
* [Kornia](https://github.com/kornia/kornia/) ⭐ 11,314 | 🐛 87 | 🌐 Python | 📅 2026-08-18：PyTorch 的开源差异化计算机视觉库。
...
神经网络和深度学习相关框架。 也可以参考 [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,772 | 🐛 85 | 📅 2025-05-26。
...
* [skflow](https://github.com/tensorflow/skflow) ⚠️ Archived：一个 [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,047 | 🐛 3,011 | 🌐 C++ | 📅 2026-08-18 的简化接口(模仿 scikit-learn)。
...
机器学习相关库，也可以参考 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python) ⭐ 74,064 | 🐛 26 | 🌐 Python | 📅 2026-08-11。

* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,604 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13：MindsDB 是现有数据库的开源 AI 层，可让使用标准查询轻松地进行开发，训练和部署最新的机器学习模型。
* [gym](https://github.com/openai/gym) ⚠️ Archived：开发和比较强化学习算法的工具包。
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 28,667 | 🐛 420 | 🌐 C++ | 📅 2026-08-18：可扩展，便携式和分布式梯度提升库。
* [pattern](https://github.com/clips/pattern) ⭐ 8,860 | 🐛 179 | 🌐 Python | 📅 2026-08-05：Python 网络挖掘模块。
* [H2O](https://github.com/h2oai/h2o-3) ⭐ 7,493 | 🐛 2,880 | 🌐 Jupyter Notebook | 📅 2026-08-18：开源快速可扩展的机器学习平台。
...
* [Ray](https://github.com/ray-project/ray/) ⭐ 43,547 | 🐛 3,522 | 🌐 Python | 📅 2026-08-18：一个用于并行和分布式 Python 的系统，它统一了机器学习生态系统。
* [luigi](https://github.com/spotify/luigi) ⭐ 18,765 | 🐛 167 | 🌐 Python | 📅 2026-07-18：这个模块帮你构建批处理作业的复杂流水线。
* [dask](https://github.com/dask/dask) ⭐ 13,891 | 🐛 1,308 | 🌐 Python | 📅 2026-08-17：用于分析计算的灵活的并行计算库。
...
* [more-itertools](https://github.com/erikrose/more-itertools) ⭐ 4,089 | 🐛 7 | 🌐 Python | 📅 2026-08-12：比 `itertools` 拥有更多的可迭代对象的操作方式。
* [funcy](https://github.com/Suor/funcy) ⭐ 3,509 | 🐛 15 | 🌐 Python | 📅 2026-08-17：炫酷又实用的函数式工具。
...
* [facebook-sdk](https://github.com/mobolic/facebook-sdk) ⭐ 2,792 | 🐛 38 | 🌐 Python | 📅 2024-08-02：Facebook 平台的 Python SDK。
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,341 | 🐛 828 | 🌐 Python | 📅 2026-08-11：一个非常简单的 IT 自动化平台。
* [SaltStack](https://github.com/saltstack/salt) ⭐ 15,620 | 🐛 1,926 | 🌐 Python | 📅 2026-08-18：基础设施自动化和管理系统。
* [psutil](https://github.com/giampaolo/psutil) ⭐ 11,264 | 🐛 255 | 🌐 Python | 📅 2026-08-17：一个跨平台进程和系统工具模块。
* [supervisor](https://github.com/Supervisor/supervisor) ⭐ 9,107 | 🐛 181 | 🌐 Python | 📅 2025-12-21：UNIX 的进程控制系统。
* [pyinfra](https://github.com/Fizzadar/pyinfra) ⭐ 5,955 | 🐛 176 | 🌐 Python | 📅 2026-08-17：一个通用的 CLI 工具包和 python 库，用于自动化的基础设施。
...
* [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,636 | 🐛 861 | 🌐 Python | 📅 2026-08-18：一个现代的工作流程编排框架，使构建、计划和监视健壮的数据管道变得容易。
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,991 | 🐛 1,533 | 🌐 C | 📅 2026-08-18：精简高效的 Python 编程语言实现。
...
* [PythonNet](https://github.com/pythonnet/pythonnet) ⭐ 5,507 | 🐛 165 | 🌐 C# | 📅 2026-08-16：Python 与 .NET 公共语言运行库 (CLR)的集成。
...
* [scapy](https://github.com/secdev/scapy) ⭐ 12,475 | 🐛 134 | 🌐 Python | 📅 2026-08-18：一个非常棒的操作数据包的库。
...
数据结构、算法和设计模式的 Python 实现。也可以参考 [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 25,457 | 🐛 0 | 📅 2026-04-18 。

* 算法
  * [TheAlgorithms](https://github.com/TheAlgorithms/Python) ⭐ 223,840 | 🐛 1,045 | 🌐 Python | 📅 2026-08-03：所有算法的 Python 实现。
  * [algorithms](https://github.com/keon/algorithms) ⭐ 25,539 | 🐛 5 | 🌐 Python | 📅 2026-08-01：数据结构和算法的简单示例。
  * [sortedcontainers](https://github.com/grantjenks/python-sortedcontainers) ⭐ 3,973 | 🐛 38 | 🌐 Python | 📅 2024-03-08：排序集合的快速的纯 Python 实现。
  * [python-ds](https://github.com/prabhupant/python-ds) ⭐ 3,090 | 🐛 34 | 🌐 Python | 📅 2024-04-06：用于面试的数据结构和算法的集合。
* 设计模式
  * [python-patterns](https://github.com/faif/python-patterns) ⭐ 42,929 | 🐛 15 | 🌐 Python | 📅 2026-08-13：一个 Python 设计模式集合。
...
* [attrs](https://github.com/python-attrs/attrs) ⭐ 5,831 | 🐛 148 | 🌐 Python | 📅 2026-08-18：一个在类定义时可替换 `__init__`, `__eq__`, `__repr__`等方法的样板。
* [Box](https://github.com/cdgriffith/Box) ⭐ 2,832 | 🐛 45 | 🌐 Python | 📅 2026-02-21：具有高级点符号访问权限的 Python 字典。
* [bidict](https://github.com/jab/bidict) ⭐ 1,585 | 🐛 1 | 🌐 Python | 📅 2026-08-18：高效的 Pythonic 的双向映射数据结构和相关功能。
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,319 | 🐛 50 | 🌐 Python | 📅 2026-08-17：各种具有可视化效果的机器人算法的汇总。
...
* Vim
  * [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) ⭐ 25,893 | 🐛 36 | 🌐 Python | 📅 2026-08-17：包含 Jedi 补全的 Python 引擎。
...
* Visual Studio
  * [PTVS](https://github.com/Microsoft/PTVS) ⭐ 2,565 | 🐛 157 | 🌐 C# | 📅 2026-08-13：Visual Studio Python 工具。
* Visual Studio Code
  * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python)：对 Python 有丰富支持的官方 VSCode 扩展。
* IDE
  * [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,288 | 🐛 1,348 | 🌐 Python | 📅 2026-08-17： 开源 Python IDE。
...
* [vnpy](https://github.com/vnpy/vnpy) ⭐ 44,599 | 🐛 31 | 🌐 Python | 📅 2026-08-10：基于Python的开源量化交易系统开发框架，整合了多种交易接口，并针对具体策略算法和功能开发提供了简洁易用的API，用于快速构建交易员所需的量化交易应用
* [abu](https://github.com/bbfamily/abu) ⭐ 18,168 | 🐛 6 | 🌐 Python | 📅 2026-01-24: 基于python的开源量化交易，量化投资架构
* [QUANTAXIS](https://github.com/QUANTAXIS/QUANTAXIS) ⭐ 11,013 | 🐛 239 | 🌐 Python | 📅 2026-02-28：支持任务调度，分布式部署的股票/期货/期权/港股/虚拟货币的数据/回测/模拟/交易/可视化/多账户纯本地量化解决方案
* [Hikyuu Quant](https://github.com/fasiondog/hikyuu) ⭐ 3,447 | 🐛 5 | 🌐 C++ | 📅 2026-08-18：基于C++/Python的开源量化交易研究框架，用于策略分析及回测（仅受限于数据，如有数据也可用于期货等）
...
* [boltons](https://github.com/mahmoud/boltons) ⭐ 6,917 | 🐛 71 | 🌐 Python | 📅 2026-08-17：一组纯 Python 实用工具。
